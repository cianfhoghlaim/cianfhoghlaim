...
## Source Files
These are the project's own examples (not third-party clones). Full source removed (2026-06-06) but architecture documents and agent instructions retained. Source available in the main repository under `sruth/cianfhoghlaim/web/`.
