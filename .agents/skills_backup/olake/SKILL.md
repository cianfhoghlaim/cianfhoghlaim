---
name: olake
description: Expert assistance for OLake database replication to data lakes. Use when users need PostgreSQL/MySQL/MongoDB CDC to Iceberg, high-performance replication (300K+ rows/sec), Dagster orchestration, or cost-effective alternatives to Fivetran/Airbyte.
---
