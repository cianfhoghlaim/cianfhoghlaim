...
| 6 | `cloudflare-workers` | `references/cloudflare-workers.md` | Cloudflare Workers + D1 / R2 / KV / Hyperdrive — the primary deploy target for `sruth/cianfhoghlaim/web/` and several `sruth/` apps |
...
(`sruth/cianfhoghlaim/`, `sruth/meaisinfhoghlaim/`, `sruth/tuatha/`, `sruth/croilar/`)
...
|:--|:--|:--|
| Quadrant | `sruth/tuatha/` (game / 3D / crypto) | `sruth/cianfhoghlaim/web/`, `sruth/croilar/`, shared web stack |
