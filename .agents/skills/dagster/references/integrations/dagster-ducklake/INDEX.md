...
sink (the `oideachais/storage/ducklake_client.py` module is the
canonical client).
...
- `oideachais/storage/ducklake_client.py` — the canonical DuckLake
...
- `oideachais/dagster_defs/assets/` — the 21+ asset modules that
