...
The `oideachais/cocoindex_flows/geospatial_indexing.py` CocoIndex v1
App embeds + indexes the Celtic place-name corpora (Gaeltacht
regions, heritage sites, school locations) with geospatial
metadata. The Dagster asset group `oideachais/dagster_defs/assets/geospatial_assets.py`
