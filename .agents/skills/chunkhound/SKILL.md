---
name: chunkhound
description: Expert assistant for ChunkHound code search and exploration. Use for semantic code search, codebase indexing, multi-hop exploration, and MCP integration.
---
