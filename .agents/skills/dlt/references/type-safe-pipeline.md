...
```python
# sruth/oideachais/baml_client/types.py
...
```typescript
// sruth/oideachais/web/src/server/contracts/curriculum.ts
...
```python
# sruth/oideachais/web/src/server/router.py
...
```python
# sruth/oideachais/mcp/curriculum.py
