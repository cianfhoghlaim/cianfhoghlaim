"""orchestration.pipelines.education.tertiary.british_isles — the per-pipeline Component home (Wave 2).

This module is the canonical home for the per-pipeline Component
that was migrated from `orchestration.defs.british_isles_tertiary` as part of the
...
_legacy_mod_path = 'orchestration.defs.british_isles_tertiary'
_legacy_backup_relpath = 'orchestration/defs/british_isles_tertiary.legacy.bak'
...
# `orchestration.defs.british_isles_tertiary` (the shim points back to this module,
...
_REEXPORT_SYMBOLS = ['bitertiary_bulk_scrape', 'bitertiary_extract_courses', 'bitertiary_extract_modules', 'bitertiary_extract_programmes', 'bitertiary_pre_research']
...
_DEPRECATION_MSG = (
    ...
    f"import from `orchestration.pipelines.education.tertiary.british_isles` instead. The legacy module will be "
