"""orchestration.pipelines.education.tertiary.nui_federation — the per-pipeline Component home (Wave 2).

This module is the canonical home for the per-pipeline Component
that was migrated from `orchestration.defs.nui_federation` as part of the
...
_legacy_mod_path = 'orchestration.defs.nui_federation'
_legacy_backup_relpath = 'orchestration/defs/nui_federation.legacy.bak'
...
# `orchestration.defs.nui_federation` (the shim points back to this module,
...
_REEXPORT_SYMBOLS = ['nui_archive_ingest', 'nui_constituents_scrape', 'nui_federation_audit']
...
_DEPRECATION_MSG = (
    ...
    f"import from `orchestration.pipelines.education.tertiary.nui_federation` instead. The legacy module will be "
