"""orchestration.pipelines.education.tertiary.uog.personal_archive — the per-pipeline Component home (Wave 2).

This module is the canonical home for the per-pipeline Component
that was migrated from `orchestration.defs.uog_personal_archive` as part of the
...
_legacy_mod_path = 'orchestration.defs.uog_personal_archive'
_legacy_backup_relpath = 'orchestration/defs/uog_personal_archive.legacy.bak'
...
# `orchestration.defs.uog_personal_archive` (the shim points back to this module,
...
_REEXPORT_SYMBOLS = ['uog_personal_archive_baml_extract', 'uog_personal_archive_duckdb_sink', 'uog_personal_archive_embed_lance', 'uog_personal_archive_stage0_audit', 'uog_personal_archive_stage1_collect', 'uog_personal_archive_typed_join']
...
_DEPRECATION_MSG = (
    ...
    f"import from `orchestration.pipelines.education.tertiary.uog.personal_archive` instead. The legacy module will be "
    "removed in a future release."
)
warnings.warn(_DEPRECATION_MSG, DeprecationWarning, stacklevel=2)

__all__ = ['uog_personal_archive_baml_extract', 'uog_personal_archive_duckdb_sink', 'uog_personal_archive_embed_lance', 'uog_personal_archive_stage0_audit', 'uog_personal_archive_stage1_collect', 'uog_personal_archive_typed_join']
