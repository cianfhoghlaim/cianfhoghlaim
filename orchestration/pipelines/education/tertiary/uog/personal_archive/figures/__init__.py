"""orchestration.pipelines.education.tertiary.uog.personal_archive.figures — the per-pipeline Component home (Wave 2).

This module is the canonical home for the per-pipeline Component
that was migrated from `orchestration.defs.uog_personal_archive_figures` as part of the
...
_legacy_mod_path = 'orchestration.defs.uog_personal_archive_figures'
_legacy_backup_relpath = 'orchestration/defs/uog_personal_archive_figures.legacy.bak'
...
# `orchestration.defs.uog_personal_archive_figures` (the shim points back to this module,
...
_loader = importlib.machinery.SourceFileLoader(
    'orchestration.defs.uog_personal_archive_figures',
...
_REEXPORT_SYMBOLS = ['FIGURES_DIR', 'uog_personal_archive_thesis_figures']
...
_DEPRECATION_MSG = (
    ...
    f"import from `orchestration.pipelines.education.tertiary.uog.personal_archive.figures` instead. The legacy module will be "
