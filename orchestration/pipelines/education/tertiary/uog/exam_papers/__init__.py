"""orchestration.pipelines.education.tertiary.uog.exam_papers — the per-pipeline Component home (Wave 2).

This module is the canonical home for the per-pipeline Component
that was migrated from `orchestration.defs.uog_exam` as part of the
...
_legacy_mod_path = 'orchestration.defs.uog_exam'
_legacy_backup_relpath = 'orchestration/defs/uog_exam.legacy.bak'
...
# `orchestration.defs.uog_exam` (the shim points back to this module,
...
_REEXPORT_SYMBOLS = ['GROUP_NAME', 'uog_exam_assets', 'uog_exam_login_health', 'uog_exam_module_discovery', 'uog_exam_papers_download', 'uog_exam_papers_ocr_extract', 'uog_exam_los_map', 'uog_exam_papers_nightly', 'build_uog_exam_definitions']
...
_DEPRECATION_MSG = (
    ...
    f"import from `orchestration.pipelines.education.tertiary.uog.exam_papers` instead. The legacy module will be "
