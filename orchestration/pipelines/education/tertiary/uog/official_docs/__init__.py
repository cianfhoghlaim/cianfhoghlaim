"""orchestration.pipelines.education.tertiary.uog.official_docs — the per-pipeline Component home (Wave 2).

This module is the canonical home for the per-pipeline Component
that was migrated from `orchestration.defs.uog_official_docs` as part of the
...
_legacy_mod_path = 'orchestration.defs.uog_official_docs'
_legacy_backup_relpath = 'orchestration/defs/uog_official_docs.legacy.bak'
...
# `orchestration.defs.uog_official_docs` (the shim points back to this module,
...
_REEXPORT_SYMBOLS = ['uog_official_docs_baml_extract', 'uog_official_docs_duckdb_sink', 'uog_official_docs_embed_lance', 'uog_official_docs_stage0_audit', 'uog_official_docs_stage1_collect']
...
_DEPRECATION_MSG = (
    ...
    f"import from `orchestration.pipelines.education.tertiary.uog.official_docs` instead. The legacy module will be "
