"""orchestration.defs.uog_personal_archive — DEPRECATION SHIM.

This module has been moved to `orchestration.pipelines.education.tertiary.uog.personal_archive` as part of
...
_ORIGINAL_MODULE = 'orchestration.defs.uog_personal_archive'
_DESTINATION_MODULE = 'orchestration.pipelines.education.tertiary.uog.personal_archive'
...
from orchestration.pipelines.education.tertiary.uog.personal_archive import *  # noqa: E402, F401, F403
