...
def _pipeline_factory():
    ...
    from dlt_sources.education.crown_dependencies.british_isles.education.crown_dependencies_jurisdiction_pipeline import (
...
def build_crown_dependencies_documents_ingested():
