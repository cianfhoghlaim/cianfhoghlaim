...
def _(
    ...
    print("-" * 50)
    print(f"{'Beginner':<15} {beginner['effective_apy']*100:>9.1f}% {beginner['pending_rewards']:>19.2f}")
    print(f"{'Intermediate':<15} {intermediate['effective_apy']*100:>9.1f}% {intermediate['pending_rewards']:>19.2f}")
    print(f"{'Fluent':<15} {fluent['effective_apy']*100:>9.1f}% {fluent['pending_rewards']:>19.2f}")
    return (
        beginner,
