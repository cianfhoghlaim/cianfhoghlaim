"""M8 entrypoint — Jersey pipeline (120 cohorts).

Per the 2026-08-13-biep-v3-systematic-download-ireland-england-v1 change.

Runs the 5-phase pattern for the 120 Jersey cohorts (30 subjects ×
4 qualification levels: GCSE + A-Level + IB + French Bac).
...
logger = logging.getLogger("biiep_v3_m8")
