...
from sruth.oideachais.data_platform.dlt_sources.ireland.curriculum_source import curriculum_source

pipeline = dlt.pipeline(
    pipeline_name="curriculum_unified", destination="duckdb", dataset_name="curriculum"
)
