...
``dlt/european_nations/prt/law/statute_book.py`` with
``source_id="european_nations.prt.law.statute_book"`` and lands in
the DuckLake table ``oideachais.law.european_nations.prt``.

Honours ``USE_LOCAL_SCRAPES=true`` by reading from
``stedding/ingest_queue/european_nations/prt/law/<lang>/``.
...
class PortugalLawSource(NationSource):
    ...
    def __init__(self) -> None:
        super().__init__(
            ...
            extra_metadata={
                "canonical_root": "https://diariodarepublica.pt",
                "title": "Diário da República (Portugal)",
            },
        )
...
def statute_book(language: str | None = None) -> Iterator[dict[str, Any]]:
    """Yield Portugal law rows from the canonical cache."""
...
def statute_book_source(language: str | None = None):
    """DLT source for the Diário da República (Portugal) ingestion."""
