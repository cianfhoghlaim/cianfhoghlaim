...
def en_english(language: str | None = None) -> Iterator[dict[str, Any]]:
    """Yield England english syllabus rows from the canonical cache.
    ...
    cache_dir = Path("stedding/site_scrape_samples/biep/en/english")
...
@dlt.source(name="en_english")
def en_english_source(language: str | None = None):
    """DLT source for the England english ingestion."""
    return en_english(language=language)
