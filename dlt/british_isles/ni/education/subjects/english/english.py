...
def ni_english(language: str | None = None) -> Iterator[dict[str, Any]]:
    """Yield Northern Ireland english syllabus rows from the canonical cache.
    ...
    cache_dir = Path("stedding/site_scrape_samples/biep/ni/english")
...
@dlt.source(name="ni_english")
def ni_english_source(language: str | None = None):
    """DLT source for the Northern Ireland english ingestion."""
    return ni_english(language=language)
