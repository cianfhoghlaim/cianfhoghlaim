...
1. `upstream_blog_monitor_ingest` — runs the DLT source
   `dlt_sources.domains.cross.upstream.blog_post.upstream_blog_post_source`
...
def _load_dlt() -> Any:
    ...
    from dlt_sources.domains.cross.upstream.blog_post import (
...
@dg.asset(
    ...
    metadata={
        ...
        "dlt_source": "dlt_sources.domains.cross.upstream.blog_post",
