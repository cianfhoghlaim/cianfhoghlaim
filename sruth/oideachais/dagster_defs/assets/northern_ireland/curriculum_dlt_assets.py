...
def create_key_stage_asset(key_stage: str):
    ...
    def _key_stage_asset(context) -> dg.MaterializeResult:
        ...
        from sruth.oideachais.dlt_sources.northern_ireland.curriculum_registry import SubjectRegistry
        ...
        context.log.info(
            f"Ingesting: northern_ireland/{key_stage}/{subject}/{language}"
        )
        ...
        context.log.info(f"Loaded {rows_loaded} rows for northern_ireland/{key_stage}/{subject}/{language}")
