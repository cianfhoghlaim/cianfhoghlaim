...
def leabharlann_books_raw(context) -> dg.MaterializeResult:
    ...
    from dlt_sources.author_archive import leabharlann_books_source
...
def leabharlann_zotero_raw(context) -> dg.MaterializeResult:
    ...
    from dlt_sources.author_archive import zotero_source
...
def leabharlann_takeout_v1_raw(context) -> dg.MaterializeResult:
    ...
    from dlt_sources.author_archive import takeout_v1_source
