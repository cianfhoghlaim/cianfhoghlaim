"""oideachais.dlt_sources.domains.cross — the 7th dlt_sources domain.
...
1. Be importable as `dlt_sources.domains.cross.<area>`.
...
from dlt_sources.domains.cross import upstream
