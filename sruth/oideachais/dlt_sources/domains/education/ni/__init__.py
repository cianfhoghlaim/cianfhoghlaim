"""oideachais.dlt_sources.domains.education.{nation} package init — re-export shim.

Each nation sub-package re-exports its legacy address so that:
  * `from oideachais.dlt_sources.domains.education.ni.ccea_curriculum import ni_curriculum_source`
    and
