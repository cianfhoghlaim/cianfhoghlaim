...
- [`sruth/oideachais/README.md`](README.md) — the user-facing overview
- [`sruth/oideachais/STATUS.md`](STATUS.md) — the single source of truth for
  the BAML × dlt × Dagster × CocoIndex matrix
- [`sruth/oideachais/REFACTORING.md`](REFACTORING.md) — the refactor backlog
