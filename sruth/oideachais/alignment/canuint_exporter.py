...
def export_all_formats(
    ...
    ljspeech_count = export_ljspeech(
        word_alignments,
    ...
    textgrid_count = export_textgrid(
    ...
    if character_alignments:
        ...
        char_count = export_character_json(
    ...
    if phoneme_alignments:
        ...
        phoneme_count = export_phoneme_alignments(
            phoneme_alignments,
