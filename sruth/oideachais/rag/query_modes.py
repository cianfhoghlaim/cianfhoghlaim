...
class CurriculumQueryParam:
    ...
    level_filter: Optional[Literal["junior", "senior", "primary"]] = None
    ...
    exam_years: Optional[list[int]] = None
    ...
    @classmethod
    def for_concept_lookup(cls, subject: Optional[str] = None) -> "CurriculumQueryParam":
