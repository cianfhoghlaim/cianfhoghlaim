...
| `embedding` | `unified_embedding_assets.py` | cocoindex/lancedb | `unified_embeddings` (DuckDB → `unified_embeddings` LanceDB), `code_embeddings` (`UNIFIED_CODE_ROOT` → `code_embeddings` LanceDB) |
