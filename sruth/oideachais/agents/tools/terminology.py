...
class TerminologyEntry(BaseModel):
    ...
    term_ga: Optional[str] = Field(default=None, description="Irish term")
    term_en: Optional[str] = Field(default=None, description="English term")
    term_gd: Optional[str] = Field(default=None, description="Scottish Gaelic term")
    term_cy: Optional[str] = Field(default=None, description="Welsh term")
    domain: str = Field(description="Subject domain")
    sub_domain: Optional[str] = Field(default=None, description="Sub-domain")
    definition: Optional[str] = Field(default=None, description="Definition")
    notes: Optional[str] = Field(default=None, description="Usage notes")
