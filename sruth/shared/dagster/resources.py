...
class CogneeResource(dg.ConfigurableResource):
    ...
    # FalkorDB connection
    graph_uri: str = Field(
        default_factory=lambda: os.getenv("COGNEE_GRAPH_URI", os.getenv("FALKORDB_URI", "redis://localhost:6379")),
    ...
    vector_uri: str = Field(
        default_factory=lambda: os.getenv("COGNEE_VECTOR_URI", os.getenv("LANCEDB_URI", "./lancedb_data")),
