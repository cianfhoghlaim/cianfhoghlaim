/**
 * STUB BAML TypeScript client for lc/accounting.
 * 
...
export type AccountingSyllabus = unknown;
export type AccountingPaper = unknown;
export type AccountingMarkingScheme = unknown;
export type AccountingTopics = unknown;
