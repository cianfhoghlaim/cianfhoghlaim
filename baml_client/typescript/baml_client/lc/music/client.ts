/**
 * STUB BAML TypeScript client for lc/music.
 * 
...
export type MusicSyllabus = unknown;
export type MusicPaper = unknown;
export type MusicMarkingScheme = unknown;
export type MusicTopics = unknown;
