/**
 * STUB BAML TypeScript client for lc/art.
 * 
...
export type ArtSyllabus = unknown;
export type ArtPaper = unknown;
export type ArtMarkingScheme = unknown;
export type ArtTopics = unknown;
