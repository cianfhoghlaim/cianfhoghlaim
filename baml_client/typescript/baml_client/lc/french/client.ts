/**
 * STUB BAML TypeScript client for lc/french.
 * 
...
export type FrenchSyllabus = unknown;
export type FrenchPaper = unknown;
export type FrenchMarkingScheme = unknown;
export type FrenchTopics = unknown;
