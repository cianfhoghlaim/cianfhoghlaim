/**
 * STUB BAML TypeScript client for lc/computer_science.
 * 
...
export type ComputerScienceSyllabus = unknown;
export type ComputerSciencePaper = unknown;
export type ComputerScienceMarkingScheme = unknown;
export type ComputerScienceTopics = unknown;
