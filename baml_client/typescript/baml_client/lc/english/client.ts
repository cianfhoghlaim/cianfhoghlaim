/**
 * STUB BAML TypeScript client for lc/english.
 * 
...
export type EnglishSyllabus = unknown;
export type EnglishPaper = unknown;
export type EnglishMarkingScheme = unknown;
export type EnglishTopics = unknown;
