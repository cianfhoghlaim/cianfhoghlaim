/**
 * STUB BAML TypeScript client for jc/gaeilge.
 * 
...
export type GaeilgeSyllabus = unknown;
export type GaeilgePaper = unknown;
export type GaeilgeMarkingScheme = unknown;
export type GaeilgeTopics = unknown;
