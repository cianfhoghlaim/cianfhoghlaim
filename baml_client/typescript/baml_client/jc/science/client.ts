/**
 * STUB BAML TypeScript client for jc/science.
 * 
...
export type ScienceSyllabus = unknown;
export type SciencePaper = unknown;
export type ScienceMarkingScheme = unknown;
export type ScienceTopics = unknown;
