/**
 * STUB BAML TypeScript client for a-level/english_language.
 * 
...
export type EnglishLanguageSyllabus = unknown;
export type EnglishLanguagePaper = unknown;
export type EnglishLanguageMarkingScheme = unknown;
export type EnglishLanguageTopics = unknown;
