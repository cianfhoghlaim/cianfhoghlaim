/**
 * STUB BAML TypeScript client for a-level/english_literature.
 * 
...
export type EnglishLiteratureSyllabus = unknown;
export type EnglishLiteraturePaper = unknown;
export type EnglishLiteratureMarkingScheme = unknown;
export type EnglishLiteratureTopics = unknown;
