/**
 * STUB BAML TypeScript client for a-level/mathematics.
 * 
...
export type MathematicsSyllabus = unknown;
export type MathematicsPaper = unknown;
export type MathematicsMarkingScheme = unknown;
export type MathematicsTopics = unknown;
