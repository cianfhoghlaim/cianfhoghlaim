/**
 * STUB BAML TypeScript client for a-level/geography.
 * 
...
export type GeographySyllabus = unknown;
export type GeographyPaper = unknown;
export type GeographyMarkingScheme = unknown;
export type GeographyTopics = unknown;
