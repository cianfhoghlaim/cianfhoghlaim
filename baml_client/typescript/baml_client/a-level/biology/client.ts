/**
 * STUB BAML TypeScript client for a-level/biology.
 * 
...
export type BiologySyllabus = unknown;
export type BiologyPaper = unknown;
export type BiologyMarkingScheme = unknown;
export type BiologyTopics = unknown;
