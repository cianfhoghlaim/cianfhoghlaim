/**
 * STUB BAML TypeScript client for a-level/politics.
 * 
...
export type PoliticsSyllabus = unknown;
export type PoliticsPaper = unknown;
export type PoliticsMarkingScheme = unknown;
export type PoliticsTopics = unknown;
