/**
 * STUB BAML TypeScript client for a-level/economics.
 * 
...
export type EconomicsSyllabus = unknown;
export type EconomicsPaper = unknown;
export type EconomicsMarkingScheme = unknown;
export type EconomicsTopics = unknown;
