/**
 * STUB BAML TypeScript client for a-level/business.
 * 
...
export type BusinessSyllabus = unknown;
export type BusinessPaper = unknown;
export type BusinessMarkingScheme = unknown;
export type BusinessTopics = unknown;
