/**
 * STUB BAML TypeScript client for a-level/history.
 * 
...
export type HistorySyllabus = unknown;
export type HistoryPaper = unknown;
export type HistoryMarkingScheme = unknown;
export type HistoryTopics = unknown;
