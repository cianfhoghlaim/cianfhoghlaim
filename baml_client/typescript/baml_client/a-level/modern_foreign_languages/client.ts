/**
 * STUB BAML TypeScript client for a-level/modern_foreign_languages.
 * 
...
export type ModernForeignLanguagesSyllabus = unknown;
export type ModernForeignLanguagesPaper = unknown;
export type ModernForeignLanguagesMarkingScheme = unknown;
export type ModernForeignLanguagesTopics = unknown;
