/**
 * STUB BAML TypeScript client for a-level/chemistry.
 * 
...
export type ChemistrySyllabus = unknown;
export type ChemistryPaper = unknown;
export type ChemistryMarkingScheme = unknown;
export type ChemistryTopics = unknown;
