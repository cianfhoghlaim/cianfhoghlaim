/**
 * STUB BAML TypeScript client for a-level/sociology.
 * 
...
export type SociologySyllabus = unknown;
export type SociologyPaper = unknown;
export type SociologyMarkingScheme = unknown;
export type SociologyTopics = unknown;
