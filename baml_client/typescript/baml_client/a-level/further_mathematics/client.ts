/**
 * STUB BAML TypeScript client for a-level/further_mathematics.
 * 
...
export type FurtherMathematicsSyllabus = unknown;
export type FurtherMathematicsPaper = unknown;
export type FurtherMathematicsMarkingScheme = unknown;
export type FurtherMathematicsTopics = unknown;
