/**
 * STUB BAML TypeScript client for a-level/psychology.
 * 
...
export type PsychologySyllabus = unknown;
export type PsychologyPaper = unknown;
export type PsychologyMarkingScheme = unknown;
export type PsychologyTopics = unknown;
