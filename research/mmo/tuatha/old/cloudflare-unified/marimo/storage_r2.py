...
@app.cell
def _(account_id, df, mo, r2_secret_form, r2_token_form):
    ...
    return CF_ACCOUNT_ID, CF_API_TOKEN, R2_SECRET, R2_TOKEN
...
@app.cell
def _(CF_ACCOUNT_ID, CF_API_TOKEN, Request, json, pd, proxy, urllib, urlopen):
...
def _(mo):
    mo.md(r"""
    We can then obtain extra info on each bucket by adding its name on the endpoint:
    """)
    return
