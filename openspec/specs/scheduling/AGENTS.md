# `scheduling` — Agent Routing

> `scheduling` is a capability of the Cianfhoghlaim platform. This document is the canonical capability spec; the corresponding source code lives in the appropriate quadrant. See `docs/00_index.md` for ...
...
- `openspec/specs/scheduling/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/scheduling/spec.md` and re-run
