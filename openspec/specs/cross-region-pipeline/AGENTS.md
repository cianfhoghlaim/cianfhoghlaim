# `cross-region-pipeline` — Agent Routing

> ## Purpose This umbrella spec extends `cianfhoghlaim-pipeline` (the British Isles scoped pipeline) i...
...
- `openspec/specs/cross-region-pipeline/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/cross-region-pipeline/spec.md` and re-run
