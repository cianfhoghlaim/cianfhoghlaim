# `bonneagar-tuatha-iac-stack` — Agent Routing
...
- `openspec/specs/bonneagar-tuatha-iac-stack/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/bonneagar-tuatha-iac-stack/spec.md` and re-run
