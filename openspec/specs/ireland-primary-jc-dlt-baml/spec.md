...
### Requirement: Canonical spec SHALL list 5 dlt sources
The change SHALL add 2 new dlt sources: `oideachais/dlt_sources/ireland/primary.py` (4 resources) and `oideachais/dlt_sources/ireland/junior_cycle.py` (3 resources). After the change, the Ireland folder SHALL have 5 dlt sources: `aistear.py`, `senior_cycle.py`, `primary.py` (new), `junior_cycle.py` (new), `leaving_cert.py`.

#### Scenario: All 5 sources import
- **GIVEN** the change is complete
- **WHEN** `oideachais/dlt_sources/ireland/__init__.py` is loaded
- **THEN** all 5 source factories SHALL be re-exported and importable
