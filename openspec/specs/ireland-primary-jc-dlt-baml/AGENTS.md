# `ireland-primary-jc-dlt-baml` — Agent Routing
...
- `openspec/specs/ireland-primary-jc-dlt-baml/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/ireland-primary-jc-dlt-baml/spec.md` and re-run
