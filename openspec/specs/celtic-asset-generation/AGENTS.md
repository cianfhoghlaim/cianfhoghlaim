# `celtic-asset-generation` — Agent Routing
...
- `openspec/specs/celtic-asset-generation/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/celtic-asset-generation/spec.md` and re-run
