# `meaisinfhoghlaim-ocr-htr` — Agent Routing
...
- `openspec/specs/meaisinfhoghlaim-ocr-htr/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/meaisinfhoghlaim-ocr-htr/spec.md` and re-run
