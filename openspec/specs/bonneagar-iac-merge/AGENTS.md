# `bonneagar-iac-merge` — Agent Routing
...
- `openspec/specs/bonneagar-iac-merge/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/bonneagar-iac-merge/spec.md` and re-run
