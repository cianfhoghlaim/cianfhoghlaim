# `cianfhoghlaim-cognify-knowledge-graph` — Agent Routing
...
- `openspec/specs/cianfhoghlaim-cognify-knowledge-graph/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/cianfhoghlaim-cognify-knowledge-graph/spec.md` and re-run
