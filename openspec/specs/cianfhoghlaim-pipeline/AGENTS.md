# `cianfhoghlaim-pipeline` — Agent Routing

> `cianfhoghlaim-pipeline` is a capability of the Cianfhoghlaim platform. This document is the canonical capability spec; the corresponding source code lives in the appropriate quadrant. See `docs/00_in...
...
- `openspec/specs/cianfhoghlaim-pipeline/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/cianfhoghlaim-pipeline/spec.md` and re-run
