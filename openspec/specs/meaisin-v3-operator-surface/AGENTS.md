# `meaisin-v3-operator-surface` — Agent Routing
...
- `openspec/specs/meaisin-v3-operator-surface/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/meaisin-v3-operator-surface/spec.md` and re-run
