# `croilar-portfolio` — Agent Routing

> `croilar-portfolio` is a capability of the Cianfhoghlaim platform. This document is the canonical capability spec; the corresponding source code lives in the appropriate quadrant. See `docs/00_index.m...
...
- `openspec/specs/croilar-portfolio/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/croilar-portfolio/spec.md` and re-run
