# `british-isles-education-pipeline-v2` — Agent Routing
...
- `openspec/specs/british-isles-education-pipeline-v2/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/british-isles-education-pipeline-v2/spec.md` and re-run
