# `agent-platform-cluster` — Agent Routing
...
- `openspec/specs/agent-platform-cluster/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/agent-platform-cluster/spec.md` and re-run
