# `infrastructure-stacks-documentation` — Agent Routing
...
- `openspec/specs/infrastructure-stacks-documentation/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/infrastructure-stacks-documentation/spec.md` and re-run
