# `official-media-marimo` — Agent Routing
...
- `openspec/specs/official-media-marimo/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/official-media-marimo/spec.md` and re-run
