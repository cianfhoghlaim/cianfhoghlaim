# `bie-8-jurisdictions` — Agent Routing
...
- `openspec/specs/bie-8-jurisdictions/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/bie-8-jurisdictions/spec.md` and re-run
