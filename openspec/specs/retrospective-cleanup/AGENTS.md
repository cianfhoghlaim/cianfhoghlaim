# `retrospective-cleanup` — Agent Routing

> The retroactive cleanup of the 1959 pre-v7 path drift occurrences that `sync:paths` surfaced + the extension of the existing sync loop with `sync:dagster` (Layer 6 — the biggest remaining gap in the s...
...
- `openspec/specs/retrospective-cleanup/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/retrospective-cleanup/spec.md` and re-run
