...
- `openspec/specs/european-union-official-language-pipeline/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/european-union-official-language-pipeline/spec.md` and re-run
