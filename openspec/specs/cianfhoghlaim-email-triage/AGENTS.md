# `cianfhoghlaim-email-triage` — Agent Routing

> `cianfhoghlaim-email-triage` is a capability of the Cianfhoghlaim
...
- `openspec/specs/cianfhoghlaim-email-triage/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/cianfhoghlaim-email-triage/spec.md` and re-run
