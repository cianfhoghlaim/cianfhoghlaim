# `spaces-cicd-pipeline` — Agent Routing
...
- `openspec/specs/spaces-cicd-pipeline/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/spaces-cicd-pipeline/spec.md` and re-run
