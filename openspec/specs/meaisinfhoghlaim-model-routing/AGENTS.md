# `meaisinfhoghlaim-model-routing` — Agent Routing

> The model routing logic at `meaisinfhoghlaim/models/routing.py` — the routing function that decides which OCR/VLM/embedder model to invoke per request. Routes every model invocation through `MODEL_REG...
...
- `openspec/specs/meaisinfhoghlaim-model-routing/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/meaisinfhoghlaim-model-routing/spec.md` and re-run
