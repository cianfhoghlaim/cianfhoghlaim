# `docs-informed-content-generation` — Agent Routing

> The docs-informed content generation surface covers the docs → content pipeline (notebooks → blog posts → social cards → tutorials) across the Cianfhoghlaim monorepo. It defines 2 invariants: the cano...
...
- `openspec/specs/docs-informed-content-generation/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/docs-informed-content-generation/spec.md` and re-run
