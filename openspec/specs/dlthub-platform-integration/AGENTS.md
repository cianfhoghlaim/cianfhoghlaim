# `dlthub-platform-integration` — Agent Routing
...
- `openspec/specs/dlthub-platform-integration/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/dlthub-platform-integration/spec.md` and re-run
