# `cianfhoghlaim-pdf-processing` — Agent Routing
...
- `openspec/specs/cianfhoghlaim-pdf-processing/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/cianfhoghlaim-pdf-processing/spec.md` and re-run
