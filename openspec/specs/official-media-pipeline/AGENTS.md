# `official-media-pipeline` — Agent Routing
...
- `openspec/specs/official-media-pipeline/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/official-media-pipeline/spec.md` and re-run
