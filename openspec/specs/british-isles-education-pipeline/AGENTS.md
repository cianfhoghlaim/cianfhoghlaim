# `british-isles-education-pipeline` — Agent Routing
...
- `openspec/specs/british-isles-education-pipeline/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/british-isles-education-pipeline/spec.md` and re-run
