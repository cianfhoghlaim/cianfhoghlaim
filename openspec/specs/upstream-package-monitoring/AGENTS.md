# `upstream-package-monitoring` — Agent Routing
...
- `openspec/specs/upstream-package-monitoring/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/upstream-package-monitoring/spec.md` and re-run
