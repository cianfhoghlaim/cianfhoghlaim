# `croilar-devtools-hub` — Agent Routing
...
- `openspec/specs/croilar-devtools-hub/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/croilar-devtools-hub/spec.md` and re-run
