# `retro-game-design-catalogue` — Agent Routing

> Catalogue the **design patterns** (not the literal assets) of retro
...
- `openspec/specs/retro-game-design-catalogue/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/retro-game-design-catalogue/spec.md` and re-run
