# `multimodal-code-and-media-intel` — Agent Routing
...
- `openspec/specs/multimodal-code-and-media-intel/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/multimodal-code-and-media-intel/spec.md` and re-run
