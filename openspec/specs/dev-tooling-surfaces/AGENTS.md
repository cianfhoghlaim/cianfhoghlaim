# `dev-tooling-surfaces` — Agent Routing

> The dev-tooling surfaces capability codifies the surface-refactor pattern (Firecrawl research → mise tasks → openspec spec deltas → docs roll-up) used for every dev-environment tool/library update. It...
...
- `openspec/specs/dev-tooling-surfaces/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/dev-tooling-surfaces/spec.md` and re-run
