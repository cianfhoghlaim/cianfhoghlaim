# `baml-quality-bulk-sweep` — Agent Routing

> The BAML quality bulk-sweep surface codifies the 3-day BAML quality pass across the Cianfhoghlaim monorepo. It defines 4 invariants: every BAML function gets a test block (the 11 test types), every ex...
...
- `openspec/specs/baml-quality-bulk-sweep/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/baml-quality-bulk-sweep/spec.md` and re-run
