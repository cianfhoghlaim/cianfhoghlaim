# `agent-runtime-and-attribution` — Agent Routing
...
- `openspec/specs/agent-runtime-and-attribution/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/agent-runtime-and-attribution/spec.md` and re-run
