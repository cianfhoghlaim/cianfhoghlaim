# `meaisin-24-ocr-models` — Agent Routing
...
- `openspec/specs/meaisin-24-ocr-models/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/meaisin-24-ocr-models/spec.md` and re-run
