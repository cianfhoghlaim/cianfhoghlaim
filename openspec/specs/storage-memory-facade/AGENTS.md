# `storage-memory-facade` — Agent Routing
...
- `openspec/specs/storage-memory-facade/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/storage-memory-facade/spec.md` and re-run
