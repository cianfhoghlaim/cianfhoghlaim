# `meaisinfoghlaim-ocr-htr` — Agent Routing

> The meaisínfhoghlaim OCR & HTR capability covers the 24-entry OCR/HTR/VLM model registry + the 6 CLASSICAL_OCR backends + the BIEP v2 4-path EnsembledExtractor across the Cianfhoghlaim monorepo. It de...
...
- `openspec/specs/meaisinfoghlaim-ocr-htr/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/meaisinfoghlaim-ocr-htr/spec.md` and re-run
