# `end-to-end-llm-zoomcamp-style-tutorial` — Agent Routing

> The Cianfhoghlaim `notebooks/` folder currently holds 50+ marimo notebooks split across 13 numbered directories, organised by **stage** (`01_dev_env` / `02_vision_models` / `03_leaving_cert` / ...) ra...
...
- `openspec/specs/end-to-end-llm-zoomcamp-style-tutorial/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/end-to-end-llm-zoomcamp-style-tutorial/spec.md` and re-run
