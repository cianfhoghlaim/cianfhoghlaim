# `workflow-automation` — Agent Routing

> `workflow-automation` is a capability of the Cianfhoghlaim platform. This document is the canonical capability spec; the corresponding source code lives in the appropriate quadrant. See `docs/00_index...
...
- `openspec/specs/workflow-automation/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/workflow-automation/spec.md` and re-run
