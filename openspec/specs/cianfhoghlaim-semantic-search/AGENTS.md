# `cianfhoghlaim-semantic-search` — Agent Routing

> `cianfhoghlaim-semantic-search` is a capability of the Cianfhoghlaim platform. The
...
- `openspec/specs/cianfhoghlaim-semantic-search/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/cianfhoghlaim-semantic-search/spec.md` and re-run
