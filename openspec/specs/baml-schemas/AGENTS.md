# `baml-schemas` — Agent Routing

> The BAML schemas surface codifies the BAML ClientRegistry pattern for OCR ensemble fallback chains across the Cianfhoghlaim monorepo. It defines 2 invariants: the canonical BAML file layout (per the c...
...
- `openspec/specs/baml-schemas/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/baml-schemas/spec.md` and re-run
