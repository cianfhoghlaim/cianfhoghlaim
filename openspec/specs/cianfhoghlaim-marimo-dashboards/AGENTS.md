# `cianfhoghlaim-marimo-dashboards` — Agent Routing

> `cianfhoghlaim-marimo-dashboards` is a capability of the Cianfhoghlaim
...
- `openspec/specs/cianfhoghlaim-marimo-dashboards/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/cianfhoghlaim-marimo-dashboards/spec.md` and re-run
