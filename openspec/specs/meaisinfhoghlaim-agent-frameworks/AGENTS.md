# `meaisinfhoghlaim-agent-frameworks` — Agent Routing
...
- `openspec/specs/meaisinfhoghlaim-agent-frameworks/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/meaisinfhoghlaim-agent-frameworks/spec.md` and re-run
