# cianfhoghlaim Specification

## Purpose

Codify the canonical cianfhoghlaim surface — what stays in this
monorepo vs what lives in sister repos. The 4 Requirements encode:
(1) the British-Isles Education Pipeline (BIEP) is the cianfhoghlaim
flagship, (2) the CIANCHEILTIS bilingual alignment stays in
cianfhoghlaim, (3) the Tuatha educational MMO + 8 NCCA subject agents
stay, (4) the Bonneagar IaC stack (89 Compose stacks + Komodo +
Pangolin + Locket + Infisical) stays. Without this spec every
refactor risks drifting work between forks or losing the canonical
surface to drift.
