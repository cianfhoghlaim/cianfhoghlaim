# `official-media-fediverse` — Agent Routing
...
- `openspec/specs/official-media-fediverse/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/official-media-fediverse/spec.md` and re-run
