# `meaisinfhoghlaim-platform` — Agent Routing
...
- `openspec/specs/meaisinfhoghlaim-platform/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/meaisinfhoghlaim-platform/spec.md` and re-run
