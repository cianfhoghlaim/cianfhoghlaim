# `croilar-data-engineering` — Agent Routing

> `croilar-data-engineering` is a capability of the Cianfhoghlaim platform. This document is the canonical capability spec; the corresponding source code lives in the appropriate quadrant. See `docs/00_...
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/croilar-data-engineering/spec.md` and re-run
