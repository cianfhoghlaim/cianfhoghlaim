# `agent-observability` — Agent Routing
...
agents:smoke              # Run smoke tests
```

## Key sources

- `openspec/specs/agent-observability/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/agent-observability/spec.md` and re-run
