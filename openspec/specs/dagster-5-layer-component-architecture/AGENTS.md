# `dagster-5-layer-component-architecture` — Agent Routing
...
- `openspec/specs/dagster-5-layer-component-architecture/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/dagster-5-layer-component-architecture/spec.md` and re-run
