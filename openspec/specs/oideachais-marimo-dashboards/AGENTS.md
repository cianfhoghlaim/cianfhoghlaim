# `oideachais-marimo-dashboards` — Agent Routing
...
- `openspec/specs/oideachais-marimo-dashboards/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/oideachais-marimo-dashboards/spec.md` and re-run
