# `cianfhoghlaim-university-deep-extraction` — Agent Routing
...
- `openspec/specs/cianfhoghlaim-university-deep-extraction/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/cianfhoghlaim-university-deep-extraction/spec.md` and re-run
