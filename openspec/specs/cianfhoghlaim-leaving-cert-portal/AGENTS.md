# `cianfhoghlaim-leaving-cert-portal` — Agent Routing
...
- `openspec/specs/cianfhoghlaim-leaving-cert-portal/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/cianfhoghlaim-leaving-cert-portal/spec.md` and re-run
