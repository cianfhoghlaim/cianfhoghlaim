# `task-management` — Agent Routing

> `task-management` is a capability of the Cianfhoghlaim platform. This document is the canonical capability spec; the corresponding source code lives in the appropriate quadrant. See `docs/00_index.md`...
...
- `openspec/specs/task-management/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/task-management/spec.md` and re-run
