# `agentic-frontend-frameworks` — Agent Routing
...
- `openspec/specs/agentic-frontend-frameworks/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/agentic-frontend-frameworks/spec.md` and re-run
