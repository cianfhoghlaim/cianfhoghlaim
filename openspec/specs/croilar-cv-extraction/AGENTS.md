# `croilar-cv-extraction` — Agent Routing

> `croilar-cv-extraction` is a capability of the Cianfhoghlaim platform. This document is the canonical capability spec; the corresponding source code lives in the appropriate quadrant. See `docs/00_ind...
...
- `openspec/specs/croilar-cv-extraction/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/croilar-cv-extraction/spec.md` and re-run
