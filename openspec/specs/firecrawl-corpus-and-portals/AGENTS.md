# `firecrawl-corpus-and-portals` — Agent Routing

> The Firecrawl observability surface covers every scrape call made via the Firecrawl MCP server (or SDK) across the Cianfhoghlaim monorepo. It defines 6 invariants: every firecrawl_* call MUST write 1 ...
...
- `openspec/specs/firecrawl-corpus-and-portals/spec.md` — the canonical spec
...
- Hand-edit this file (the generator will overwrite it). To customise,
  edit `openspec/specs/firecrawl-corpus-and-portals/spec.md` and re-run
