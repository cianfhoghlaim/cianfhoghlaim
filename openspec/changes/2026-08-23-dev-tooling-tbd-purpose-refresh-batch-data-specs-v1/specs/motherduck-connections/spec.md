...
### Requirement: spec-purpose-motherduck-connections (MODIFIED)
...
#### Scenario: MotherDuck Purpose is non-TBD

- **WHEN** `grep "TBD" openspec/specs/motherduck-connections/spec.md` runs
