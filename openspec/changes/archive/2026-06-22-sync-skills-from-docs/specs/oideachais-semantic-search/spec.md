# Spec Delta: oideachais-semantic-search
...
(None. The 2-embedding-model selection at the CocoIndex flow level is
preserved; the 10 new requirements above are additive.)
