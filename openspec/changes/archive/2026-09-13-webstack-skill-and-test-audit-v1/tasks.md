...
- [x] **B.1** `uv run pytest tests/webstack/ -v` all 10 pass
- [x] **B.2** `uv run openspec validate 2026-09-13-webstack-skill-and-test-audit-v1 --strict` exits 0
- [x] **B.3** `uv run openspec archive 2026-09-13-webstack-skill-and-test-audit-v1 --yes`
