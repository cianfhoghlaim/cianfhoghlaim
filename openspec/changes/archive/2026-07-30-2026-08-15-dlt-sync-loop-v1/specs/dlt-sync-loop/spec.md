# Spec delta: `dlt-sync-loop`

This delta is part of the openspec change
`2026-08-15-dlt-sync-loop-v1`. It registers the new `sync:dlt`
orchestrator + the 5 sub-layers + the new Cognee cluster + the
24th CCC concept guide.
