...
## 1. `oideachais/cocoindex_flows/api_indexing.py`
...
- [x] Functional test: 325 endpoints in `oideachais/` (4.7s)

## 2. `oideachais/cocoindex_flows/filesystem_indexing.py`
...
- [x] Functional test: 351 dirs in `oideachais/` (0.1s)

## 3. `oideachais/cocoindex_flows/storage_indexing.py`
...
- [x] Functional test: 151 backends in `oideachais/` (6.3s)

## 4. `oideachais/cocoindex_flows/config_indexing.py`
...
- [x] Functional test: 12 configs in `oideachais/` (10.6s)

## 5. `oideachais/dagster_defs/assets/infrastructure_assets.py`
