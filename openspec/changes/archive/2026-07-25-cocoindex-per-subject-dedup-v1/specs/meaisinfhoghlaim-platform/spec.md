...
`cocoindex_flows/subjects/lc_subject_embedding.py` that drives all 6 LC subjects
via `cocoindex_flows/subjects/lc_subject_config.yaml`. The 7 deprecated
...
- **GIVEN** the existing `oideachais.lc.mathematics.hl_en` LanceDB table
  was populated by the deprecated `cocoindex_flows/subjects/mathematics_embedding.py`
