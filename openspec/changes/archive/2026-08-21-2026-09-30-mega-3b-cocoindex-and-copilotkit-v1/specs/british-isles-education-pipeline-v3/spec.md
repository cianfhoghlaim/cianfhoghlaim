...
The system SHALL provide a single `cocoindex_flows/european_nations/_factory.py`
...
- **AND** the 40 hand-written `cocoindex_flows/european_nations/<country>/education_embedding.py`
  files are deleted
