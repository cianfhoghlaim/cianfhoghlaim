...
- **GIVEN** `sruth/oideachais/data_platform/dagster_defs/assets/aistear_kg.py`
...
- **GIVEN** `sruth/oideachais/data_platform/dagster_defs/assets/primary_kg.py`
...
- **GIVEN** `sruth/oideachais/data_platform/dagster_defs/assets/junior_cycle_kg.py`
...
- **GIVEN** `sruth/oideachais/data_platform/dagster_defs/assets/senior_cycle_kg.py`
...
- **GIVEN** `sruth/oideachais/data_platform/dagster_defs/assets/tertiary_kg.py`
...
- **GIVEN** `sruth/oideachais/data_platform/cognee_integration/cross_stage_cognify.py`
