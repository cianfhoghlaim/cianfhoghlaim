...
## Cross-references
- `web/hono-api/src/db/schema.ts` (the canonical Drizzle schema)
- `web/hono-api/src/db/client.ts` (the Drizzle client + the type aliases)
- `web/hono-api/src/db/migrations/2026-09-24-k12-agentic-tables.sql` (the DDL)
- `agents/meaisinfhoghlaim/educational/teachers/lesson_planner_agent.py` (writes here)
- `agents/meaisinfhoghlaim/educational/students_jc/homework_tracker_agent.py` (writes here)
