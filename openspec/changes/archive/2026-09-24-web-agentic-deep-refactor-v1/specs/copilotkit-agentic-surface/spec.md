...
- `web/apps/_shared/copilotkit/` (the shared module)
- `.agents/skills/copilotkit-agui-bridge/SKILL.md`
- `agents/integrations/agent_registry_runtime.py` (the canonical Python helpers)
- `openspec/changes/2026-09-23-upgrade-to-adk2-pillars-1-2-3-v1/`
