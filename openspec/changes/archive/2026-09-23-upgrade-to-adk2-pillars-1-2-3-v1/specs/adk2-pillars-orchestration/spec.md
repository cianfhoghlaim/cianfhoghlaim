...
- `openspec/changes/2026-09-23-k12-teacher-student-pipeline-v1/`
- `.agents/skills/adk2-pillars/SKILL.md`
- `docs/google_examples/adk2-tutorial/` (the 10-level runnable reference)
- `docs/google_examples/agent-valley-archive/` (the 4-floor memory ladder twin)
- `agents/workflows/` (the 8 new ADK 2 workflow files)
- `agents/meaisinfhoghlaim/educational/_archive/` (the 5-floor education ladder)
