...
|:--|:--|:--|:--|
| **Leaving Cycle** | `cocoindex/biep_parity/ireland_lc_factory.py` (exists, 176 LOC) | 11 (6 subjects × 2 langs minus 1) | Existing — wire BAML |
| **Junior Cycle** | `cocoindex/biep_parity/ireland_jc_factory.py` (new, ~300 LOC) | 16 (8 subjects × 2 langs) | This change |
| **A-Level** | `cocoindex/biep_parity/england_alevel_factory.py` (new, ~400 LOC) | 45 (15 × 3 boards) | This change |
| **GCSE** | `cocoindex/biep_parity/england_gcse_factory.py` (new, ~300 LOC) | 27 (9 × 3 boards) | This change |
...
| Before | After |
|:--|:--|
| `cocoindex/european_nations/{albania,austria,...}/education_embedding.py` (40 files, ~3,000 LOC) | `cocoindex/european_nations/_factory.py` (1 file, ~500 LOC) |
...
The 47 BIEP CocoIndex Apps at `cocoindex/biep_parity/*.py` get wired
