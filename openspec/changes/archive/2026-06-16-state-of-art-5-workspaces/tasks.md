...
- [ ] 1.1 Delete `sruth/oideachais/web/src/` (empty Vinxi relic)
- [ ] 1.2 Fix `sruth/oideachais/web/app.config.ts` — replace stale Vinxi config with TanStack Start vite plugin
- [ ] 1.3 Run `bunx convex dev --once` in `sruth/oideachais/web/convex/` to populate `_generated/`
- [ ] 1.4 Run `bunx baml-cli generate` to regenerate BAML client types
- [ ] 1.5 Run `bunx @tanstack/router-cli generate` in sruth/oideachais/web to regen `routeTree.gen.ts`
- [ ] 1.6 Add root `README.md` to sruth/oideachais/web with architecture diagram, env map, dev commands
- [ ] 1.7 Add per-route READMEs under `sruth/oideachais/web/apps/web/src/app/routes/{en,ga}/`
- [ ] 1.8 Add `sruth/oideachais/web/convex/README.md` (5 tables, RLS)
- [ ] 1.9 Add `sruth/oideachais/web/packages/api/README.md` (oRPC routers, auth flow)
- [ ] 1.10 Delete `sruth/tuatha/ui/app.config.ts` (replaced by native TanStack Start in vite.config.ts)
- [ ] 1.11 Fix `sruth/tuatha/ui/src/routes/game.tsx` import from `../../game/client/src` to workspace ref
- [ ] 1.12 Add root `README.md` to sruth/tuatha/ui
- [ ] 1.13 Add per-route READMEs in sruth/tuatha/ui/src/routes/
- [ ] 1.14 Add `sruth/tuatha/ui/src/server/README.md` (curriculum, mythology server functions)
- [ ] 1.15 Add root `README.md` to sruth/croilar/apps/web
- [ ] 1.16 Add per-route READMEs in sruth/croilar/apps/web/src/routes/
- [ ] 1.17 Add `sruth/croilar/apps/portal/src/routes/_layout/README.md` summarizing portal sections
- [ ] 1.18 Add `sruth/croilar/apps/portal/src/lib/tenant/README.md` (tenant config loader)
- [ ] 1.19 Add per-folder READMEs to sruth/croilar/hono-api (auth, db, data)
- [ ] 1.20 Add `sruth/croilar/hono-api/ORGANIZATIONS.md`
- [ ] 1.21 Add `sruth/croilar/hono-api/ARCHITECTURE.md` with sequence diagrams

## Phase 2 — sruth/croilar/hono-api real wiring
...
## Phase 3 — sruth/oideachais/web: AG-UI + auth + DB
...
## Phase 4 — sruth/oideachais/web: observability + bilingual
...
- [ ] 4.5 Verify `bun run typecheck` passes in sruth/oideachais/web

## Phase 5 — sruth/tuatha/ui: backend wiring
...
## Phase 6 — sruth/tuatha/ui: front-end
...
- [ ] 6.5 Verify `bun run typecheck` passes in sruth/tuatha/ui

## Phase 7 — sruth/croilar/apps/web: real data
...
## Phase 8 — sruth/croilar/apps/portal: core
...
## Phase 9 — sruth/croilar/apps/portal: monitoring + analytics
