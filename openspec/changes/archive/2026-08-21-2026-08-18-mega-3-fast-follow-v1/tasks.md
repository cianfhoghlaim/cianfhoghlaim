...
- **Status**: pending
- **Files**: `cocoindex_flows/_shared/cocoindex_query_api.py` (~250 LOC)
...
- **Status**: pending
- **Files**: `cocoindex_flows/biep_parity/ireland_lc_factory.py` + 6 per-subject files
...
- **Status**: pending
- **Files**: `cocoindex_flows/british_isles/england/education/ensembled_extraction.py` (~120 LOC)
...
### TASK-FF.13 — Build `cocoindex_flows/subjects/_factory.py`
- **Status**: pending
- **Files**: `cocoindex_flows/subjects/_factory.py` (~300 LOC)
...
- **Reference**: `cocoindex_flows/biep_parity/ireland_lc_factory.py` (the canonical factory pattern)

### TASK-FF.14 — Delete 13 `cocoindex_flows/biep_parity/*_education_embedding.py` shims
- **Status**: pending
- **Files**: 13 shim files
...
- **Removes**: 169 LOC
- **Reference**: `cocoindex_flows/biep_parity/ireland_lc_mathematics_embedding.py:1` (the 1-line shim docstring confirms this)
...
- [ ] All 5 helpers land (`agents/integrations/`, `notebooks/_shared/`, `cocoindex_flows/_shared/`)
