...
- `sruth/oideachais/dlt_utils/target_factory.py` — the Python factory
- `sruth/oideachais/scripts/make_target.sh` — the CLI helper
- `sruth/oideachais/dlt_utils/destinations.py` — the DuckLake destination
