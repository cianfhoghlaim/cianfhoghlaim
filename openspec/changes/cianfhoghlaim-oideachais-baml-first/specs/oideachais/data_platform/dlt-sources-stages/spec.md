...
- **GIVEN** `oideachais/data_platform/dlt_sources/ireland/aistear.py`
...
- **GIVEN** `oideachais/data_platform/dlt_sources/ireland/primary.py`
...
- **GIVEN** `oideachais/data_platform/dlt_sources/ireland/junior_cycle.py` (extension)
...
- **GIVEN** `oideachais/data_platform/dlt_sources/ireland/senior_cycle.py` (extension)
...
- **GIVEN** `oideachais/data_platform/dlt_sources/ireland/tertiary.py`
