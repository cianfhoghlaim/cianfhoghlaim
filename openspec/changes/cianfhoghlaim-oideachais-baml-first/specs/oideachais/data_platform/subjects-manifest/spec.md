...
- **GIVEN** `oideachais/data_platform/subjects/stages.json`
...
- **GIVEN** `oideachais/data_platform/subjects/lc_subjects.json`
- **WHEN** the file is loaded
...
- **GIVEN** `oideachais/data_platform/subjects/jc_subjects.json`
- **WHEN** the file is loaded
...
- **GIVEN** `oideachais/data_platform/subjects/hei.json`
- **WHEN** the file is loaded
...
The system SHALL provide 5 per-stage BAML context files in `oideachais/data_platform/subjects/baml_context/` that pre-load the BAML `client` with stage-specific system prompts.

#### Scenario: Aistear Context
- **GIVEN** `oideachais/data_platform/subjects/baml_context/aistear.baml`
- **WHEN** the file is loaded
...
- **GIVEN** `oideachais/data_platform/subjects/baml_context/primary.baml`
- **WHEN** the file is loaded
...
- **GIVEN** `oideachais/data_platform/subjects/baml_context/junior_cycle.baml`
- **WHEN** the file is loaded
