...
- [ ] **F.1** `mise run lint:brand` exits 0
- [ ] **F.2** `uv run pytest tests/dlt/test_curated_sources.py -v` all pass (37 skipped OK — those are from lost Phase 16-29 work)
- [ ] **F.3** `uv run openspec validate 2026-09-12-dlt-1.29-feature-adoption-v1 --strict` exits 0
- [ ] **F.4** `uv run openspec archive 2026-09-12-dlt-1.29-feature-adoption-v1 --yes`
