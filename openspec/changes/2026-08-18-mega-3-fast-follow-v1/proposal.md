...
| FF.5 | `cocoindex/_shared/cocoindex_query_api.py` — every CocoIndex App exposes a `search()` closure | ~250 | -800 LOC |
...
| # | Dedup | LOC saved |
|:--|:--|:--|
| FF.13 | `cocoindex/subjects/_factory.py` — collapse 4 hand-written files | -504 LOC |
| FF.14 | Delete 13 `cocoindex/biep_parity/*_education_embedding.py` shims | -169 LOC |
