...
| **Standalone CocoIndex factory files** | 13 | 0 (all via `cocoindex/subjects/_factory.py`) | **-13 files** |
...
### FF.13 — `cocoindex/subjects/_factory.py` (-504 LOC)
...
- 1 new factory: `cocoindex/subjects/_factory.py` (300 LOC)
- **Net: -504 LOC**
...
- 1 new helper: `cocoindex/_shared/cocoindex_query_api.py` (250 LOC)
- **Net: -800 LOC**
