...
- [ ] **C.1** `uv run pytest tests/baml/ -v` all 4 pass
- [ ] **C.2** `uv run openspec validate 2026-09-13-baml-health-test-and-skill-update-v1 --strict` exits 0
- [ ] **C.3** `uv run openspec archive 2026-09-13-baml-health-test-and-skill-update-v1 --yes`
