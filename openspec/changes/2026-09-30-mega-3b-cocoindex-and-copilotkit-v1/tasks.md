...
- **Status**: pending
- **Files**: `cocoindex/biep_parity/ireland_lc_factory.py` + 4 stage factories
...
- **Status**: pending
- **Files**: `cocoindex/biep_parity/ireland_jc_factory.py` (~300 LOC, new)
...
- **Status**: pending
- **Files**: `cocoindex/biep_parity/england_alevel_factory.py` (~400 LOC, new)
...
- **Status**: pending
- **Files**: `cocoindex/biep_parity/england_gcse_factory.py` (~300 LOC, new)
...
- **Status**: pending
- **Files**: `cocoindex/biep_parity/ireland_lc_factory.py`
...
- **Status**: pending
- **Files**: `cocoindex/european_nations/_factory.py` (~500 LOC, rewrite)
- **What**: Delete the 40 hand-written `cocoindex/european_nations/<country>/education_embedding.py`
