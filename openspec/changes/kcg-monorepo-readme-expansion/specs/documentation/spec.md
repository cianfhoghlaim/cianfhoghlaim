...
- `oideachais/README.md` — the lakehouse quadrant
- `meaisinfhoghlaim/README.md` — the AI/ML quadrant
- `tuatha/README.md` — the MMO + crypto quadrant
- `croilar/README.md` — the portfolio quadrant
