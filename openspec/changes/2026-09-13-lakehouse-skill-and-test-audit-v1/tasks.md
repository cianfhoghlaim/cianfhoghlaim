...
- [ ] **C.1** `uv run pytest tests/lakehouse/ -v` all 9 pass
- [ ] **C.2** `uv run openspec validate 2026-09-13-lakehouse-skill-and-test-audit-v1 --strict` exits 0
- [ ] **C.3** `uv run openspec archive 2026-09-13-lakehouse-skill-and-test-audit-v1 --yes`
