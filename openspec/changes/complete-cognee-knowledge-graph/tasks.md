...
- [ ] In `sruth/oideachais/cognify_rules/author_archive_cross_corpus.py`:
...
- [ ] In `sruth/oideachais/cognee_integration/cross_stage_cognify.py`:
...
- [ ] In `sruth/oideachais/cognee_integration/author_archive_cognify.py`:
...
- [ ] `grep "def _build_arxiv_match_query\|def _build_module_title_match_query\|def _build_takeout_citation_query" sruth/oideachais/cognify_rules/author_archive_cross_corpus.py` shows 3 hits
