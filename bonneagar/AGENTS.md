...
# Validate all 94 stacks against the 6-file GOLD_STANDARD
...
The canonical inventory lives at `bonneagar/stacks/INDEX.md` (auto-generated by the stack-doctor audit). The live count is 94 stacks (lowercase directories; added `stacks/newt-arm1-oci/` in the 2026-08-15 openspec change). 81 of them follow the 6-file GOLD_STANDARD contract; the 12 outliers are:
...
- `sources/discover-stacks.ts` — walks `bonneagar/stacks/*/compose.yaml` (94 stacks)
