...
Provides the pipecat service for the Cianfhoghlaim platform.
...
- **Ops**: `bonneagar/stacks/pipecat/` (the 6-file GOLD_STANDARD)
...
- - **Pangolin**: `https://pipecat.cianfhoghlaim.ie` (if exposed)
