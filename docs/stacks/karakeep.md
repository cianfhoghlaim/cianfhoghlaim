...
Karakeep is an open-source, self-hosted bookmark and read-later service (formerly Hoarder). It provides a web UI for saving, tagging, searching, and organising web bookmarks, with full-text search powered by Meilisearch and AI-powered automatic tagging.
...
- **Ops**: `bonneagar/stacks/karakeep/` (the 6-file GOLD_STANDARD)
...
- - **Pangolin**: `https://karakeep.cianfhoghlaim.ie` (if exposed)
