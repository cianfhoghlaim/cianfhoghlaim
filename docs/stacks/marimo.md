...
Provides the marimo service for the Cianfhoghlaim platform.
...
- **Ops**: `bonneagar/stacks/marimo/` (the 6-file GOLD_STANDARD)
...
- - **Pangolin**: `https://marimo.cianfhoghlaim.ie` (if exposed)
