...
Provides the n8n service for the Cianfhoghlaim platform.
...
- **Ops**: `bonneagar/stacks/n8n/` (the 6-file GOLD_STANDARD)
...
- - **Pangolin**: `https://n8n.cianfhoghlaim.ie` (if exposed)
