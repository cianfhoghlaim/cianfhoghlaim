...
Stirling PDF is an open-source, self-hosted web application providing 50+ PDF manipulation tools. It can merge, split, rotate, compress, OCR, convert (to/from Word, Excel, PowerPoint, images), sign, redact, and watermark PDFs through a clean web UI.
...
- **Ops**: `bonneagar/stacks/stirling-pdf/` (the 6-file GOLD_STANDARD)
...
- - **Pangolin**: `https://stirling-pdf.cianfhoghlaim.ie` (if exposed)
