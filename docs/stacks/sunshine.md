...
Runs sunshine as part of the sunshine stack (image: `lizardbyte/sunshine:latest`).
...
- **Ops**: `bonneagar/stacks/sunshine/` (the 6-file GOLD_STANDARD)
...
- **Pangolin**: `sunshine.aleyum.cianfhoghlaim.ie` (public resource, port ?)
