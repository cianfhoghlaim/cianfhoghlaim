...
Runs ludusavi as part of the ludusavi stack (image: `mtkennerly/ludusavi:latest`).
...
Primary port: `8080`. Backed by Komodo deploy procedure + Pangolin  resource registration.

## Cross-references

- **Ops**: `bonneagar/stacks/ludusavi/` (the 6-file GOLD_STANDARD)
