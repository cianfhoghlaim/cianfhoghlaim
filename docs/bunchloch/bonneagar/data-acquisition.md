...
## Celtic Data Sources, Tool Integrations & Multimodal Document Intelligence

### `README.md` — 02-celtic-data-acquisition
...
### `acquisition-pipeline.md` — 02-celtic-data-acquisition
...
### `bilingual-scraper-implementation.md` — 02-celtic-data-acquisition
...
### `eu-irish-datasets.md` — 02-celtic-data-acquisition
...
### `gaois-api-reference.md` — 02-celtic-data-acquisition
...
### `pan-celtic-scraping.md` — 02-celtic-data-acquisition
...
### `dlt-baml-orpc-mcp-typesafe-pipeline-analysis.md` — 02-integrations
...
### `effect-convex-integration-research.md` — 02-integrations
...
### `effect-ts-tanstack-start-integration.md` — 02-integrations
...
### `mcp-ui-gradio-evidence-integration-analysis.md` — 02-integrations
...
### `README.md` — 02-multimodal-document-intelligence
...
### `apple-silicon-deployment.md` — 02-multimodal-document-intelligence
...
### `gaelic-heritage-pipeline.md` — 02-multimodal-document-intelligence
...
### `orchestration-infrastructure.md` — 02-multimodal-document-intelligence
...
### `vlm-ocr-comparison.md` — 02-multimodal-document-intelligence
...
- `02-celtic-data-acquisition/` (README.md, acquisition-pipeline.md, bilingual-scraper-implementation.md, eu-irish-datasets.md, gaois-api-reference.md, pan-celtic-scraping.md)
- `02-integrations/` (dlt-baml-orpc-mcp-typesafe-pipeline-analysis.md, effect-convex-integration-research.md, effect-ts-tanstack-start-integration.md, mcp-ui-gradio-evidence-integration-analysis.md)
- `02-multimodal-document-intelligence/` (README.md, apple-silicon-deployment.md, gaelic-heritage-pipeline.md, orchestration-infrastructure.md, vlm-ocr-comparison.md)
