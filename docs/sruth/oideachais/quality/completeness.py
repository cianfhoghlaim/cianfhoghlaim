...
class CompletenessScorer:
    ...
    def score(self, document: Any) -> CompletenessBreakdown:
        ...
        for field, weight in self.weights.items():
            ...
            if field_score == 0:
                ...
                recommendations.append(f"Improve {field}: current score {field_score:.1%}")
        ...
        if quality == ContentQuality.MINIMAL:
            recommendations.insert(0, "Document has minimal completeness. Major fields missing.")
    ...
    def _contains_irish(self, text: str) -> bool:
        ...
        matches = sum(1 for pattern in irish_patterns if re.search(pattern, text_lower))
        return matches >= 2
    ...
    def get_statistics(
        ...
        return {
            ...
            "quality_distribution": {q.value: qualities.count(q) for q in ContentQuality},
