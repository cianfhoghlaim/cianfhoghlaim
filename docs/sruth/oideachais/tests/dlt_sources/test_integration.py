...
class TestFirecrawlSource:
    ...
    def test_scrape_page_with_mock_client(self) -> None:
        ...
        with patch.dict(os.environ, {"FIRECRAWL_API_KEY": "test_key"}):
            with patch(
                "sruth.oideachais.dlt_sources.common.firecrawl_source.get_firecrawl_client"
            ) as mock_get:
...
class TestCrawlUtils:
    ...
    def test_url_matcher_include_patterns(self) -> None:
        ...
        matcher = URLMatcher(include_patterns=["https://curriculumonline.ie/Junior-Cycle/*"])
    ...
    def test_url_matcher_exclude_patterns(self) -> None:
        ...
        matcher = URLMatcher(exclude_patterns=["*.pdf", "*.zip"])
    ...
    def test_url_matcher_domain_filtering(self) -> None:
        ...
        matcher = URLMatcher(include_domains=["curriculumonline.ie", "ncca.ie"])
    ...
    def test_crawl_pattern_matching(self) -> None:
        ...
        assert not pattern.matches(
            "https://curriculumonline.ie/Junior-Cycle/specifications/doc.pdf"
        )
