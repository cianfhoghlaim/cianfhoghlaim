...
class ExtractionTask:
    ...
    selected_extractor: Optional[str] = None
...
class ExtractorComparison:
    ...
    irish_text_quality: Optional[float] = None  # Special metric for Irish content
...
class MetricsDatabase:
    ...
    def complete_comparison(
        ...
        output_size_bytes: Optional[int] = None,
        completeness_score: Optional[float] = None,
        irish_text_quality: Optional[float] = None,
        error_message: Optional[str] = None,
    ) -> None:
    ...
    def get_best_extractor(self, document_type: str) -> Optional[str]:
        """
...
def get_metrics_db(db_path: Optional[Path] = None) -> MetricsDatabase:
