...
class GaelicMetrics:
    ...
    def _evaluate_tironian(self, prediction: str, reference: str) -> dict[str, Any]:
    ...
    def _evaluate_punctum_delens(self, prediction: str, reference: str) -> dict[str, Any]:
    ...
    def _evaluate_fada(self, prediction: str, reference: str) -> dict[str, Any]:
    ...
    def batch_evaluate(
        ...
        results = [self.evaluate(pred, ref) for pred, ref in zip(predictions, references)]
