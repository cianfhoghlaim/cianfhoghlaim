    ...
    class CurriculumSearchTools:
        ...
        def search_curriculum(self, query: str) -> dict:
            return {
                "query": query,
                "results": [],
                "message": "Stub: Install ADK for full functionality",
            }
...
class EducationResponse(BaseModel):
    ...
    query: str
    summary: str
    curriculum_info: Optional[CurriculumSearchResult] = None
    research: Optional[ResearchReport] = None
    translation: Optional[TranslationResult] = None
    corpus_data: Optional[CorpusSearchResult] = None
    geospatial_data: Optional[GeospatialResult] = None
