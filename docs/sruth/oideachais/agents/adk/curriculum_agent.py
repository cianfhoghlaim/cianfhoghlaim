                    ...
                    all_results.append(
                        {
                            ...
                            "nation": r.get(
                                "nation", "ireland" if "oideachas" in table_name else "uk"
                            ),
    ...
    async def process(self, context: AgentContext) -> AgentResponse:
        ...
        if not search_results:
            return AgentResponse(
                content=f"I couldn't find curriculum content matching your query. Try being more specific about the subject, level, or nation.",
...
"""
    ...
    def _generate_follow_ups(
        ...
        if filters["nation"]:
            nation = filters["nation"]
            other_nations = [n for n in ["ireland", "scotland", "wales"] if n != nation]
            if other_nations:
