...
from .config import config, CURRICULUM_FRAMEWORKS
...
async def compare_curricula_cross_nation(
    ...
    return {
        ...
        "delta": [
            {
                "op": "replace",
                "path": "/comparison_table",
                "value": [r.model_dump() for r in table_rows],
            },
...
async def request_translation_approval(
    ...
    return {
        ...
        "delta": [
            {
                "op": "add",
                "path": "/pending_translations/-",
                "value": translation_request.model_dump(),
            },
        ],
    }
