...
class OrchestratorState:
    ...
    def to_snapshot(self) -> dict[str, Any]:
        ...
        return {
            ...
            "tasksFailed": len([t for t in self.task_history if t.status == TaskStatus.FAILED]),
...
class AGUIEventEmitter:
    ...
    @staticmethod
    def run_error(
        run_id: str, error: str, code: str = "AGENT_ERROR", recoverable: bool = True
    ) -> dict:
        return AGUIEventEmitter.emit(
            "RUN_ERROR",
            {
            ...
            if memory:
                ...
                try:
                    ...
                    state.memory_results = [
                        {"content": r.content, "score": r.score} for r in memory_results
                    ]
    ...
    async def validate_content(
        ...
        for stage_name, prompt in validation_stages:
            ...
            try:
                ...
                yield self.orchestrator.emit.step_finished(
                    step_id,
                    stage_name,
                    duration_ms,
                    {
