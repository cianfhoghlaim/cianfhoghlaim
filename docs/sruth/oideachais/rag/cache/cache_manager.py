...
class CurriculumCacheManager:
    ...
    async def get_prerequisite_chain(
        ...
        return await self.prerequisite_cache.get(concept_id, "prerequisite", {})
    ...
    async def set_prerequisite_chain(
        ...
        await self.prerequisite_cache.set(concept_id, "prerequisite", {}, chain)
    ...
    async def get_learning_outcome(
        ...
        return await self.learning_outcome_cache.get(lo_code, "learning_outcome", {})
    ...
    async def set_learning_outcome(
        ...
        await self.learning_outcome_cache.set(lo_code, "learning_outcome", {}, data)
