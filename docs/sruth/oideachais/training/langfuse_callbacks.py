    ...
    def on_train_end(
        ...
        **kwargs,
        ...
        self._cost_estimate.estimated_cost_usd = (
            self._cost_estimate.prompt_tokens / 1000
        ) * model_costs["input"] + (self._cost_estimate.completion_tokens / 1000) * model_costs[
            "output"
        ]
...
class LangfuseGenerationCallback(TrainerCallback):
    ...
    def log_generation(
        ...
        try:
            ...
            if token_usage:
                cost = (token_usage.get("prompt_tokens", 0) / 1000) * model_costs["input"] + (
