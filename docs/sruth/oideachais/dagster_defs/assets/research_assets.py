...
def research_bunchloch_raw(context) -> MaterializeResult:
    ...
    from sruth.oideachais.dlt_sources.bunchloch import bunchloch_source
...
def research_bunchloch_by_subject(context) -> MaterializeResult:
    ...
    from sruth.oideachais.dlt_sources.bunchloch import bunchloch_by_subject_source
...
def research_pdf_extraction(context) -> MaterializeResult:
    ...
    from sruth.oideachais.document_factory.pdf_converter import PDFConverterFactory
