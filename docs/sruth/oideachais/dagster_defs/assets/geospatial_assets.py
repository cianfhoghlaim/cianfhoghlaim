...
from ..resources import DuckDBResource, LanceDBResource, GeoParquetResource
from ..partitions import geospatial_source_partitions, nation_partitions
...
def duchas_by_gaeltacht(
    ...
    try:
        ...
        row_count = conn.execute("SELECT COUNT(*) FROM geospatial.duchas_by_gaeltacht").fetchone()[
            0
        ]
