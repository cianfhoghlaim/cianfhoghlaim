...
from ..resources import DuckDBResource, LanceDBResource, FirecrawlResource
from ..partitions import uk_multipartitions, uk_nation_partitions
...
def england_dfe_statistics(
    ...
    from dlt_sources.uk.england.dfe import dfe_source
...
def england_ofsted_inspections(
    ...
    from dlt_sources.uk.england.ofsted import ofsted_source
...
def scotland_gov_statistics(
    ...
    from dlt_sources.uk.scotland.gov import scotland_gov_source
...
def scotland_sqa_examinations(
    ...
    from dlt_sources.uk.scotland.sqa import sqa_source
...
def wales_statswales(
    ...
    from dlt_sources.uk.wales.statswales import statswales_source
...
def wales_curriculum(
    ...
    from dlt_sources.uk.wales.curriculum import wales_curriculum_source
...
def ni_nisra_statistics(
    ...
    from dlt_sources.uk.northern_ireland.nisra import nisra_source
...
def ni_ccea(
    ...
    from dlt_sources.uk.northern_ireland.ccea import ccea_source
...
def iom_curriculum(
    ...
    from dlt_sources.crown_dependencies.isle_of_man import iom_source
