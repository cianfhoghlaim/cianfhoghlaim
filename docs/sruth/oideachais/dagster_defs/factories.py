...
def create_dlt_asset(config: DLTAssetConfig) -> dg.AssetsDefinition:
    ...
    Usage:
        ncca_asset = create_dlt_asset(DLTAssetConfig(
            ...
            source_module="sruth.oideachais.dlt_sources.ncca",
    ...
    def _dlt_asset(
        ...
        # Extract metrics
        rows_loaded = sum(pkg.state.get("rows_count", 0) for pkg in load_info.load_packages)
...
def create_embedding_asset(config: EmbeddingAssetConfig) -> dg.AssetsDefinition:
    ...
    def _embedding_asset(
        ...
        context.log.info(f"Generated {embeddings_generated} embeddings for {rows_processed} rows")
...
def create_modal_asset(config: ModalAssetConfig) -> dg.AssetsDefinition:
    ...
    Usage:
        finetune_asset = create_modal_asset(ModalAssetConfig(
            ...
            modal_function="sruth.oideachais.modal.finetune.train",
            gpu_type="H100",
        ))
    """
    ...
    return create_asset_group(
        [
            ...
            DLTAssetConfig(
                ...
                source_module="sruth.oideachais.dlt_sources.curriculumonline",
            ...
            DLTAssetConfig(
                name="sec_exams",
                source_module="sruth.oideachais.dlt_sources.sec",
...
def create_celtic_language_assets() -> list[dg.AssetsDefinition]:
    ...
    return create_asset_group(
        [
            DLTAssetConfig(
                name="duchas_schools",
                source_module="sruth.oideachais.dlt_sources.duchas",
            ...
            DLTAssetConfig(
                ...
                source_module="sruth.oideachais.dlt_sources.tearma",
...
def create_curriculum_ingestion_asset(
    ...
    """
    from .partitions_v2 import ireland_curriculum_partitions, CURRICULUM_CONFIG_SCHEMA
    ...
    def _curriculum_ingestion_asset(
        ...
        import dlt as dlt_lib
        from sruth.oideachais.dlt_sources.ireland.curriculum_source import curriculum_source
...
def create_unified_curriculum_assets() -> list[dg.AssetsDefinition]:
    ...
    Usage:
        from sruth.oideachais.dagster_defs.factories import create_unified_curriculum_assets
    ...
    assets.append(
        create_curriculum_processing_asset(
            stage="pdf_extractions",
    ...
    assets.append(
        create_curriculum_enrichment_asset(
