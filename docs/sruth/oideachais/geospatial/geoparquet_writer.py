...
from .hilbert_indexing import add_hilbert_index, create_hilbert_partitions
...
def write_geoparquet(
    ...
    if partition_by:
        return _write_partitioned(gdf, output_path, partition_by, compression, row_group_size)
    else:
        ...
        metadata["partitions"].append(
            {
                ...
                "keys": dict(zip(partition_by, keys)),
                "rows": len(group),
            }
        )
