...
class LLMRouter:
    ...
    def _get_available_providers(
        ...
        for provider in self.providers:
            ...
            if required_capabilities:
                if not all(provider.has_capability(cap) for cap in required_capabilities):
                    continue
    ...
    async def _call_provider(
        ...
        try:
            ...
            raise NotImplementedError("LiteLLM not installed. Install with: pip install litellm")
