...
class PlanetScaleConfig:
    ...
    host: str = field(
        default_factory=lambda: os.getenv("PLANETSCALE_HOST", "eu-west-3.pg.psdb.cloud")
    )
    port: int = field(default_factory=lambda: int(os.getenv("PLANETSCALE_PORT", "5432")))
    database: str = field(default_factory=lambda: os.getenv("PLANETSCALE_DATABASE", "oideachais"))
    username: str = field(default_factory=lambda: os.getenv("PLANETSCALE_USERNAME", ""))
    password: str = field(default_factory=lambda: os.getenv("PLANETSCALE_PASSWORD", ""))
    sslmode: str = field(default_factory=lambda: os.getenv("PLANETSCALE_SSLMODE", "require"))
...
class LanceDBConfig:
    ...
    remote_uri: str | None = field(default_factory=lambda: os.getenv("LANCEDB_REMOTE_URI"))
    api_key: str | None = field(default_factory=lambda: os.getenv("LANCEDB_API_KEY"))
    region: str = field(default_factory=lambda: os.getenv("LANCEDB_REGION", "us-east-1"))

    # Namespace prefixes for multi-domain data
    namespace_prefixes: dict = field(
...
class DuckLakeConfig:
    ...
    local_path: str = field(
        default_factory=lambda: os.getenv("DUCKDB_LOCAL_PATH", "./data/celtic_education.duckdb")
    )
    motherduck_token: str | None = field(default_factory=lambda: os.getenv("MOTHERDUCK_TOKEN"))
...
class GarageConfig:
    ...
    endpoint_url: str = field(
        default_factory=lambda: os.getenv("GARAGE_ENDPOINT", "http://localhost:3900")
    )
    access_key: str = field(default_factory=lambda: os.getenv("GARAGE_ACCESS_KEY", ""))
    secret_key: str = field(default_factory=lambda: os.getenv("GARAGE_SECRET_KEY", ""))
    bucket: str = field(default_factory=lambda: os.getenv("GARAGE_BUCKET", "education-documents"))
    region: str = field(default_factory=lambda: os.getenv("GARAGE_REGION", "garage"))
...
class LakehouseConfig:
    ...
    garage_region: str = field(default_factory=lambda: os.getenv("GARAGE_REGION", "garage"))

    # Buckets for different data types
    iceberg_bucket: str = field(default_factory=lambda: os.getenv("ICEBERG_BUCKET", "iceberg"))
    lance_bucket: str = field(default_factory=lambda: os.getenv("LANCE_BUCKET", "lance"))
    ducklake_bucket: str = field(default_factory=lambda: os.getenv("DUCKLAKE_BUCKET", "ducklake"))
...
class MemgraphConfig:
    ...
    uri: str = field(default_factory=lambda: os.getenv("MEMGRAPH_URI", "bolt://localhost:7687"))
    username: str = field(default_factory=lambda: os.getenv("MEMGRAPH_USERNAME", ""))
...
class FalkorDBConfig:
    ...
    url: str = field(default_factory=lambda: os.getenv("FALKORDB_URL", "redis://localhost:6379"))
    graph_name: str = field(default_factory=lambda: os.getenv("FALKORDB_GRAPH", "curriculum_cache"))
