...
Start with the main subject/style, then add modifiers."""
    ...
    async def compare_artworks(
        ...
        styles1 = set(
            [analysis1.style.primary_style]
            + (analysis1.style.secondary_styles if analysis1.style else [])
        )
        styles2 = set(
            [analysis2.style.primary_style]
            + (analysis2.style.secondary_styles if analysis2.style else [])
        )
