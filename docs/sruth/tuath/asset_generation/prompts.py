...
from .models import AssetType, CelticStyle, ItemRarity, ClanId
...
class CelticPromptGenerator:
    ...
    CLAN_AESTHETICS = {
        ClanId.TUATHA_DE_DANANN: (
            "divine radiance, silver and gold, magical aura, skilled craftsmanship, ethereal glow"
        ),
        ClanId.FIR_BOLG: (
        ...
        ClanId.MILESIANS: (
            "Mediterranean influence, Mediterranean blues, navigation symbols, conquest imagery"
        ),
    }
    ...
    def _get_asset_base(
        ...
        if asset_type == AssetType.CHARACTER_PORTRAIT:
            ...
            return (
                "Celtic magical effect, druidic spell, mystical energy, rune circle, nature magic"
            )
