    ...
    for r in db_results:
        ...
        results.append(
            CurriculumSearchResult(
                ...
                learning_outcomes=[r.get("learning_outcome", "")]
                if r.get("learning_outcome")
                else [],
...
async def get_learning_outcomes(
    ...
    if topic:
        ...
        outcomes = [
            o
            for o in outcomes
            if topic_lower in o.description.lower()
            or any(topic_lower in t.lower() for t in o.related_topics)
        ]
    if nation:
        ...
        "nations": [
            {
                ...
                "name": "Ireland",
                "native_name": "Éire",
                "languages": [{"code": "ga", "name": "Irish", "native_name": "Gaeilge"}],
            ...
            },
            {
                ...
                "name": "Scotland",
                "native_name": "Alba",
                "languages": [{"code": "gd", "name": "Scottish Gaelic", "native_name": "Gàidhlig"}],
            ...
            },
            {
                ...
                "name": "Wales",
                "native_name": "Cymru",
                "languages": [{"code": "cy", "name": "Welsh", "native_name": "Cymraeg"}],
    ...
    subjects = {
        "ireland": [
            {"id": "irish_language", "name": "Irish Language", "native_name": "Gaeilge"},
            {
                ...
                "native_name": "Litríocht na Gaeilge",
            },
        ...
        "scotland": [
            ...
            {
                "id": "gaelic_literature",
                "name": "Gaelic Literature",
                "native_name": "Litreachas Gàidhlig",
            },
            {
                "id": "scottish_history",
                "name": "Scottish History",
                "native_name": "Eachdraidh na h-Alba",
            },
        ],
        "wales": [
            {"id": "welsh_language", "name": "Welsh Language", "native_name": "Cymraeg"},
            {
                ...
                "native_name": "Llenyddiaeth Gymraeg",
            },
