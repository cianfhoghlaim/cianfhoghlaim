...
Usage:
    from sruth.crypteolas.dagster_assets.components import load_crypteolas_components
...
def load_crypteolas_from_yaml(
    ...
    if config_path is None:
        config_path = str(Path(__file__).parent / "rest_pipeline_component.yaml")
...
class CrypteolasPipelineComponent:
    ...
    def get_storage_config(self) -> dict[str, Any]:
        ...
        return {
            ...
            "postgres": {
                "url": os.getenv(
                    "POSTGRES_URL", "postgresql://postgres:postgres@postgres:5432/crypteolas"
                ),
            },
        }
