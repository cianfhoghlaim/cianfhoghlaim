    ...
    with _get_client() as client:
        try:
            ...
            return {
                ...
                "telegram_members": data.get("community_data", {}).get(
                ...
                "github_commit_count_4_weeks": data.get("developer_data", {}).get(
        ...
        try:
            ...
            for exchange in exchanges:
                yield {
                    ...
                    "trade_volume_24h_btc_normalized": exchange.get(
        ...
        try:
            ...
            for nft in data.get("nfts", []):
                yield {
                    ...
                    "floor_price_24h_percentage_change": nft.get(
