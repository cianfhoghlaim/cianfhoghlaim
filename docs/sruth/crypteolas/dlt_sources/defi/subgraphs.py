...
def aave_reserves(
    ...
    for reserve in data.get("reserves", []):
        ...
        yield {
            ...
            "lastUpdateTimestamp": datetime.utcfromtimestamp(int(reserve["lastUpdateTimestamp"])),
            ...
            "liquidationThreshold": float(reserve.get("reserveLiquidationThreshold", 0)) / 10000,
            "liquidationBonus": float(reserve.get("reserveLiquidationBonus", 0)) / 10000,
