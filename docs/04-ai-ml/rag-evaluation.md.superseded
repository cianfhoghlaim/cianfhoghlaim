...
ccc_query_hints: ["rag evaluation ragas faithfulness answer relevancy federated rag prompt optimization"]
source_files: "12 files from meaisínfhoghlaim and teanga"
---
# RAG & Evaluation Guide

> Merged from 12 source files across the meaisínfhoghlaim and teanga document collections. Migration date: 2026-06-06.

## Table of Contents

- [mlflow-llm-guide](#mlflow-llm-guide-md)
- [Federated RAG Tutorial_ Build Privacy-Preserving LLM Systems in Python ⬩OpenMined](#federated-rag-tutorial--build-privacy-preserving-l)
- [AI_MEMORY](#ai-memory-md)
- [mlflow_ragas](#mlflow-ragas-md)
- [gaois-terminologue-website-docs-intro.de](#gaois-terminologue-website-docs-intro-de-md)
- [langfuse_ragas](#langfuse-ragas-md)
- [Prompt Optimization (Beta)](#prompt-optimization--beta--md)
- [Prompt Optimization (Beta)(3)](#prompt-optimization--beta--3--md)
- [Prompt Optimization (Beta)(2)](#prompt-optimization--beta--2--md)
- [kscanne-gbb-proofing-diacritics-README](#kscanne-gbb-proofing-diacritics-readme-md)
- [syft-flwr_notebooks_fedrag_README.md at main · OpenMined_syft-flwr](#syft-flwr-notebooks-fedrag-readme-md-at-main---ope)
- [repo-IRLBench](#repo-irlbench-md)

---

## mlflow-llm-guide

<!-- BEGIN: original content from mlflow-llm-guide.md -->

*Source: `docs/bunchloch/meaisínfhoghlaim/mlflow-llm-guide.md` (6026 words, 2364 lines)*
...
<!-- END: original content from mlflow-llm-guide.md -->

---

## Federated RAG Tutorial  Build Privacy-Preserving LLM Systems in Python ⬩OpenMined

*Source: `docs/bunchloch/meaisínfhoghlaim/Federated RAG Tutorial_ Build Privacy-Preserving LLM Systems in Python ⬩OpenMined.md` (3140 words, 543 lines)*
...
*Source: `docs/bunchloch/meaisínfhoghlaim/AI_MEMORY.md` (2751 words, 876 lines)*
...
*Source: `docs/bunchloch/meaisínfhoghlaim/mlflow_ragas.md` (2382 words, 501 lines)*
...
## gaois-terminologue-website-docs-intro.de

*Source: `docs/bunchloch/teanga/gaois-terminologue-website-docs-intro.de.md` (2040 words, 110 lines)*
...
![Der Bereich *Administration*, in dem Sie verschiedene Listen für Ihre Terminologiedatenbank konfigurieren können, z. B. Part-of-Speech-Labels (hier abgebildet).](/docs/intro05.png)
...
![Intelligente Suche in Aktion.](/docs/intro09.png)
...
![Ein Extranet in Terminologue.](/docs/intro15.png)
...
*Source: `docs/bunchloch/meaisínfhoghlaim/langfuse_ragas.md` (1713 words, 288 lines)*
...
*Source: `docs/bunchloch/meaisínfhoghlaim/Prompt Optimization (Beta).md` (1621 words, 217 lines)*
...
## Prompt Optimization (Beta)(3)

*Source: `docs/bunchloch/meaisínfhoghlaim/Prompt Optimization (Beta)(3).md` (1621 words, 217 lines)*
...
## Prompt Optimization (Beta)(2)

*Source: `docs/bunchloch/meaisínfhoghlaim/Prompt Optimization (Beta)(2).md` (1621 words, 217 lines)*
...
## kscanne-gbb-proofing-diacritics-README

*Source: `docs/bunchloch/teanga/kscanne-gbb-proofing-diacritics-README.md` (516 words, 97 lines)*
...
## syft-flwr notebooks fedrag README.md at main · OpenMined syft-flwr

*Source: `docs/bunchloch/meaisínfhoghlaim/syft-flwr_notebooks_fedrag_README.md at main · OpenMined_syft-flwr.md` (348 words, 56 lines)*
...
*Source: `docs/bunchloch/teanga/repo-IRLBench.md` (304 words, 21 lines)*
