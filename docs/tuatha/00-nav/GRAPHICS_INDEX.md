...
| File | Lines | Topics |
|------|-------|--------|
| [WGPU_GUIDE.md](../04-game-tech/reference/guides/WGPU_GUIDE.md) | 700+ | WebGPU rendering, terrain/water shaders, particle systems, render pipelines |
| [GODOT_RUST_GUIDE.md](../04-game-tech/reference/guides/GODOT_RUST_GUIDE.md) | 760+ | gdext integration, GodotClass macros, signals, zones, SpacetimeDB network |
| [SPACETIMEDB_GUIDE.md](../04-game-tech/reference/guides/SPACETIMEDB_GUIDE.md) | 710+ | Multiplayer backend, reducers, subscriptions, position sync, zone management |
| [CROSS_PLATFORM_GUIDE.md](../04-game-tech/reference/guides/CROSS_PLATFORM_GUIDE.md) | 780+ | Kotlin Multiplatform, Swift, React Native + Godot, platform bridging |
...
|------|------|-------------|
| [Game Particle Effects Research(2).md](../04-game-tech/Game%20Particle%20Effects%20Research(2).md) | 2,500+ lines | **"Anam Initiative"** - Meteorological particle simulation using real weather data. Covers Unreal Niagara, Unity VFX Graph, Godot compute shaders. Includes Catmull-Rom bicubic interpolation, vector quantization, SpacetimeDB streaming. |
| [Geospatial Workflow & Particle Effects(1).md](../04-game-tech/Geospatial%20Workflow%20%26%20Particle%20Effects(1).md) | 1,800+ lines | Cloud-native OLAP architecture with DuckDB + MotherDuck. WebGPU particle rendering, Lagrangian particle tracking, GeoArrow zero-copy transport, Lonboard + Marimo visualization. |
...
### Guides
- [WGPU Guide](../04-game-tech/reference/guides/WGPU_GUIDE.md) - WebGPU rendering
- [Godot Rust Guide](../04-game-tech/reference/guides/GODOT_RUST_GUIDE.md) - GDExtension development
- [SpacetimeDB Guide](../04-game-tech/reference/guides/SPACETIMEDB_GUIDE.md) - Multiplayer backend
- [Cross-Platform Guide](../04-game-tech/reference/guides/CROSS_PLATFORM_GUIDE.md) - Multi-platform development

### Research
- [Anam Particle System](../04-game-tech/Game%20Particle%20Effects%20Research(2).md) - Weather-driven particles
- [Geospatial Workflow](../04-game-tech/Geospatial%20Workflow%20%26%20Particle%20Effects(1).md) - Cloud-native OLAP

### Code (in upstream mirrors)
- [wgpu examples & API specs](../08-mirrors/wgpu/docs/) - WGSL shader library, mesh shaders, ray tracing specs
- [SpacetimeDB Blackholio demo](../08-mirrors/SpacetimeDB/demo/Blackholio/) - Reference client-server example
- [Babylon.js game client reference](../04-game-tech/reference/FRONTEND.md) - Tuath's web client architecture
