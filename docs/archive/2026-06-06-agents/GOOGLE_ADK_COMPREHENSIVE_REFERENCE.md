...
- `google-adk/deployment/README.md`
- `google-adk/tests/load_test/README.md`
- `google-adk/examples/academic-research/README.md`
- `google-adk/examples/deep-search/README.md`
- `google-adk/examples/firecrawl/README.md` + `app/README.md` + `docs/*`
- `google-adk/examples/launchmybakery/README.md` + `google.md`
- `google-adk/examples/with-adk/README.md` + `a2a/docs/README.md` + `ag_ui.md` + `typescript/README.md`
