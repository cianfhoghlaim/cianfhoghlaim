---
title: 'Tuath Celtic Educational MMO - Quick Start'
domain: 'product'
status: 'stable'
description: 'Celtic language learning through mythology - a gamified educational platform.'
read_when:
  - looking for documentation on this topic
updated: '2026-06-10'
supersedes:
  - docs/TUATH_QUICKSTART.md
ccc_query_hints:
  - tuath celtic educational mmo - quick sta
---
