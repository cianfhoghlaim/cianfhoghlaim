...
from .base import DocumentFormat, DocumentSource
...
class CurriculumMetadata(BaseModel):
    ...
    year_group: str | None = Field(default=None, description="Year group (e.g., '5th Year')")
    strand: str | None = Field(default=None, description="Curriculum strand")
    strand_unit: str | None = Field(default=None, description="Strand unit")
    topic: str | None = Field(default=None, description="Topic within strand")
...
class CurriculumDocument(BaseModel):
    ...
    content_html: str | None = Field(default=None, description="HTML content if available")
    ...
    curriculum_year: str | None = Field(default=None, description="Curriculum year (e.g., '2023-24')")
