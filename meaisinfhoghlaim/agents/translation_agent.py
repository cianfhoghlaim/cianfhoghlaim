...
class TranslationRequest(BaseModel):
    ...
    preserve_formatting: bool = Field(
        default=True, description="Whether to preserve formatting"
    )
...
class TranslationResult(BaseModel):
    ...
    terminology_notes: list[str] | None = Field(
...
class TerminologyLookup(BaseModel):
    ...
    domain: str | None = Field(default=None, description="Domain/field")
    definition: str | None = Field(default=None, description="Definition if available")
