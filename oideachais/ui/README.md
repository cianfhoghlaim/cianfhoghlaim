...
Frontend components (CopilotKit, Vinxi, TanStack Start)
...
- Relevant modules: [visualization](../visualization/README.md), [clients](../clients/README.md), [middleware](../middleware/README.md)
