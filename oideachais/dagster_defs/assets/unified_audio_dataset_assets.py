...
def edcolearning_audio_extraction(
    ...
    from oideachais.data_platform.dlt_sources.ireland.edcolearning import edcolearning_source
...
def sec_aural_transcripts(
    ...
    from oideachais.data_platform.dlt_sources.ireland.sec_aural_transcripts import (
