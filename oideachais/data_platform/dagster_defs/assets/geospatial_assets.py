...
def gaeltacht_boundaries(
    ...
    from data_platform.dlt_sources.geospatial.geohive import geohive_source
...
def welsh_speaking_boundaries(
    ...
    from data_platform.dlt_sources.geospatial.ons_lsoa import ons_lsoa_source
...
def gaidhealtachd_boundaries(
    ...
    from data_platform.dlt_sources.geospatial.scotland_gov import scotland_datazones_source
...
def celtic_medium_schools(
    ...
    from data_platform.dlt_sources.geospatial.schools import celtic_schools_source
