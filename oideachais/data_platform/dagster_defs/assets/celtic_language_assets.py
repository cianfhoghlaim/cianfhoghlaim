...
def duchas_volumes(
    ...
    from data_platform.dlt_sources.celtic.duchas import duchas_source
...
def canuint_areas(
    ...
    from data_platform.dlt_sources.celtic.canuint import canuint_source
...
def ud_treebank_sentences(
    ...
    from data_platform.dlt_sources.celtic.universal_dependencies import ud_source
...
def logainm_placenames(
    ...
    from data_platform.dlt_sources.celtic.logainm import logainm_source
...
def tearma_terms(
    ...
    from data_platform.dlt_sources.celtic.tearma import tearma_source
