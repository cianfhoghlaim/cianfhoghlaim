// convex/computer_science/schema — per-subject Convex real-time backend.
//
...
// apps/cianfhoghlaim-leaving-cert/apps/web/src/routes/en/subjects/computer_science/.

// Convex schema for the per-subject Computer Science (Ríomheolaíocht) interactive study
...
// baml/education/web/computer_science_web.baml. The foundation extraction is in
// baml/education/subjects/qpack_computer_science.baml.
//
// These tables are consumed by the per-subject TanStack routes:
//   - convex/computer_science/createSession.ts   → POST /en/subjects/computer_science/study-plan
//   - convex/computer_science/getSession.ts      → GET  /en/subjects/computer_science/syllabus
//   - convex/computer_science/updateSession.ts   → POST /en/subjects/computer_science/syllabus
//   - convex/computer_science/generateStudyPlan.ts → POST /en/subjects/computer_science/study-plan
//   - convex/computer_science/discussExamPaper.ts → POST /en/subjects/computer_science/exam-papers
