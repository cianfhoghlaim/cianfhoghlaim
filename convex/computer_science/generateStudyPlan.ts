// convex/computer_science/generateStudyPlan — per-subject Convex real-time backend.
//
...
// generateStudyPlan — per-subject Computer Science study plan generator.
//
// Convex action that calls into the per-subject BAML backend
// baml/education/web/computer_science_web.baml (function WebStudyPlan), which
// itself delegates to baml/education/subjects/Ríomheolaíocht for the
// per-subject syllabus + past-paper grounding.
//
// Called from /en/subjects/computer_science/study-plan.
