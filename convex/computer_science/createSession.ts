// convex/computer_science/createSession — per-subject Convex real-time backend.
//
...
// createSession — start a per-subject Computer Science interactive study session.
//
// Convex mutation called from /en/subjects/computer_science/study-plan when the
