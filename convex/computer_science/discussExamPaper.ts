// convex/computer_science/discussExamPaper — per-subject Convex real-time backend.
//
...
// discussExamPaper — per-subject Computer Science exam paper discussion.
//
// Convex action that calls into the per-subject BAML backend
// baml/education/web/computer_science_web.baml (function WebExamPaperDiscussion)
// to walk the student through a past exam question.
//
// Called from /en/subjects/computer_science/exam-papers.
