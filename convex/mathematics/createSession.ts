// convex/mathematics/createSession — per-subject Convex real-time backend.
//
...
// createSession — start a per-subject Mathematics interactive study session.
//
// Convex mutation called from /en/subjects/mathematics/study-plan when the
