// convex/mathematics/generateStudyPlan — per-subject Convex real-time backend.
//
...
// generateStudyPlan — per-subject Mathematics study plan generator.
//
// Convex action that calls into the per-subject BAML backend
// baml/education/web/mathematics_web.baml (function WebStudyPlan), which
// itself delegates to baml/education/subjects/Mata for the
// per-subject syllabus + past-paper grounding.
//
// Called from /en/subjects/mathematics/study-plan.
