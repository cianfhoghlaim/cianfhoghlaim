// convex/mathematics/schema — per-subject Convex real-time backend.
//
...
// Convex schema for the per-subject Mathematics (Mata) interactive study
...
// baml/education/web/mathematics_web.baml. The foundation extraction is in
// baml/education/subjects/qpack_mathematics.baml.
//
// These tables are consumed by the per-subject TanStack routes:
//   - convex/mathematics/createSession.ts   → POST /en/subjects/mathematics/study-plan
//   - convex/mathematics/getSession.ts      → GET  /en/subjects/mathematics/syllabus
//   - convex/mathematics/updateSession.ts   → POST /en/subjects/mathematics/syllabus
//   - convex/mathematics/generateStudyPlan.ts → POST /en/subjects/mathematics/study-plan
//   - convex/mathematics/discussExamPaper.ts → POST /en/subjects/mathematics/exam-papers
