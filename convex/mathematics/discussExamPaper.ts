// convex/mathematics/discussExamPaper — per-subject Convex real-time backend.
//
...
// discussExamPaper — per-subject Mathematics exam paper discussion.
//
// Convex action that calls into the per-subject BAML backend
// baml/education/web/mathematics_web.baml (function WebExamPaperDiscussion)
// to walk the student through a past exam question.
//
// Called from /en/subjects/mathematics/exam-papers.
