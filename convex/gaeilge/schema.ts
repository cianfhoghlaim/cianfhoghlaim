// convex/gaeilge/schema — per-subject Convex real-time backend.
//
...
// Convex schema for the per-subject Gaeilge (Gaeilge) interactive study
...
// baml/education/web/gaeilge_web.baml. The foundation extraction is in
// baml/education/subjects/qpack_gaeilge.baml.
//
// These tables are consumed by the per-subject TanStack routes:
//   - convex/gaeilge/createSession.ts   → POST /en/subjects/gaeilge/study-plan
//   - convex/gaeilge/getSession.ts      → GET  /en/subjects/gaeilge/syllabus
//   - convex/gaeilge/updateSession.ts   → POST /en/subjects/gaeilge/syllabus
//   - convex/gaeilge/generateStudyPlan.ts → POST /en/subjects/gaeilge/study-plan
//   - convex/gaeilge/discussExamPaper.ts → POST /en/subjects/gaeilge/exam-papers
