// convex/gaeilge/generateStudyPlan — per-subject Convex real-time backend.
//
...
// generateStudyPlan — per-subject Gaeilge study plan generator.
//
// Convex action that calls into the per-subject BAML backend
// baml/education/web/gaeilge_web.baml (function WebStudyPlan), which
// itself delegates to baml/education/subjects/Gaeilge for the
// per-subject syllabus + past-paper grounding.
//
// Called from /en/subjects/gaeilge/study-plan.
