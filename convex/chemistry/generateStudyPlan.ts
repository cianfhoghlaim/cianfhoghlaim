// convex/chemistry/generateStudyPlan — per-subject Convex real-time backend.
//
...
// generateStudyPlan — per-subject Chemistry study plan generator.
//
// Convex action that calls into the per-subject BAML backend
// baml/education/web/chemistry_web.baml (function WebStudyPlan), which
// itself delegates to baml/education/subjects/Ceimic for the
// per-subject syllabus + past-paper grounding.
//
// Called from /en/subjects/chemistry/study-plan.
