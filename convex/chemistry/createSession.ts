// convex/chemistry/createSession — per-subject Convex real-time backend.
//
...
// createSession — start a per-subject Chemistry interactive study session.
//
// Convex mutation called from /en/subjects/chemistry/study-plan when the
