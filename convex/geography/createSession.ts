// convex/geography/createSession — per-subject Convex real-time backend.
//
...
// createSession — start a per-subject Geography interactive study session.
//
// Convex mutation called from /en/subjects/geography/study-plan when the
