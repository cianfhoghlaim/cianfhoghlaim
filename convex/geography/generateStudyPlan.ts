// convex/geography/generateStudyPlan — per-subject Convex real-time backend.
//
...
// generateStudyPlan — per-subject Geography study plan generator.
//
// Convex action that calls into the per-subject BAML backend
// baml/education/web/geography_web.baml (function WebStudyPlan), which
// itself delegates to baml/education/subjects/Tíreolaíocht for the
// per-subject syllabus + past-paper grounding.
//
// Called from /en/subjects/geography/study-plan.
