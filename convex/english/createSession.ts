// convex/english/createSession — per-subject Convex real-time backend.
//
...
// createSession — start a per-subject English interactive study session.
//
// Convex mutation called from /en/subjects/english/study-plan when the
