// convex/english/schema — per-subject Convex real-time backend.
//
...
// Convex schema for the per-subject English (Béarla) interactive study
...
// baml/education/web/english_web.baml. The foundation extraction is in
// baml/education/subjects/qpack_english.baml.
//
// These tables are consumed by the per-subject TanStack routes:
//   - convex/english/createSession.ts   → POST /en/subjects/english/study-plan
//   - convex/english/getSession.ts      → GET  /en/subjects/english/syllabus
//   - convex/english/updateSession.ts   → POST /en/subjects/english/syllabus
//   - convex/english/generateStudyPlan.ts → POST /en/subjects/english/study-plan
//   - convex/english/discussExamPaper.ts → POST /en/subjects/english/exam-papers
