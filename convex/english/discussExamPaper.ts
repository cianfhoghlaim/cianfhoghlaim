// convex/english/discussExamPaper — per-subject Convex real-time backend.
//
...
// discussExamPaper — per-subject English exam paper discussion.
//
// Convex action that calls into the per-subject BAML backend
// baml/education/web/english_web.baml (function WebExamPaperDiscussion)
// to walk the student through a past exam question.
//
// Called from /en/subjects/english/exam-papers.
