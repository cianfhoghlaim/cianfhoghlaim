"""
destinations_tuatha — re-export shim.
...
# Original path: dlt_sources/common/destinations_tuatha.py
# Original line count: 146
# Wave 4: replaced with re-export shim.
#
# The original implementation is preserved in git history at commit
# b8e7e18bd (before Wave 4) — use `git show b8e7e18bd:dlt_sources/common/destinations_tuatha.py` to view.
