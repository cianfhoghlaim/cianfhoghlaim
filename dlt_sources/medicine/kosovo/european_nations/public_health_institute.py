"""DLT source for the Public Health Institute of Kosovo.

Crawls ``https://msh.rks-gov.net`` and emits one row per ``(phi_id, language)``
...
``dlt/european_nations/xkx/medicine/public_health_institute.py`` with
``source_id="european_nations.xkx.medicine.public_health_institute"`` and lands in
the DuckLake table ``oideachais.medicine.european_nations.xkx``.

Honours ``USE_LOCAL_SCRAPES=true`` by reading from
``stedding/ingest_queue/european_nations/xkx/medicine/<lang>/``.
...
class KosovoMedicineSource(NationSource):
    """Public Health Institute of Kosovo DLT source."""
    ...
    def __init__(self) -> None:
        super().__init__(
            ...
            extra_metadata={
                "canonical_root": "https://msh.rks-gov.net",
                "title": "Public Health Institute of Kosovo",
            },
        )


_NATION_SOURCE = KosovoMedicineSource()
...
def public_health_institute(language: str | None = None) -> Iterator[dict[str, Any]]:
    """Yield Kosovo Public Health Institute rows from the canonical cache."""
...
def public_health_institute_source(language: str | None = None):
    """DLT source for the Public Health Institute of Kosovo ingestion."""
    return public_health_institute(language=language)


__all__ = [
    "KosovoMedicineSource",
