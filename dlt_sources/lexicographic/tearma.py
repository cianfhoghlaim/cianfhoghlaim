...
this source moved from `dlt_sources/language/tearma.py` to
`dlt_sources/lexicographic/tearma.py` (master plan §3.2, §7.1).
The companion search source lives at
`dlt_sources.lexicographic.tearma_search`. Shared helpers + module
constants + `TerminologyLinker` live at
...
import dlt_sources
from ._tearma_helpers import _load_tearma_terms
