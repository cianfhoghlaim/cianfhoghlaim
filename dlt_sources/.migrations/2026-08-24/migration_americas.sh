...
# (lines L133-L133) for Phase 0.2 of the openspec change
# `2026-08-24-dlt-sources-to-multi-repo-scaffold-v1`.
#
# Usage:
#   bash migration_americas.sh           # APPLY (default)
#   bash migration_americas.sh --dry-run # print what would change; do NOT write
#
...
# ----------------------------------------------------------------------------
# Pair list (4 pairs; deterministic, sourced from
# LEGACY_ALIASES.md L133-L133)
# ----------------------------------------------------------------------------

apply_pair 'from dlt_sources\.americas\.Brazil\.' 'from dlt_sources.american_nations.brazil.' 'dlt_sources/americas/bra' 'dlt_sources/american_nations/brazil'
apply_pair 'from dlt_sources\.americas\.Mexico\.' 'from dlt_sources.american_nations.mexico.' 'dlt_sources/americas/mex' 'dlt_sources/american_nations/mexico'
apply_pair 'from dlt_sources\.americas\.United States\.' 'from dlt_sources.american_nations.united_states.' 'dlt_sources/americas/us' 'dlt_sources/american_nations/united_states'
apply_pair 'from dlt_sources\.americas\.Venezuela\.' 'from dlt_sources.american_nations.venezuela.' 'dlt_sources/americas/ven' 'dlt_sources/american_nations/venezuela'
