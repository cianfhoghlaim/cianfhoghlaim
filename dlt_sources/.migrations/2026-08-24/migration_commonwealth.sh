#!/usr/bin/env bash
#
# Commonwealth top-level — ISO 3-letter -> full snake_case.
#
# Generated by `_generator.py` from `dlt_sources/LEGACY_ALIASES.md`
# (lines L103-L103) for Phase 0.2 of the openspec change
# `2026-08-24-dlt-sources-to-multi-repo-scaffold-v1`.
#
# Usage:
#   bash migration_commonwealth.sh           # APPLY (default)
#   bash migration_commonwealth.sh --dry-run # print what would change; do NOT write
#
...
# ----------------------------------------------------------------------------
# Pair list (6 pairs; deterministic, sourced from
# LEGACY_ALIASES.md L103-L103)
# ----------------------------------------------------------------------------

apply_pair 'from dlt_sources\.commonwealth\.aus\b' 'from dlt_sources.commonwealth.australia' 'dlt_sources/commonwealth/aus' 'dlt_sources/commonwealth/australia'
apply_pair 'from dlt_sources\.commonwealth\.can\b' 'from dlt_sources.commonwealth.canada' 'dlt_sources/commonwealth/can' 'dlt_sources/commonwealth/canada'
apply_pair 'from dlt_sources\.commonwealth\.ind\b' 'from dlt_sources.commonwealth.india' 'dlt_sources/commonwealth/ind' 'dlt_sources/commonwealth/india'
apply_pair 'from dlt_sources\.commonwealth\.nga\b' 'from dlt_sources.commonwealth.nigeria' 'dlt_sources/commonwealth/nga' 'dlt_sources/commonwealth/nigeria'
apply_pair 'from dlt_sources\.commonwealth\.nzl\b' 'from dlt_sources.commonwealth.new_zealand' 'dlt_sources/commonwealth/nzl' 'dlt_sources/commonwealth/new_zealand'
apply_pair 'from dlt_sources\.commonwealth\.zaf\b' 'from dlt_sources.commonwealth.south_africa' 'dlt_sources/commonwealth/zaf' 'dlt_sources/commonwealth/south_africa'
