...
Canonical: ciandlíthe/dlt_sources/law/_context/european_nations/montenegro/law/
...
warnings.warn(
    "dlt_sources.european_nations.montenegro.law moved to ciandlíthe; "
    "update to ciandlithe.dlt_sources.law._context.european_nations.montenegro.law",
    DeprecationWarning,
    stacklevel=2,
)
