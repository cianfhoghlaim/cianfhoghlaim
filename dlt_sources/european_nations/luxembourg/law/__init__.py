...
Canonical: ciandlíthe/dlt_sources/law/_context/european_nations/luxembourg/law/
...
warnings.warn(
    "dlt_sources.european_nations.luxembourg.law moved to ciandlíthe; "
    "update to ciandlithe.dlt_sources.law._context.european_nations.luxembourg.law",
    DeprecationWarning,
    stacklevel=2,
)
