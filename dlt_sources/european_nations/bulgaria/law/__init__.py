...
Canonical: ciandlíthe/dlt_sources/law/_context/european_nations/bulgaria/law/
...
warnings.warn(
    "dlt_sources.european_nations.bulgaria.law moved to ciandlíthe; "
    "update to ciandlithe.dlt_sources.law._context.european_nations.bulgaria.law",
    DeprecationWarning,
    stacklevel=2,
)
