...
Canonical: ciandlíthe/dlt_sources/law/_context/european_nations/poland/law/
...
warnings.warn(
    "dlt_sources.european_nations.poland.law moved to ciandlíthe; "
    "update to ciandlithe.dlt_sources.law._context.european_nations.poland.law",
    DeprecationWarning,
    stacklevel=2,
)
