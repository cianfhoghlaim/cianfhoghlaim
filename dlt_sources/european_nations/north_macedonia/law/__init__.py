...
Canonical: ciandlíthe/dlt_sources/law/_context/european_nations/north_macedonia/law/
...
warnings.warn(
    "dlt_sources.european_nations.north_macedonia.law moved to ciandlíthe; "
    "update to ciandlithe.dlt_sources.law._context.european_nations.north_macedonia.law",
    DeprecationWarning,
    stacklevel=2,
)
