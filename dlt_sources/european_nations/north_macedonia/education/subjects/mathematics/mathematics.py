"""Per-subject DLT source for North Macedonia (Mathematics).
...
``stedding/ingest_queue/european_nations/mkd/education/subjects/mathematics/<lang>/``.
...
class NorthMacedoniaMathematicsSource(NationSource):
    """North Macedonia Mathematics DLT source."""
    ...
    def __init__(self) -> None:
        super().__init__(
            ...
            extra_metadata={
                ...
                "title": "North Macedonia Mathematics (MKD)",
                "subject": SUBJECT,
...
_NATION_SOURCE = MKDMathematicsSource()
...
def mkd_mathematics(language: str | None = None) -> Iterator[dict[str, Any]]:
    """Yield North Macedonia Mathematics rows from the canonical cache."""
    if not use_local_scrapes():
        logger.warning(
            "mkd_mathematics_live_mode_not_implemented",
...
@dlt.source(name="mkd_mathematics")
def mkd_mathematics_source(language: str | None = None):
    """DLT source for the North Macedonia Mathematics ingestion."""
    return mkd_mathematics(language=language)
