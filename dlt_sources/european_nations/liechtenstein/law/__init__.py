...
Canonical: ciandlíthe/dlt_sources/law/_context/european_nations/liechtenstein/law/
...
warnings.warn(
    "dlt_sources.european_nations.liechtenstein.law moved to ciandlíthe; "
    "update to ciandlithe.dlt_sources.law._context.european_nations.liechtenstein.law",
    DeprecationWarning,
    stacklevel=2,
)
