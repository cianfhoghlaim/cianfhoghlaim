"""Per-subject DLT source for Moldova (Computing Science).
...
``stedding/ingest_queue/european_nations/mda/education/subjects/computing_science/<lang>/``.
    ...
    def __init__(self) -> None:
        super().__init__(
            ...
            extra_metadata={
                ...
                "title": "Moldova Computing Science (MDA)",
                "subject": SUBJECT,
...
_NATION_SOURCE = MDAComputingScienceSource()
...
def mda_computing_science(language: str | None = None) -> Iterator[dict[str, Any]]:
    """Yield Moldova Computing Science rows from the canonical cache."""
    if not use_local_scrapes():
        logger.warning(
            "mda_computing_science_live_mode_not_implemented",
...
@dlt.source(name="mda_computing_science")
def mda_computing_science_source(language: str | None = None):
    """DLT source for the Moldova Computing Science ingestion."""
    return mda_computing_science(language=language)
...
__all__ = [
    ...
    "SUBJECT",
    "DEFAULT_LEVEL",
    "MDAComputingScienceSource",
    "mda_computing_science",
    "mda_computing_science_source",
]
