"""DLT source for the Public Health Institute of Moldova.

Crawls ``https://ms.gov.md`` and emits one row per ``(phi_id, language)``
...
``dlt/european_nations/mda/medicine/public_health_institute.py`` with
``source_id="european_nations.mda.medicine.public_health_institute"`` and lands in
the DuckLake table ``oideachais.medicine.european_nations.mda``.

Honours ``USE_LOCAL_SCRAPES=true`` by reading from
``stedding/ingest_queue/european_nations/mda/medicine/<lang>/``.
...
class MoldovaMedicineSource(NationSource):
    """Public Health Institute of Moldova DLT source."""
    ...
    def __init__(self) -> None:
        super().__init__(
            ...
            extra_metadata={
                "canonical_root": "https://ms.gov.md",
                "title": "Public Health Institute of Moldova",
            },
        )


_NATION_SOURCE = MoldovaMedicineSource()
...
def public_health_institute(language: str | None = None) -> Iterator[dict[str, Any]]:
    """Yield Moldova Public Health Institute rows from the canonical cache."""
...
def public_health_institute_source(language: str | None = None):
    """DLT source for the Public Health Institute of Moldova ingestion."""
    return public_health_institute(language=language)


__all__ = [
    "MoldovaMedicineSource",
