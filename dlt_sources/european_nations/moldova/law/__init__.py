...
Canonical: ciandlíthe/dlt_sources/law/_context/european_nations/moldova/law/
...
warnings.warn(
    "dlt_sources.european_nations.moldova.law moved to ciandlíthe; "
    "update to ciandlithe.dlt_sources.law._context.european_nations.moldova.law",
    DeprecationWarning,
    stacklevel=2,
)
