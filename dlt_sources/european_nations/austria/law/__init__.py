...
Canonical: ciandlíthe/dlt_sources/law/_context/european_nations/austria/law/
...
warnings.warn(
    "dlt_sources.european_nations.austria.law moved to ciandlíthe; "
    "update to ciandlithe.dlt_sources.law._context.european_nations.austria.law",
    DeprecationWarning,
    stacklevel=2,
)
