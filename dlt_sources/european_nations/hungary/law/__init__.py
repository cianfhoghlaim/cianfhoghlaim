...
Canonical: ciandlíthe/dlt_sources/law/_context/european_nations/hungary/law/
...
warnings.warn(
    "dlt_sources.european_nations.hungary.law moved to ciandlíthe; "
    "update to ciandlithe.dlt_sources.law._context.european_nations.hungary.law",
    DeprecationWarning,
    stacklevel=2,
)
