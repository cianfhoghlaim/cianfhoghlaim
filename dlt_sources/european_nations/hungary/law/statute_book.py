...
``dlt/european_nations/hun/law/statute_book.py`` with
``source_id="european_nations.hun.law.statute_book"`` and lands in
the DuckLake table ``oideachais.law.european_nations.hun``.

Honours ``USE_LOCAL_SCRAPES=true`` by reading from
``stedding/ingest_queue/european_nations/hun/law/<lang>/``.
...
class HungaryLawSource(NationSource):
    ...
    def __init__(self) -> None:
        super().__init__(
            ...
            extra_metadata={
                "canonical_root": "https://njt.hu",
                "title": "Hungarian Official Gazette / Nemzeti Jogszabálytár",
            },
        )
...
def statute_book(language: str | None = None) -> Iterator[dict[str, Any]]:
    """Yield Hungary law rows from the canonical cache."""
...
def statute_book_source(language: str | None = None):
    """DLT source for the Hungarian Official Gazette / Nemzeti Jogszabálytár ingestion."""
