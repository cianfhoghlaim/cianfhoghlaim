...
Canonical: ciandlíthe/dlt_sources/law/_context/european_nations/spain/law/
...
warnings.warn(
    "dlt_sources.european_nations.spain.law moved to ciandlíthe; "
    "update to ciandlithe.dlt_sources.law._context.european_nations.spain.law",
    DeprecationWarning,
    stacklevel=2,
)
