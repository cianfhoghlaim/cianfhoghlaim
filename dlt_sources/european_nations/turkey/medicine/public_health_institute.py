"""DLT source for the Public Health Institute of Turkey.

Crawls ``https://saglik.gov.tr`` and emits one row per ``(phi_id, language)``
...
``dlt/european_nations/tur/medicine/public_health_institute.py`` with
``source_id="european_nations.tur.medicine.public_health_institute"`` and lands in
the DuckLake table ``oideachais.medicine.european_nations.tur``.

Honours ``USE_LOCAL_SCRAPES=true`` by reading from
``stedding/ingest_queue/european_nations/tur/medicine/<lang>/``.
...
class TurkeyMedicineSource(NationSource):
    """Public Health Institute of Turkey DLT source."""
    ...
    def __init__(self) -> None:
        super().__init__(
            ...
            extra_metadata={
                "canonical_root": "https://saglik.gov.tr",
                "title": "Public Health Institute of Turkey",
            },
        )


_NATION_SOURCE = TurkeyMedicineSource()
...
def public_health_institute(language: str | None = None) -> Iterator[dict[str, Any]]:
    """Yield Turkey Public Health Institute rows from the canonical cache."""
...
def public_health_institute_source(language: str | None = None):
    """DLT source for the Public Health Institute of Turkey ingestion."""
    return public_health_institute(language=language)


__all__ = [
    "TurkeyMedicineSource",
