...
Canonical: ciandlíthe/dlt_sources/law/_context/european_nations/turkey/law/
...
warnings.warn(
    "dlt_sources.european_nations.turkey.law moved to ciandlíthe; "
    "update to ciandlithe.dlt_sources.law._context.european_nations.turkey.law",
    DeprecationWarning,
    stacklevel=2,
)
