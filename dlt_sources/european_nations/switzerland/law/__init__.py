...
Canonical: ciandlíthe/dlt_sources/law/_context/european_nations/switzerland/law/
...
warnings.warn(
    "dlt_sources.european_nations.switzerland.law moved to ciandlíthe; "
    "update to ciandlithe.dlt_sources.law._context.european_nations.switzerland.law",
    DeprecationWarning,
    stacklevel=2,
)
