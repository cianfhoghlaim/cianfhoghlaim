...
Canonical: ciandlíthe/dlt_sources/law/_context/european_nations/france/law/
...
warnings.warn(
    "dlt_sources.european_nations.france.law moved to ciandlíthe; "
    "update to ciandlithe.dlt_sources.law._context.european_nations.france.law",
    DeprecationWarning,
    stacklevel=2,
)
