...
Canonical: ciandlíthe/dlt_sources/law/_context/european_nations/czechia/law/
...
warnings.warn(
    "dlt_sources.european_nations.czechia.law moved to ciandlíthe; "
    "update to ciandlithe.dlt_sources.law._context.european_nations.czechia.law",
    DeprecationWarning,
    stacklevel=2,
)
