...
Canonical: ciandlíthe/dlt_sources/law/_context/european_nations/finland/law/
...
warnings.warn(
    "dlt_sources.european_nations.finland.law moved to ciandlíthe; "
    "update to ciandlithe.dlt_sources.law._context.european_nations.finland.law",
    DeprecationWarning,
    stacklevel=2,
)
