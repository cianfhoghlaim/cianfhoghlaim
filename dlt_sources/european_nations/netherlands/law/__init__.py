...
Canonical: ciandlíthe/dlt_sources/law/_context/european_nations/netherlands/law/
...
warnings.warn(
    "dlt_sources.european_nations.netherlands.law moved to ciandlíthe; "
    "update to ciandlithe.dlt_sources.law._context.european_nations.netherlands.law",
    DeprecationWarning,
    stacklevel=2,
)
