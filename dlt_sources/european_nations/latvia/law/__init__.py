...
Canonical: ciandlíthe/dlt_sources/law/_context/european_nations/latvia/law/
...
warnings.warn(
    "dlt_sources.european_nations.latvia.law moved to ciandlíthe; "
    "update to ciandlithe.dlt_sources.law._context.european_nations.latvia.law",
    DeprecationWarning,
    stacklevel=2,
)
