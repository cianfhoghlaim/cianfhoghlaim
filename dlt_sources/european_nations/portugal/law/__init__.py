...
Canonical: ciandlíthe/dlt_sources/law/_context/european_nations/portugal/law/
...
warnings.warn(
    "dlt_sources.european_nations.portugal.law moved to ciandlíthe; "
    "update to ciandlithe.dlt_sources.law._context.european_nations.portugal.law",
    DeprecationWarning,
    stacklevel=2,
)
