...
Canonical: ciandlíthe/dlt_sources/law/_context/european_nations/cyprus/law/
...
warnings.warn(
    "dlt_sources.european_nations.cyprus.law moved to ciandlíthe; "
    "update to ciandlithe.dlt_sources.law._context.european_nations.cyprus.law",
    DeprecationWarning,
    stacklevel=2,
)
