...
Canonical: ciandlíthe/dlt_sources/law/_context/european_nations/denmark/law/
...
warnings.warn(
    "dlt_sources.european_nations.denmark.law moved to ciandlíthe; "
    "update to ciandlithe.dlt_sources.law._context.european_nations.denmark.law",
    DeprecationWarning,
    stacklevel=2,
)
