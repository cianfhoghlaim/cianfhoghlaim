...
Canonical: ciandlíthe/dlt_sources/law/_context/european_nations/iceland/law/
...
warnings.warn(
    "dlt_sources.european_nations.iceland.law moved to ciandlíthe; "
    "update to ciandlithe.dlt_sources.law._context.european_nations.iceland.law",
    DeprecationWarning,
    stacklevel=2,
)
