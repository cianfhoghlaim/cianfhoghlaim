...
Canonical: ciandlíthe/dlt_sources/law/_context/european_nations/kosovo/law/
...
warnings.warn(
    "dlt_sources.european_nations.kosovo.law moved to ciandlíthe; "
    "update to ciandlithe.dlt_sources.law._context.european_nations.kosovo.law",
    DeprecationWarning,
    stacklevel=2,
)
