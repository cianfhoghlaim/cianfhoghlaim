"""Per-subject DLT source for Albania (Computing Science).
...
``stedding/ingest_queue/european_nations/alb/education/subjects/computing_science/<lang>/``.
...
class AlbaniaComputingScienceSource(NationSource):
    """Albania Computing Science DLT source."""
    ...
    def __init__(self) -> None:
        super().__init__(
            ...
            extra_metadata={
                ...
                "title": "Albania Computing Science (ALB)",
                "subject": SUBJECT,
...
_NATION_SOURCE = ALBComputingScienceSource()
...
def alb_computing_science(language: str | None = None) -> Iterator[dict[str, Any]]:
    """Yield Albania Computing Science rows from the canonical cache."""
    if not use_local_scrapes():
        logger.warning(
            "alb_computing_science_live_mode_not_implemented",
...
@dlt.source(name="alb_computing_science")
def alb_computing_science_source(language: str | None = None):
    """DLT source for the Albania Computing Science ingestion."""
    return alb_computing_science(language=language)
...
__all__ = [
    ...
    "SUBJECT",
    "DEFAULT_LEVEL",
    "ALBComputingScienceSource",
    "alb_computing_science",
    "alb_computing_science_source",
]
