...
Canonical: ciandlíthe/dlt_sources/law/_context/european_nations/albania/law/
...
warnings.warn(
    "dlt_sources.european_nations.albania.law moved to ciandlíthe; "
    "update to ciandlithe.dlt_sources.law._context.european_nations.albania.law",
    DeprecationWarning,
    stacklevel=2,
)
