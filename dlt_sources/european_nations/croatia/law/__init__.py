...
Canonical: ciandlíthe/dlt_sources/law/_context/european_nations/croatia/law/
...
warnings.warn(
    "dlt_sources.european_nations.croatia.law moved to ciandlíthe; "
    "update to ciandlithe.dlt_sources.law._context.european_nations.croatia.law",
    DeprecationWarning,
    stacklevel=2,
)
