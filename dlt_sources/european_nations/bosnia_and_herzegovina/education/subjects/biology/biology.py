"""Per-subject DLT source for Bosnia and Herzegovina (Biology).
...
``stedding/ingest_queue/european_nations/bih/education/subjects/biology/<lang>/``.
    ...
    def __init__(self) -> None:
        super().__init__(
            ...
            extra_metadata={
                ...
                "title": "Bosnia and Herzegovina Biology (BIH)",
                "subject": SUBJECT,
...
_NATION_SOURCE = BIHBiologySource()
...
def bih_biology(language: str | None = None) -> Iterator[dict[str, Any]]:
    """Yield Bosnia and Herzegovina Biology rows from the canonical cache."""
    if not use_local_scrapes():
        logger.warning(
            "bih_biology_live_mode_not_implemented",
...
@dlt.source(name="bih_biology")
def bih_biology_source(language: str | None = None):
    """DLT source for the Bosnia and Herzegovina Biology ingestion."""
    return bih_biology(language=language)
