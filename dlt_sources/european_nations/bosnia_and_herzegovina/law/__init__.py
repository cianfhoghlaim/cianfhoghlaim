...
Canonical: ciandlíthe/dlt_sources/law/_context/european_nations/bosnia_and_herzegovina/law/
...
warnings.warn(
    "dlt_sources.european_nations.bosnia_and_herzegovina.law moved to ciandlíthe; "
    "update to ciandlithe.dlt_sources.law._context.european_nations.bosnia_and_herzegovina.law",
    DeprecationWarning,
    stacklevel=2,
)
