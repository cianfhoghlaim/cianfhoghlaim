...
Canonical: ciandlíthe/dlt_sources/law/_context/european_nations/malta/law/
...
warnings.warn(
    "dlt_sources.european_nations.malta.law moved to ciandlíthe; "
    "update to ciandlithe.dlt_sources.law._context.european_nations.malta.law",
    DeprecationWarning,
    stacklevel=2,
)
