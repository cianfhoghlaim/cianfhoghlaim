...
Canonical: ciandlíthe/dlt_sources/law/_context/european_nations/germany/law/
...
warnings.warn(
    "dlt_sources.european_nations.germany.law moved to ciandlíthe; "
    "update to ciandlithe.dlt_sources.law._context.european_nations.germany.law",
    DeprecationWarning,
    stacklevel=2,
)
