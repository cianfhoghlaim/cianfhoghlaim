...
Canonical: ciandlíthe/dlt_sources/law/_context/european_nations/lithuania/law/
...
warnings.warn(
    "dlt_sources.european_nations.lithuania.law moved to ciandlíthe; "
    "update to ciandlithe.dlt_sources.law._context.european_nations.lithuania.law",
    DeprecationWarning,
    stacklevel=2,
)
