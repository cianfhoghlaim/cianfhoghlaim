...
Canonical: ciandlíthe/dlt_sources/law/_context/european_nations/estonia/law/
...
warnings.warn(
    "dlt_sources.european_nations.estonia.law moved to ciandlíthe; "
    "update to ciandlithe.dlt_sources.law._context.european_nations.estonia.law",
    DeprecationWarning,
    stacklevel=2,
)
