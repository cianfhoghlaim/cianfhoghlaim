...
Canonical: ciandlíthe/dlt_sources/law/_context/european_nations/norway/law/
...
warnings.warn(
    "dlt_sources.european_nations.norway.law moved to ciandlíthe; "
    "update to ciandlithe.dlt_sources.law._context.european_nations.norway.law",
    DeprecationWarning,
    stacklevel=2,
)
