...
Canonical: ciandlíthe/dlt_sources/law/_context/european_nations/ukraine/law/
...
warnings.warn(
    "dlt_sources.european_nations.ukraine.law moved to ciandlíthe; "
    "update to ciandlithe.dlt_sources.law._context.european_nations.ukraine.law",
    DeprecationWarning,
    stacklevel=2,
)
