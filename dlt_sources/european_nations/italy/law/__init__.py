...
Canonical: ciandlíthe/dlt_sources/law/_context/european_nations/italy/law/
...
warnings.warn(
    "dlt_sources.european_nations.italy.law moved to ciandlíthe; "
    "update to ciandlithe.dlt_sources.law._context.european_nations.italy.law",
    DeprecationWarning,
    stacklevel=2,
)
