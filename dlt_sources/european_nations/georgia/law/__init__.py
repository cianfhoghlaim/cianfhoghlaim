...
Canonical: ciandlíthe/dlt_sources/law/_context/european_nations/georgia/law/
...
warnings.warn(
    "dlt_sources.european_nations.georgia.law moved to ciandlíthe; "
    "update to ciandlithe.dlt_sources.law._context.european_nations.georgia.law",
    DeprecationWarning,
    stacklevel=2,
)
