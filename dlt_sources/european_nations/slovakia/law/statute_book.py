...
``dlt/european_nations/svk/law/statute_book.py`` with
``source_id="european_nations.svk.law.statute_book"`` and lands in
the DuckLake table ``oideachais.law.european_nations.svk``.

Honours ``USE_LOCAL_SCRAPES=true`` by reading from
``stedding/ingest_queue/european_nations/svk/law/<lang>/``.
...
class SlovakiaLawSource(NationSource):
    ...
    def __init__(self) -> None:
        super().__init__(
            ...
            extra_metadata={
                "canonical_root": "https://www.slov-lex.sk",
                "title": "Slov-Lex (Slovak Statute Book)",
            },
        )
...
def statute_book(language: str | None = None) -> Iterator[dict[str, Any]]:
    """Yield Slovakia law rows from the canonical cache."""
...
def statute_book_source(language: str | None = None):
    """DLT source for the Slov-Lex (Slovak Statute Book) ingestion."""
