...
Canonical: ciandlíthe/dlt_sources/law/_context/european_nations/slovakia/law/
...
warnings.warn(
    "dlt_sources.european_nations.slovakia.law moved to ciandlíthe; "
    "update to ciandlithe.dlt_sources.law._context.european_nations.slovakia.law",
    DeprecationWarning,
    stacklevel=2,
)
