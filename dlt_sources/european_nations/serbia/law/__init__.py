...
Canonical: ciandlíthe/dlt_sources/law/_context/european_nations/serbia/law/
...
warnings.warn(
    "dlt_sources.european_nations.serbia.law moved to ciandlíthe; "
    "update to ciandlithe.dlt_sources.law._context.european_nations.serbia.law",
    DeprecationWarning,
    stacklevel=2,
)
