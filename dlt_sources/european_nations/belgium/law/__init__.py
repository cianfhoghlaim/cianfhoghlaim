...
Canonical: ciandlíthe/dlt_sources/law/_context/european_nations/belgium/law/
...
warnings.warn(
    "dlt_sources.european_nations.belgium.law moved to ciandlíthe; "
    "update to ciandlithe.dlt_sources.law._context.european_nations.belgium.law",
    DeprecationWarning,
    stacklevel=2,
)
