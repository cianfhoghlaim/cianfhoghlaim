...
Canonical: ciandlíthe/dlt_sources/law/_context/european_nations/sweden/law/
...
warnings.warn(
    "dlt_sources.european_nations.sweden.law moved to ciandlíthe; "
    "update to ciandlithe.dlt_sources.law._context.european_nations.sweden.law",
    DeprecationWarning,
    stacklevel=2,
)
