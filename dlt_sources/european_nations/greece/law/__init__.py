...
Canonical: ciandlíthe/dlt_sources/law/_context/european_nations/greece/law/
...
warnings.warn(
    "dlt_sources.european_nations.greece.law moved to ciandlíthe; "
    "update to ciandlithe.dlt_sources.law._context.european_nations.greece.law",
    DeprecationWarning,
    stacklevel=2,
)
