...
Canonical: ciandlíthe/dlt_sources/law/_context/european_nations/romania/law/
...
warnings.warn(
    "dlt_sources.european_nations.romania.law moved to ciandlíthe; "
    "update to ciandlithe.dlt_sources.law._context.european_nations.romania.law",
    DeprecationWarning,
    stacklevel=2,
)
