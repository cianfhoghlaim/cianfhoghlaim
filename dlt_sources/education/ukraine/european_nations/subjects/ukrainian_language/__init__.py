"""dlt_sources/education/ukraine/european_nations/subjects/ukrainian_language — DLT sources.
...
from . import ukrainian_language  # noqa: F401

__all__ = ['ukrainian_language']
