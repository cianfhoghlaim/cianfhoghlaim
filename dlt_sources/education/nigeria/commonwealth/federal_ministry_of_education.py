"""DLT source for the Nigerian federal Federal Ministry of Education.
...
``stedding/ingest_queue/commonwealth/nga/education/federal_ministry_of_education/<lang>/``.
"""
...
FEDERAL_INSTITUTION = "federal_ministry_of_education"
CANONICAL_URL = "https://www.education.gov.ng"
DEFAULT_LANGUAGE = "en"


@dlt.resource(
    name="nga_federal_federal_ministry_of_education",
...
def nga_federal_federal_ministry_of_education(language=None):
    """Yield Nigerian federal rows from the canonical cache."""
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/education/federal_ministry_of_education")
    ...
    for lang in languages:
        ...
        for json_path in sorted(lang_dir.glob("*.json")):
            try:
                ...
                logger.warning("nga_federal_federal_ministry_of_education_cache_parse_failed", path=str(json_path), error=str(exc))
                continue
...
@dlt.source(name="nga_federal_federal_ministry_of_education")
def nga_federal_federal_ministry_of_education_source(language=None):
    """DLT source for the Nigerian federal ingestion."""
    return nga_federal_federal_ministry_of_education(language=language)
...
__all__ = [
    ...
    "DEFAULT_LANGUAGE",
    "FEDERAL_INSTITUTION",
    "nga_federal_federal_ministry_of_education",
    "nga_federal_federal_ministry_of_education_source",
]
