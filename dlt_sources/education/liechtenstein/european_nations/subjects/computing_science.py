"""Per-subject DLT source for Liechtenstein (computing_science).
...
``stedding/ingest_queue/european_nations/lie/education/subjects/computing_science/<lang>/``.
    ...
    def __init__(self) -> None:
        super().__init__(
            ...
            extra_metadata={
                ...
                "title": "Liechtenstein computing_science curriculum (de)",
            },
        )
...
def lie_computing_science(language: str | None = None) -> Iterator[dict[str, Any]]:
    """Yield Liechtenstein computing_science rows from the canonical per-subject cache."""
    if not use_local_scrapes():
        logger.warning(
            "lie_computing_science_live_mode_not_implemented",
...
@dlt.source(name="lie_computing_science")
def lie_computing_science_source(language: str | None = None):
    """DLT source for the Liechtenstein computing_science ingestion."""
    return lie_computing_science(language=language)
