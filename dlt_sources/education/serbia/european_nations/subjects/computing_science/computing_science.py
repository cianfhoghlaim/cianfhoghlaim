"""Per-subject DLT source for Serbia (Computing Science).
...
``stedding/ingest_queue/european_nations/srb/education/subjects/computing_science/<lang>/``.
    ...
    def __init__(self) -> None:
        super().__init__(
            ...
            extra_metadata={
                ...
                "title": "Serbia Computing Science (SRB)",
                "subject": SUBJECT,
...
_NATION_SOURCE = SRBComputingScienceSource()
...
def srb_computing_science(language: str | None = None) -> Iterator[dict[str, Any]]:
    """Yield Serbia Computing Science rows from the canonical cache."""
    if not use_local_scrapes():
        logger.warning(
            "srb_computing_science_live_mode_not_implemented",
...
@dlt.source(name="srb_computing_science")
def srb_computing_science_source(language: str | None = None):
    """DLT source for the Serbia Computing Science ingestion."""
    return srb_computing_science(language=language)
...
__all__ = [
    ...
    "SUBJECT",
    "DEFAULT_LEVEL",
    "SRBComputingScienceSource",
    "srb_computing_science",
    "srb_computing_science_source",
]
