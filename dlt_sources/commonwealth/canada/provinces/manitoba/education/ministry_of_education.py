"""DLT source for the Manitoba Ministry of Education.
...
CANONICAL_URL = "https://www.edu.gov.mb.ca"
DEFAULT_LANGUAGE = "en"


@dlt.resource(
    name="mb_ministry_of_education",
...
def mb_ministry_of_education(language=None):
    """Yield Manitoba Ministry of Education rows from the canonical cache."""
    import hashlib
    import json
...
@dlt.source(name="mb_ministry_of_education")
def mb_ministry_of_education_source(language=None):
    """DLT source for the Manitoba Ministry of Education ingestion."""
    return mb_ministry_of_education(language=language)
...
__all__ = [
    ...
    "PROVINCE",
    "SLUG",
    "mb_ministry_of_education",
    "mb_ministry_of_education_source",
]
