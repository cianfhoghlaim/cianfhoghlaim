"""DLT source for the Nunavut Government Portal.
...
DOMAIN = "government"
SLUG = "gov_portal"
CANONICAL_URL = "https://www.gov.nu.ca"
DEFAULT_LANGUAGE = "en"
...
def nu_gov_portal(language=None):
    """Yield Nunavut Government Portal rows from the canonical cache."""
    import hashlib
    import json
...
@dlt.source(name="nu_gov_portal")
def nu_gov_portal_source(language=None):
    """DLT source for the Nunavut Government Portal ingestion."""
    return nu_gov_portal(language=language)
