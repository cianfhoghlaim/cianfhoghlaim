"""DEPRECATION SHIM — moved to dlt_sources.official_media.british_crown.wls.

Per the **2026-08-24-wave-1-dlt-sources-domain-restructure-v1** openspec
change (§1.8, master plan §3.2, §7.1), the canonical home is now
`dlt_sources.official_media.british_crown.wls`. This shim re-exports from the
...
"""
from dlt_sources.official_media.british_crown.wls import *  # noqa: F401, F403
