...
def en_biology(language: str | None = None) -> Iterator[dict[str, Any]]:
    """Yield England biology syllabus rows from the canonical cache.
    ...
    cache_dir = Path("stedding/site_scrape_samples/biep/en/biology")
...
@dlt.source(name="en_biology")
def en_biology_source(language: str | None = None):
    """DLT source for the England biology ingestion."""
    return en_biology(language=language)
