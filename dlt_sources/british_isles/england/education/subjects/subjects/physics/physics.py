...
def en_physics(language: str | None = None) -> Iterator[dict[str, Any]]:
    """Yield England physics syllabus rows from the canonical cache.
    ...
    cache_dir = Path("stedding/site_scrape_samples/biep/en/physics")
...
@dlt.source(name="en_physics")
def en_physics_source(language: str | None = None):
    """DLT source for the England physics ingestion."""
    return en_physics(language=language)
