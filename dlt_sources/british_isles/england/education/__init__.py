...
from dlt_sources.british_isles.england.education._national_curriculum_helpers import (
    EXAM_BOARD_URLS,
    GOV_UK_CURRICULUM_URLS,
)
from dlt_sources.british_isles.england.education.all_exam_boards import all_exam_boards_source
from dlt_sources.british_isles.england.education.aqa_qualifications import aqa_qualifications_source
from dlt_sources.british_isles.england.education.edexcel_qualifications import (
    edexcel_qualifications_source,
)
from dlt_sources.british_isles.england.education.national_curriculum import national_curriculum_source
from dlt_sources.british_isles.england.education.ocr_qualifications import ocr_qualifications_source
