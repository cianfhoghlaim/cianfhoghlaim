...
>
> To selfhost your own pop-up infrastructure you require your own domain name and a free Cloudflare account. 
> Within our bonneagar (infrastructure) directory is the infrastructure-as-code to set up the rest for yourself.
>
> READMEs and other previously simple fixes to the repository are hindered by the author's traumatic brain injury and poverty.
