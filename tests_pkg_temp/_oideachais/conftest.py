...
@pytest.fixture
def duckdb_connection(temp_dir: Path) -> Generator[Any]:
...
@pytest.fixture
def lancedb_connection(temp_dir: Path) -> Generator[Any]:
...
@pytest.fixture
def dlt_pipeline(temp_dir: Path) -> Generator[Any]:
...
@pytest.fixture
def dagster_instance(temp_dir: Path) -> Generator[Any]:
...
@pytest.fixture
def dagster_context(dagster_instance: Any) -> Generator[Any]:
...
@pytest.fixture
def mock_lancedb_cloud() -> Generator[MagicMock]:
...
@pytest.fixture
def mock_kafka_producer() -> Generator[MagicMock]:
    """Mock Kafka producer."""
...
@pytest.fixture
def mock_modal_function() -> Generator[MagicMock]:
