...
from .celtic_tutor import celtic_tutor_agent
from .mythology_narrator import mythology_narrator_agent
from .quest_guide import quest_guide_agent
from .research_assistant import research_assistant_agent
