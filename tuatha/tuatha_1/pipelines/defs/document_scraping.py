...
from crypteolas.defs._partitions import protocol_partitions
...
def protocol_documentation(context: AssetExecutionContext) -> Output[dict[str, Any]]:
    ...
    from crypteolas.pipelines.scrapers.firecrawl_source import firecrawl_crawl, CRYPTO_DOC_SOURCES
    from crypteolas.pipelines.shared.duckdb_destination import create_pipeline
