...
def indexed_documents(
    ...
    from crypteolas.pipelines.indexers.cocoindex_flow import index_crypto_docs
...
def knowledge_graph(
    ...
    from crypteolas.pipelines.knowledge.cognee_pipeline import sync_cognify_docs, load_from_duckdb
