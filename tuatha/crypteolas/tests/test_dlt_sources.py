...
class TestDefiLlamaSource:
    ...
    def test_list_protocols_success(self, mock_defillama_protocols):
        ...
        with patch("httpx.Client") as mock_client:
            ...
            from tuatha.crypteolas.dlt_sources.defi.defillama import _list_protocols
    ...
    def test_list_yields_success(self, mock_defillama_yields):
        ...
        with patch("httpx.Client") as mock_client:
            ...
            from tuatha.crypteolas.dlt_sources.defi.defillama import _list_yields
    ...
    def test_protocol_tvl_history(self, mock_defillama_protocol_tvl):
        ...
        with patch("httpx.Client") as mock_client:
            ...
            from tuatha.crypteolas.dlt_sources.defi.defillama import _get_protocol_tvl_history
...
class TestGitHubSource:
    ...
    def test_get_client_with_token(self):
        ...
        with patch.dict("os.environ", {"GITHUB_TOKEN": "test_token"}):
            with patch("httpx.Client") as mock_client:
                from tuatha.crypteolas.dlt_sources.github.github_source import _get_client
    ...
    def test_paginate_single_page(self, mock_github_repos_page):
        ...
        with patch("httpx.Client") as mock_client:
            ...
            from tuatha.crypteolas.dlt_sources.github.github_source import _paginate
    ...
    def test_list_commits(self, mock_github_commits_page):
        ...
        with patch("httpx.Client") as mock_client:
            ...
            from tuatha.crypteolas.dlt_sources.github.github_source import _list_commits
...
class TestBinanceSource:
    ...
    def test_list_funding_rates(self):
        ...
        with patch("httpx.Client") as mock_client:
            ...
            from tuatha.crypteolas.dlt_sources.defi.binance import _list_funding_rates
    ...
    def test_list_open_interest(self):
        ...
        with patch("httpx.Client") as mock_client:
            ...
            from tuatha.crypteolas.dlt_sources.defi.binance import _list_open_interest
...
class TestCoinGeckoSource:
    ...
    def test_list_coins_without_api_key(self):
        ...
        with patch.dict("os.environ", {}, clear=True):
            with patch("httpx.Client") as mock_client:
                ...
                from tuatha.crypteolas.dlt_sources.defi.coingecko import _list_coins
    ...
    def test_get_price_history(self):
        ...
        with patch("httpx.Client") as mock_client:
            ...
            from tuatha.crypteolas.dlt_sources.defi.coingecko import _get_price_history
...
class TestFileWatcherSource:
    ...
    def test_compute_file_hash(self, tmp_path):
        ...
        from tuatha.crypteolas.dlt_sources.local.file_watcher import _compute_file_hash
    ...
    def test_read_file_content_utf8(self, tmp_path):
        ...
        from tuatha.crypteolas.dlt_sources.local.file_watcher import _read_file_content
    ...
    def test_detect_language(self):
        ...
        from tuatha.crypteolas.dlt_sources.local.file_watcher import _detect_language
    ...
    def test_ignore_patterns(self, tmp_path):
        ...
        from tuatha.crypteolas.dlt_sources.local.file_watcher import get_changed_files
...
class TestSubgraphSource:
    ...
    def test_aave_reserves_query(self):
        ...
        with patch("httpx.Client") as mock_client:
            ...
            from tuatha.crypteolas.dlt_sources.defi.subgraphs import aave_reserves
