...
Provides stdio and HTTP transport for code search tools.
Based on ChunkHound pattern.
"""
...
class MCPServer:
    ...
    async def run(self):
        ...
        self.running = True
        logger.info("Códeolas MCP server starting (stdio)")
        ...
        logger.info("Códeolas MCP server stopped")
...
def main():
    ...
    logging.basicConfig(
        ...
        stream=sys.stderr,  # Log to stderr to not break JSON-RPC on stdout
    )
