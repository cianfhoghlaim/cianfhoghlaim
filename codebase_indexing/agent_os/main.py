...
Usage:
    # Development
    python -m sruth.crypteolas.agent_os.main

    # Production (via uvicorn)
    uvicorn sruth.crypteolas.agent_os.main:app --host 0.0.0.0 --port 7771
"""
...
from sruth.crypteolas.agents.agno.protocol_team import (
    protocol_team,
    documentation_agent,
    code_analysis_agent,
    graph_agent,
...
if __name__ == "__main__":
    ...
    agent_os.serve(
        app="sruth.crypteolas.agent_os.main:app",
        host="0.0.0.0",
        port=7771,
        reload=True,
    )
