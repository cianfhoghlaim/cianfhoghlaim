...
def build_hnsw_index(
    ...
    *,
    ...
    Example:
        >>> from cianfhoghlaim.embeddings.indexing import build_hnsw_index
...
def build_ivf_pq_index(
    ...
    *,
    ...
    Example:
        >>> from cianfhoghlaim.embeddings.indexing import build_ivf_pq_index
        >>> table = db.open_table("leabharlann_books")
...
def build_scalar_index(
    ...
    *,
    ...
    Example:
        >>> from cianfhoghlaim.embeddings.indexing import build_scalar_index
        >>> table = db.open_table("leabharlann_books")
...
def optimize_index(table: Any) -> None:
    ...
    Example:
        >>> from cianfhoghlaim.embeddings.indexing import (
