/**
 * Per-vernacular Convex table for Breton (Brezhoneg).
 *
 ...
 * ``../schema`` for Breton (br).
 *
 * Breton uses the ExtractBretonSubjectSpec BAML function.
 * Jurisdiction: BR (Brittany — sister-repo lift target).
 */
