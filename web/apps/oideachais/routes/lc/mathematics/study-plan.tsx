// /en/subjects/mathematics/study-plan — Mathematics per-subject study plan generator.
//
// Per the 2026-09-01-cianfhoghlaim-nua-end-to-end-showcase-v1 change
// (Phase 1, §3.4 + §4.2.3 of tasks.md). Renders the canonical Phase 1
// `<StudyPlanCard>` A2UI surface backed by the Hono
// `/api/copilotkit/lc/mathematics/get_study_plan` endpoint.
...
export const Route = createFileRoute("/lc/mathematics/study-plan")({
