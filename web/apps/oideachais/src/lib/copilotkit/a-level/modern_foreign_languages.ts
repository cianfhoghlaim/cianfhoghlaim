...
export function useModernForeignLanguagesActions() {
  useCopilotAction({
    ...
    handler: {"stub":true,"action":"get_syllabus_topics"}
  });
  ...
  useCopilotAction({
    ...
    handler: {"stub":true,"action":"get_exam_papers"}
  });
  ...
  useCopilotAction({
    ...
    handler: {"stub":true,"action":"get_marking_schemes"}
  });
  ...
  useCopilotAction({
    ...
    handler: {"stub":true,"action":"get_topic_detail"}
  });
  ...
  useCopilotAction({
    ...
    handler: {"stub":true,"action":"get_cross_jurisdictional_equivalences"}
  });
  ...
  useCopilotAction({
    ...
    handler: {"stub":true,"action":"semantic_search"}
  });
  ...
  useCopilotAction({
    ...
    handler: {"stub":true,"action":"extract_syllabus_from_pdf"}
  });
  ...
  useCopilotAction({
    ...
    handler: {"stub":true,"action":"save_annotation"}
  });
  ...
  useCopilotAction({
    ...
    handler: {"stub":true,"action":"track_progress"}
  });
  ...
  useCopilotAction({
    ...
    handler: {"stub":true,"action":"get_study_plan"}
  });
  ...
  useCopilotAction({
    ...
    handler: {"stub":true,"action":"compare_curricula"}
  });
  ...
  useCopilotAction({
    ...
    handler: {"stub":true,"action":"get_glossary_term"}
  });
  ...
  useCopilotAction({
    ...
    handler: {"stub":true,"action":"extract_learning_outcome"}
  });
}
