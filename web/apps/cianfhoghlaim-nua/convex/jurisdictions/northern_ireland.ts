/**
 * Northern Ireland jurisdiction subject-spec table.
 *
 * Per the 2026-09-XX-orchestration-integration-v1 change (Phase 11 §3).
 * The NISubjectSpec row from `b.ExtractNorthernIrelandSubjectSpec` is
...
export const northern_ireland_subject_specs = defineTable({
  jurisdiction: v.literal("northern_ireland"),
...
export const create = mutation({
  ...
  handler: async (ctx, args) => {
    const id = await ctx.db.insert("northern_ireland_subject_specs", {
