/**
 * Isle of Man jurisdiction subject-spec table.
 *
 * Per the 2026-09-XX-orchestration-integration-v1 change (Phase 11 §3).
 * The IMSubjectSpec row from `b.ExtractIsleOfManSubjectSpec` is
...
export const isle_of_man_subject_specs = defineTable({
  jurisdiction: v.literal("isle_of_man"),
...
export const create = mutation({
  ...
  handler: async (ctx, args) => {
    const id = await ctx.db.insert("isle_of_man_subject_specs", {
