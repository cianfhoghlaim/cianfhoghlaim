  ...
  return (
    <div className="max-w-5xl mx-auto flex flex-col gap-4">
      ...
      <p className="text-slate-400">
        Reads from `cianfhoghlaim.{stage}` Cognee dataset + `{stage}_knowledge_graph` LanceDB.
        See `cianfhoghlaim/notebooks/dashboards/{stage}.py` for the marimo source.
      </p>
      <div className="bg-slate-800 border border-slate-700 rounded-lg p-4 text-center text-slate-500">
        ...
        The notebook is ready at cianfhoghlaim/notebooks/dashboards/{stage}.py.
      </div>
    </div>
  );
}
