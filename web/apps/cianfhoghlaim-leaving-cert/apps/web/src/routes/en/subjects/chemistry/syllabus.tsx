// /en/subjects/chemistry/syllabus — Chemistry per-subject NCCA syllabus + learning outcomes viewer.
//
...
export const Route = createFileRoute("/en/subjects/chemistry/syllabus")({
  component: ChemistrySyllabusPage,
});

function ChemistrySyllabusPage() {
  return (
    <div className="max-w-4xl mx-auto flex flex-col gap-6 p-6">
      <h1 className="text-2xl font-bold text-slate-900">Chemistry — Syllabus</h1>
      <p className="text-slate-600">
        The NCCA Chemistry syllabus + learning outcomes viewer.
        Source: the per-subject BAML extraction
        (<code>qpack_chemistry.baml</code>) over the
