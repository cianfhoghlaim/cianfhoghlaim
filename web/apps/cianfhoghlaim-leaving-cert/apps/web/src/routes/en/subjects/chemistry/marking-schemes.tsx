// /en/subjects/chemistry/marking-schemes — Chemistry per-subject marking scheme (PCLM) viewer + WebMarkingSchemeExplanation.
//
...
export const Route = createFileRoute("/en/subjects/chemistry/marking-schemes")({
  component: ChemistryMarkingschemesPage,
});

function ChemistryMarkingschemesPage() {
  return (
    <div className="max-w-4xl mx-auto flex flex-col gap-6 p-6">
      <h1 className="text-2xl font-bold text-slate-900">Chemistry — Marking schemes</h1>
      <p className="text-slate-600">
        Chemistry marking scheme (PCLM — Partial Credit, Logical
