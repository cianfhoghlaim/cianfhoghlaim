// /en/subjects/english/syllabus — English per-subject NCCA syllabus + learning outcomes viewer.
//
...
export const Route = createFileRoute("/en/subjects/english/syllabus")({
  component: EnglishSyllabusPage,
});

function EnglishSyllabusPage() {
  return (
    <div className="max-w-4xl mx-auto flex flex-col gap-6 p-6">
      <h1 className="text-2xl font-bold text-slate-900">English — Syllabus</h1>
      <p className="text-slate-600">
        The NCCA English syllabus + learning outcomes viewer.
        Source: the per-subject BAML extraction
        (<code>qpack_english.baml</code>) over the
