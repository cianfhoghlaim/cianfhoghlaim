// /en/subjects/mathematics/marking-schemes — Mathematics per-subject marking scheme (PCLM) viewer + WebMarkingSchemeExplanation.
//
...
export const Route = createFileRoute("/en/subjects/mathematics/marking-schemes")({
  component: MathematicsMarkingschemesPage,
});

function MathematicsMarkingschemesPage() {
  return (
    <div className="max-w-4xl mx-auto flex flex-col gap-6 p-6">
      <h1 className="text-2xl font-bold text-slate-900">Mathematics — Marking schemes</h1>
      <p className="text-slate-600">
        Mathematics marking scheme (PCLM — Partial Credit, Logical
