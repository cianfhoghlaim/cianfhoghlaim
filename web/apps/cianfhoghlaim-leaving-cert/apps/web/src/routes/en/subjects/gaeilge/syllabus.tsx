// /en/subjects/gaeilge/syllabus — Gaeilge per-subject NCCA syllabus + learning outcomes viewer.
//
...
export const Route = createFileRoute("/en/subjects/gaeilge/syllabus")({
  component: GaeilgeSyllabusPage,
});

function GaeilgeSyllabusPage() {
  return (
    <div className="max-w-4xl mx-auto flex flex-col gap-6 p-6">
      <h1 className="text-2xl font-bold text-slate-900">Gaeilge — Syllabus</h1>
      <p className="text-slate-600">
        The NCCA Gaeilge syllabus + learning outcomes viewer.
        Source: the per-subject BAML extraction
        (<code>qpack_gaeilge.baml</code>) over the
