// /en/subjects/computer_science/marking-schemes — Computer Science per-subject marking scheme (PCLM) viewer + WebMarkingSchemeExplanation.
//
...
export const Route = createFileRoute("/en/subjects/computer_science/marking-schemes")({
  component: ComputerScienceMarkingschemesPage,
});

function ComputerScienceMarkingschemesPage() {
  return (
    <div className="max-w-4xl mx-auto flex flex-col gap-6 p-6">
      <h1 className="text-2xl font-bold text-slate-900">Computer Science — Marking schemes</h1>
      <p className="text-slate-600">
        Computer Science marking scheme (PCLM — Partial Credit, Logical
