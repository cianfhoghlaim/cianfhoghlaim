// /en/subjects/english/marking-schemes — English per-subject marking scheme (PCLM) viewer + WebMarkingSchemeExplanation.
//
...
export const Route = createFileRoute("/en/subjects/english/marking-schemes")({
  component: EnglishMarkingschemesPage,
});

function EnglishMarkingschemesPage() {
  return (
    <div className="max-w-4xl mx-auto flex flex-col gap-6 p-6">
      <h1 className="text-2xl font-bold text-slate-900">English — Marking schemes</h1>
      <p className="text-slate-600">
        English marking scheme (PCLM — Partial Credit, Logical
