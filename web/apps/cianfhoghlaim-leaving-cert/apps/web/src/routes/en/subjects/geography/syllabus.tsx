// /en/subjects/geography/syllabus — Geography per-subject NCCA syllabus + learning outcomes viewer.
//
...
export const Route = createFileRoute("/en/subjects/geography/syllabus")({
  component: GeographySyllabusPage,
});

function GeographySyllabusPage() {
  return (
    <div className="max-w-4xl mx-auto flex flex-col gap-6 p-6">
      <h1 className="text-2xl font-bold text-slate-900">Geography — Syllabus</h1>
      <p className="text-slate-600">
        The NCCA Geography syllabus + learning outcomes viewer.
        Source: the per-subject BAML extraction
        (<code>qpack_geography.baml</code>) over the
