// /en/subjects/computer_science/exam-papers — Computer Science per-subject past exam paper viewer + discussExamPaper BAML action.
//
...
export const Route = createFileRoute("/en/subjects/computer_science/exam-papers")({
  component: ComputerScienceExampapersPage,
});

function ComputerScienceExampapersPage() {
  return (
    <div className="max-w-4xl mx-auto flex flex-col gap-6 p-6">
      <h1 className="text-2xl font-bold text-slate-900">Computer Science — Past exam papers</h1>
      <p className="text-slate-600">
        All Computer Science past exam papers tagged by topic + paper + year.
