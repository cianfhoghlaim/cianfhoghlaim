...
export const recordAttempt = mutation({
  ...
  handler: async (ctx, args) => {
    return await ctx.db.insert("practice_attempts", {
      ...
      essay: args.essay,
      score: args.score,
      rubric_fingerprint: args.rubricFingerprint,
...
export const issueBadge = mutation({
  ...
  handler: async (ctx, args) => {
    return await ctx.db.insert("badge_ledger", {
      ...
      level: args.level,
      subject: args.subject,
      competency_code: args.competencyCode,
      competency_text_en: args.competencyTextEn,
      competency_text_ga: args.competencyTextGa,
      eiraic_tier: args.eiraicTier,
      agent_issuer: args.agentIssuer,
      evidence_hash: args.evidenceHash,
      signature: args.signature,
      on_chain_anchor: args.onChainAnchor,
