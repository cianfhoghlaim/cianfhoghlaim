...
> implementation for the rest of `cianfhoghlaim`.*

> **v4 consolidation note (2026-06-28):** `sruth/croilar/` was
> merged into `cianfhoghlaim/` per
> `openspec/changes/2026-06-28-consolidate-sruth-into-cianfhoghlaim-v4/`.
> The persona site now lives at `cianfhoghlaim/web/apps/croilar-web/`,
> the portal at `cianfhoghlaim/web/apps/croilar-portal/`, and the
> Convex backend at `cianfhoghlaim/web/apps/croilar-web/convex/`.
> The 12 croilar DLT streams were registered as Dagster assets
> in the single code-location `cianfhoghlaim/assets/definitions.py`.
