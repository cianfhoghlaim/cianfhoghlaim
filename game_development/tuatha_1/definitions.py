...
from fibo.defs.curriculum import sources, processing
from fibo.defs.curriculum.resources import (
    DLTResource,
    LanceDBResource,
    CocoIndexResource,
    ColPaliResource,
...
from fibo.defs.fibo_generation import assets as fibo_assets
from fibo.defs.fibo_generation.resources import FiboResource, ValidationResource
