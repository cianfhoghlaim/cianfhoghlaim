...
def ireland_oide_cpd(
    ...
    from dlt_sources.ireland.oide import oide_source
...
def england_national_curriculum(
    ...
    from dlt_sources.uk.england.national_curriculum import national_curriculum_source
...
def england_exam_boards(
    ...
    from dlt_sources.uk.england.national_curriculum import all_exam_boards_source
...
def scotland_cfe(
    ...
    from dlt_sources.uk.scotland.curriculum_for_excellence import curriculum_for_excellence_source
...
def scotland_sqa(
    ...
    from dlt_sources.uk.scotland.curriculum_for_excellence import sqa_qualifications_source
...
def wales_curriculum(
    ...
    from dlt_sources.uk.wales.curriculum_for_wales import curriculum_for_wales_source
...
def wales_wjec(
    ...
    from dlt_sources.uk.wales.curriculum_for_wales import wjec_qualifications_source
...
def northern_ireland_curriculum(
    ...
    from dlt_sources.uk.northern_ireland.ccea_curriculum import ni_curriculum_source
...
def northern_ireland_ccea_quals(
    ...
    from dlt_sources.uk.northern_ireland.ccea_curriculum import ccea_qualifications_source
