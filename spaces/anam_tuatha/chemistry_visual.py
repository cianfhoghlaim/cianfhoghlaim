...
MOLECULES: dict[str, Molecule] = {
    ...
    "co2": Molecule(
        "Carbon Dioxide", "Dé-ocsaíd Charbóin", "CO2",
        atoms=(
            Atom("C", 50, 35),
            Atom("O", 25, 35),
            Atom("O", 75, 35),
    ...
    "benzene": Molecule(
        ...
        bonds=(
            Bond(0, 1, 2), Bond(1, 2, 1),
            Bond(2, 3, 2), Bond(3, 4, 1),
            Bond(4, 5, 2), Bond(5, 0, 1),
        ),
        description=(
    ...
    "sodium_chloride": Molecule(
        "Sodium Chloride", "Clóiríd Sóidiam", "NaCl",
        atoms=(
