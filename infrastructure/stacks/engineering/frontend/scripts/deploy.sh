...
#   ./infrastructure/stacks/engineering/frontend/scripts/deploy.sh down
#   ./infrastructure/stacks/engineering/frontend/scripts/deploy.sh logs
#   ./infrastructure/stacks/engineering/frontend/scripts/deploy.sh status
# ----------------------------------------------------------------------------
set -euo pipefail
...
POSTGRES="$ROOT/infrastructure/stacks/storage/croilar-postgres/compose.yaml"
CONVEX="$ROOT/infrastructure/stacks/engineering/convex/compose.yaml"
LITELLM="$ROOT/infrastructure/stacks/engineering/litellm/compose.yaml"
HONO_API="$ROOT/infrastructure/stacks/engineering/croilar-hono-api/compose.yaml"
FRONTEND="$ROOT/infrastructure/stacks/engineering/frontend/compose.yaml"
FRONTEND_DEV="$ROOT/infrastructure/stacks/engineering/frontend/compose.dev.yaml"
