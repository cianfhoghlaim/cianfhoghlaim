...
#
# Usage:
#   ./infrastructure/stacks/frontend/scripts/dev-start.sh start
#   ./infrastructure/stacks/frontend/scripts/dev-start.sh stop
#   ./infrastructure/stacks/frontend/scripts/dev-start.sh status
#   ./infrastructure/stacks/frontend/scripts/dev-start.sh logs
# ----------------------------------------------------------------------------
set -euo pipefail
