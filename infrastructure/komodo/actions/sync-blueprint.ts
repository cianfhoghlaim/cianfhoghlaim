...
const stackLocations: Record<string, { category: string; path: string; server: string }> = {
  // Storage stacks (on cax41-hetzner)
  "qdrant": { category: "storage", path: "/etc/komodo/storage/qdrant/blueprint.yaml", server: "cax41-hetzner" },
  "memgraph": { category: "storage", path: "/etc/komodo/storage/memgraph/blueprint.yaml", server: "cax41-hetzner" },
  "falkordb": { category: "storage", path: "/etc/komodo/storage/falkordb/blueprint.yaml", server: "cax41-hetzner" },
  "graphiti": { category: "storage", path: "/etc/komodo/storage/graphiti/blueprint.yaml", server: "cax41-hetzner" },
  "lancedb": { category: "storage", path: "/etc/komodo/storage/lancedb/blueprint.yaml", server: "cax41-hetzner" },
  "cognee": { category: "storage", path: "/etc/komodo/storage/cognee/blueprint.yaml", server: "cax41-hetzner" },
  "mlflow": { category: "storage", path: "/etc/komodo/storage/mlflow/blueprint.yaml", server: "cax41-hetzner" },
  "langfuse": { category: "storage", path: "/etc/komodo/storage/langfuse/blueprint.yaml", server: "cax41-hetzner" },
  "nimtable": { category: "storage", path: "/etc/komodo/storage/nimtable/blueprint.yaml", server: "cax41-hetzner" },
  "mathesar": { category: "storage", path: "/etc/komodo/storage/mathesar/blueprint.yaml", server: "cax41-hetzner" },
  "beszel": { category: "storage", path: "/etc/komodo/storage/beszel/blueprint.yaml", server: "cax41-hetzner" },
  "dozzle": { category: "storage", path: "/etc/komodo/storage/dozzle/blueprint.yaml", server: "cax41-hetzner" },
  "garage": { category: "storage", path: "/etc/komodo/storage/garage/blueprint.yaml", server: "cax41-hetzner" },
  "lakefs": { category: "storage", path: "/etc/komodo/storage/lakefs/blueprint.yaml", server: "cax41-hetzner" },
  "lakekeeper": { category: "storage", path: "/etc/komodo/storage/lakekeeper/blueprint.yaml", server: "cax41-hetzner" },
  "lakehouse": { category: "storage", path: "/etc/komodo/storage/lakehouse/blueprint.yaml", server: "cax41-hetzner" },
  "olake-ui": { category: "storage", path: "/etc/komodo/storage/olake-ui/blueprint.yaml", server: "cax41-hetzner" },
  "convex": { category: "storage", path: "/etc/komodo/storage/convex/blueprint.yaml", server: "cax41-hetzner" },
  "autobase": { category: "storage", path: "/etc/komodo/storage/autobase/blueprint.yaml", server: "cax41-hetzner" },
  "confluent": { category: "storage", path: "/etc/komodo/storage/confluent/blueprint.yaml", server: "cax41-hetzner" },
  "forgejo": { category: "storage", path: "/etc/komodo/storage/forgejo/blueprint.yaml", server: "cax41-hetzner" },
};
