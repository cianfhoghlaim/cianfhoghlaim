...
def _():
    ...
    mo.md(
        ...
        **Further Mathematics**:
        ...
        | Display name | Further Mathematics |
        | NCCA code | `` |
        | Language | English |
        | Level | AS / A2 |
...
def _(duckdb, ibis, pd):
    ...
    # (consumed from leaving_certificate/a_level/further_mathematics/)
    pdf_root = f"leaving_certificate/a_level/further_mathematics"
...
async def _():
    ...
    try:
        ...
        baml_result = {"stub": True, "subject": "further_mathematics", "stage": "a_level"}
    return baml_result,
...
def _():
    ...
    # (consumed from england_a_level_aqa_further_mathematics_a_level_en_embedding)
...
def _(alt, mo, pd):
    ...
    chart = (
        ...
        .properties(title="BIEP per-subject pipeline status (further_mathematics)", width=400, height=200)
    )
