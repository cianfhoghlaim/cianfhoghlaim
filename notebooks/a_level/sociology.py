...
def _(duckdb, ibis, pd):
    ...
    # (consumed from leaving_certificate/a_level/sociology/)
    pdf_root = f"leaving_certificate/a_level/sociology"
...
async def _():
    ...
    try:
        ...
        baml_result = {"stub": True, "subject": "sociology", "stage": "a_level"}
    return baml_result,
...
def _():
    ...
    # (consumed from england_a_level_aqa_sociology_a_level_en_embedding)
...
def _(alt, mo, pd):
    ...
    chart = (
        ...
        .properties(title="BIEP per-subject pipeline status (sociology)", width=400, height=200)
    )
