...
def _(duckdb, ibis, pd):
    ...
    # (consumed from leaving_certificate/a_level/politics/)
    pdf_root = f"leaving_certificate/a_level/politics"
...
async def _():
    ...
    try:
        ...
        baml_result = {"stub": True, "subject": "politics", "stage": "a_level"}
    return baml_result,
...
def _():
    ...
    # (consumed from england_a_level_aqa_politics_a_level_en_embedding)
...
def _(alt, mo, pd):
    ...
    chart = (
        ...
        .properties(title="BIEP per-subject pipeline status (politics)", width=400, height=200)
    )
