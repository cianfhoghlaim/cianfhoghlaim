...
def _(duckdb, ibis, pd):
    ...
    # (consumed from leaving_certificate/a_level/mathematics/)
    pdf_root = f"leaving_certificate/a_level/mathematics"
...
async def _():
    ...
    try:
        ...
        baml_result = {"stub": True, "subject": "mathematics", "stage": "a_level"}
    return baml_result,
...
def _():
    ...
    # (consumed from england_a_level_aqa_mathematics_a_level_en_embedding)
