...
def _(duckdb, ibis, pd):
    ...
    # (consumed from leaving_certificate/a_level/geography/)
    pdf_root = f"leaving_certificate/a_level/geography"
...
async def _():
    ...
    try:
        ...
        baml_result = {"stub": True, "subject": "geography", "stage": "a_level"}
    return baml_result,
...
def _():
    ...
    # (consumed from england_a_level_aqa_geography_a_level_en_embedding)
