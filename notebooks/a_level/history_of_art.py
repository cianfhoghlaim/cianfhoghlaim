...
def _():
    ...
    mo.md(
        ...
        **History of Art**:
        ...
        |:--|:--|
        | Stage | `a_level` |
        | Subject | `history_of_art` |
        | Display name | History of Art |
        | NCCA code | `` |
        | Language | English |
        | Level | AS / A2 |
...
def _(duckdb, ibis, pd):
    ...
    # (consumed from leaving_certificate/a_level/history_of_art/)
    pdf_root = f"leaving_certificate/a_level/history_of_art"
...
async def _():
    ...
    try:
        ...
        baml_result = {"stub": True, "subject": "history_of_art", "stage": "a_level"}
    return baml_result,
...
def _():
    ...
    # (consumed from england_a_level_aqa_history_of_art_a_level_en_embedding)
...
def _(alt, mo, pd):
    ...
    chart = (
        ...
        .properties(title="BIEP per-subject pipeline status (history_of_art)", width=400, height=200)
    )
