...
def _(duckdb, ibis, pd):
    ...
    # (consumed from leaving_certificate/a_level/chemistry/)
    pdf_root = f"leaving_certificate/a_level/chemistry"
...
async def _():
    ...
    try:
        ...
        baml_result = {"stub": True, "subject": "chemistry", "stage": "a_level"}
    return baml_result,
...
def _():
    ...
    # (consumed from england_a_level_aqa_chemistry_a_level_en_embedding)
