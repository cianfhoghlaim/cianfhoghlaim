...
def _(duckdb, ibis, pd):
    ...
    # (consumed from leaving_certificate/a_level/biology/)
    pdf_root = f"leaving_certificate/a_level/biology"
...
async def _():
    ...
    try:
        ...
        baml_result = {"stub": True, "subject": "biology", "stage": "a_level"}
    return baml_result,
...
def _():
    ...
    # (consumed from england_a_level_aqa_biology_a_level_en_embedding)
