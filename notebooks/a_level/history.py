...
def _(duckdb, ibis, pd):
    ...
    # (consumed from leaving_certificate/a_level/history/)
    pdf_root = f"leaving_certificate/a_level/history"
...
async def _():
    ...
    try:
        ...
        baml_result = {"stub": True, "subject": "history", "stage": "a_level"}
    return baml_result,
...
def _():
    ...
    # (consumed from england_a_level_aqa_history_a_level_en_embedding)
