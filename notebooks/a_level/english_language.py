...
def _(duckdb, ibis, pd):
    ...
    # (consumed from leaving_certificate/a_level/english_language/)
    pdf_root = f"leaving_certificate/a_level/english_language"
...
async def _():
    ...
    try:
        ...
        baml_result = {"stub": True, "subject": "english_language", "stage": "a_level"}
    return baml_result,
...
def _():
    ...
    # (consumed from england_a_level_aqa_english_language_a_level_en_embedding)
...
def _(alt, mo, pd):
    ...
    chart = (
        ...
        .properties(title="BIEP per-subject pipeline status (english_language)", width=400, height=200)
    )
