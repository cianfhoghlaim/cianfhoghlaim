...
def _(duckdb, ibis, pd):
    ...
    # (consumed from leaving_certificate/a_level/business/)
    pdf_root = f"leaving_certificate/a_level/business"
...
async def _():
    ...
    try:
        ...
        baml_result = {"stub": True, "subject": "business", "stage": "a_level"}
    return baml_result,
...
def _():
    ...
    # (consumed from england_a_level_aqa_business_a_level_en_embedding)
