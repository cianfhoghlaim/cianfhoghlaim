"""marimo notebook: ADK 2 — 02 collaborative teacher root.
...
Run with:
    uv run marimo edit notebooks/_shared/education/walkthroughs/adk2_02_collaborative_teacher_root.py
"""
...
def _intro():
    ...
    mo.md(
        """
        # ADK 2 · 02 collaborative teacher root
