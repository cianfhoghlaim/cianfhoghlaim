"""marimo notebook: ADK 2 — 03 dynamic aistear research.
...
Run with:
    uv run marimo edit notebooks/_shared/education/walkthroughs/adk2_03_dynamic_aistear_research.py
"""
...
def _intro():
    ...
    mo.md(
        """
        # ADK 2 · 03 dynamic aistear research
