"""marimo notebook: ADK 2 — 08 capstone decision tree.
...
Run with:
    uv run marimo edit notebooks/_shared/education/walkthroughs/adk2_08_capstone_decision_tree.py
"""
...
def _intro():
    ...
    mo.md(
        """
        # ADK 2 · 08 capstone decision tree
