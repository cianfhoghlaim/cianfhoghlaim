"""marimo notebook: 04_asset_generation: L4 Asset Generation — 10 CocoIndex flows + per-module factory — UoG tertiary pipeline walkthrough.
...
L4 Asset Generation — 10 CocoIndex flows + per-module factory

Reference surfaces:
orchestration/defs/4_asset_generation/tertiary_uog/ + 
cocoindex_flows/.../tertiary/uog/

Run with:
    uv run marimo edit notebooks/_shared/tertiary/walkthroughs/04_asset_generation.py
    uv run python notebooks/_shared/tertiary/walkthroughs/04_asset_generation.py --cli
"""
...
def _intro() -> None:
    ...
    mo.md(
        ...
        This notebook walks through **L4 Asset Generation — 10 CocoIndex flows + per-module factory** — what it is, how it works, where the docs live, and how to query the live DuckLake data.
...
def _phase_status() -> None:
    ...
    mo.md(
        ...
        Walkthrough `04_asset_generation: L4 Asset Generation — 10 CocoIndex flows + per-module factory` — fetched at {datetime.utcnow().isoformat()}.
        """
    )
    return
