"""marimo notebook: 07_translation: 3-entry translation family (opus-mt + m2m100 + nllb) — UoG tertiary pipeline walkthrough.
...
3-entry translation family (opus-mt + m2m100 + nllb)

Reference surfaces:
meaisinfhoghlaim/models/model_registry.py

Run with:
    uv run marimo edit notebooks/_shared/tertiary/walkthroughs/07_translation.py
    uv run python notebooks/_shared/tertiary/walkthroughs/07_translation.py --cli
"""
...
def _intro() -> None:
    ...
    mo.md(
        ...
        This notebook walks through **3-entry translation family (opus-mt + m2m100 + nllb)** — what it is, how it works, where the docs live, and how to query the live DuckLake data.
...
def _phase_status() -> None:
    ...
    mo.md(
        ...
        Walkthrough `07_translation: 3-entry translation family (opus-mt + m2m100 + nllb)` — fetched at {datetime.utcnow().isoformat()}.
        """
    )
    return
