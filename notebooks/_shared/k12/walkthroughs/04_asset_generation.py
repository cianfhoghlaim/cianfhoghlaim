"""marimo notebook: 04_asset_generation: L4 Asset Generation — 8 K-12 CocoIndex flows + factory — K-12 teacher + student pipeline walkthrough.
...
L4 Asset Generation — 8 K-12 CocoIndex flows + factory

Reference surfaces:
orchestration/defs/4_asset_generation/primary_jc/ + 
cocoindex_flows/british_isles/ireland/education/_shared.py

Run with:
    uv run marimo edit notebooks/_shared/k12/walkthroughs/04_asset_generation.py
    uv run python notebooks/_shared/k12/walkthroughs/04_asset_generation.py --cli
"""
...
def _intro() -> None:
    ...
    mo.md(
        ...
        This notebook walks through **L4 Asset Generation — 8 K-12 CocoIndex flows + factory** — what it is, how it works, where the docs live, and how to query the live DuckLake data.
...
def _phase_status() -> None:
    ...
    mo.md(
        ...
        Walkthrough `04_asset_generation: L4 Asset Generation — 8 K-12 CocoIndex flows + factory` — fetched at {datetime.utcnow().isoformat()}.
        """
    )
    return
