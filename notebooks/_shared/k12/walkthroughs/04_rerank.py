"""marimo notebook: 04_rerank: 3-entry rerank family (Jina + Cohere + Aliyun) — K-12 teacher + student pipeline walkthrough.
...
Run with:
    uv run marimo edit notebooks/_shared/k12/walkthroughs/04_rerank.py
    uv run python notebooks/_shared/k12/walkthroughs/04_rerank.py --cli
"""
