"""marimo notebook: 07_translation: 3-entry translation family (opus-mt + m2m100 + nllb) for EN ↔ GA SEN letters — K-12 teacher + student pipeline walkthrough.
...
3-entry translation family (opus-mt + m2m100 + nllb) for EN ↔ GA SEN letters

Reference surfaces:
meaisinfhoghlaim/models/model_registry.py

Run with:
    uv run marimo edit notebooks/_shared/k12/walkthroughs/07_translation.py
    uv run python notebooks/_shared/k12/walkthroughs/07_translation.py --cli
"""
...
def _intro() -> None:
    ...
    mo.md(
        ...
        This notebook walks through **3-entry translation family (opus-mt + m2m100 + nllb) for EN ↔ GA SEN letters** — what it is, how it works, where the docs live, and how to query the live DuckLake data.
...
def _phase_status() -> None:
    ...
    mo.md(
        ...
        Walkthrough `07_translation: 3-entry translation family (opus-mt + m2m100 + nllb) for EN ↔ GA SEN letters` — fetched at {datetime.utcnow().isoformat()}.
        """
    )
    return
