...
def _(duckdb, ibis, pd):
    ...
    # (consumed from leaving_certificate/gcse/mathematics/)
    pdf_root = f"leaving_certificate/gcse/mathematics"
...
async def _():
    ...
    try:
        ...
        baml_result = {"stub": True, "subject": "mathematics", "stage": "gcse"}
    return baml_result,
...
def _():
    ...
    # (consumed from england_gcse_aqa_mathematics_en_embedding)
