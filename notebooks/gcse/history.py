...
def _(duckdb, ibis, pd):
    ...
    # (consumed from leaving_certificate/gcse/history/)
    pdf_root = f"leaving_certificate/gcse/history"
...
async def _():
    ...
    try:
        ...
        baml_result = {"stub": True, "subject": "history", "stage": "gcse"}
    return baml_result,
...
def _():
    ...
    # (consumed from england_gcse_aqa_history_en_embedding)
