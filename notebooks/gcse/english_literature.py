...
def _(duckdb, ibis, pd):
    ...
    # (consumed from leaving_certificate/gcse/english_literature/)
    pdf_root = f"leaving_certificate/gcse/english_literature"
...
async def _():
    ...
    try:
        ...
        baml_result = {"stub": True, "subject": "english_literature", "stage": "gcse"}
    return baml_result,
...
def _():
    ...
    # (consumed from england_gcse_aqa_english_literature_en_embedding)
