...
def _(duckdb, ibis, pd):
    ...
    # (consumed from leaving_certificate/gcse/chemistry/)
    pdf_root = f"leaving_certificate/gcse/chemistry"
...
async def _():
    ...
    try:
        ...
        baml_result = {"stub": True, "subject": "chemistry", "stage": "gcse"}
    return baml_result,
...
def _():
    ...
    # (consumed from england_gcse_aqa_chemistry_en_embedding)
