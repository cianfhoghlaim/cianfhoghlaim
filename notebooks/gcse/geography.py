...
def _(duckdb, ibis, pd):
    ...
    # (consumed from leaving_certificate/gcse/geography/)
    pdf_root = f"leaving_certificate/gcse/geography"
...
async def _():
    ...
    try:
        ...
        baml_result = {"stub": True, "subject": "geography", "stage": "gcse"}
    return baml_result,
...
def _():
    ...
    # (consumed from england_gcse_aqa_geography_en_embedding)
