...
def _(duckdb, ibis, pd):
    ...
    # (consumed from leaving_certificate/gcse/computer_science/)
    pdf_root = f"leaving_certificate/gcse/computer_science"
...
async def _():
    ...
    try:
        ...
        baml_result = {"stub": True, "subject": "computer_science", "stage": "gcse"}
    return baml_result,
...
def _():
    ...
    # (consumed from england_gcse_aqa_computer_science_en_embedding)
