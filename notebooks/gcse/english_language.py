...
def _(duckdb, ibis, pd):
    ...
    # (consumed from leaving_certificate/gcse/english_language/)
    pdf_root = f"leaving_certificate/gcse/english_language"
...
async def _():
    ...
    try:
        ...
        baml_result = {"stub": True, "subject": "english_language", "stage": "gcse"}
    return baml_result,
...
def _():
    ...
    # (consumed from england_gcse_aqa_english_language_en_embedding)
