...
def _():
    ...
    mo.md(
        r"""
        # Mathematics (Leaving Certificate (LC))

        > **LC-MATH-LO** — the canonical BIEP per-subject analysis.
...
async def _():
    ...
    try:
        ...
        baml_result = {"stub": True, "subject": "mathematics", "stage": "lc"}
    return baml_result,
...
def _():
    ...
    # (consumed from ireland_lc_mathematics_untiered_en_embedding)
