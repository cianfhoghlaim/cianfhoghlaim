...
def _():
    ...
    mo.md(
        r"""
        # Mathematics (Junior Cycle (JC))

        > **JC-MATH-LO** — the canonical BIEP per-subject analysis.
...
def _(duckdb, ibis, pd):
    ...
    # (consumed from leaving_certificate/jc/mathematics/)
    pdf_root = f"leaving_certificate/jc/mathematics"
...
async def _():
    ...
    try:
        ...
        baml_result = {"stub": True, "subject": "mathematics", "stage": "jc"}
    return baml_result,
...
def _():
    ...
    # (consumed from ireland_jc_mathematics_en_embedding)
...
def _(alt, mo, pd):
    ...
    chart = (
        ...
        .properties(title="BIEP per-subject pipeline status (mathematics)", width=400, height=200)
    )
