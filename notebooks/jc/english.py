...
def _():
    ...
    mo.md(
        r"""
        # English (Junior Cycle (JC))

        > **JC-ENGL-LO** — the canonical BIEP per-subject analysis.
...
def _(duckdb, ibis, pd):
    ...
    # (consumed from leaving_certificate/jc/english/)
    pdf_root = f"leaving_certificate/jc/english"
...
async def _():
    ...
    try:
        ...
        baml_result = {"stub": True, "subject": "english", "stage": "jc"}
    return baml_result,
...
def _():
    ...
    # (consumed from ireland_jc_english_en_embedding)
