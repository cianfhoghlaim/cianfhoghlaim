...
def _():
    ...
    mo.md(
        r"""
        # Science (Junior Cycle (JC))

        > **JC-SCI-LO** — the canonical BIEP per-subject analysis.
...
def _(duckdb, ibis, pd):
    ...
    # (consumed from leaving_certificate/jc/science/)
    pdf_root = f"leaving_certificate/jc/science"
...
async def _():
    ...
    try:
        ...
        baml_result = {"stub": True, "subject": "science", "stage": "jc"}
    return baml_result,
...
def _():
    ...
    # (consumed from ireland_jc_science_en_embedding)
...
def _(alt, mo, pd):
    ...
    chart = (
        ...
        .properties(title="BIEP per-subject pipeline status (science)", width=400, height=200)
    )
