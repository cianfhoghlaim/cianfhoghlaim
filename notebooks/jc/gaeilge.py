...
def _():
    ...
    mo.md(
        r"""
        # Gaeilge (Junior Cycle (JC))

        > **JC-GAEL-LO** — the canonical BIEP per-subject analysis.
...
def _(duckdb, ibis, pd):
    ...
    # (consumed from leaving_certificate/jc/gaeilge/)
    pdf_root = f"leaving_certificate/jc/gaeilge"
...
async def _():
    ...
    try:
        ...
        baml_result = {"stub": True, "subject": "gaeilge", "stage": "jc"}
    return baml_result,
...
def _():
    ...
    # (consumed from ireland_jc_gaeilge_en_embedding)
