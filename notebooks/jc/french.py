...
def _():
    ...
    mo.md(
        r"""
        # French (Junior Cycle (JC))

        > **JC-FREN-LO** — the canonical BIEP per-subject analysis.
...
def _(duckdb, ibis, pd):
    ...
    # (consumed from leaving_certificate/jc/french/)
    pdf_root = f"leaving_certificate/jc/french"
...
async def _():
    ...
    try:
        ...
        baml_result = {"stub": True, "subject": "french", "stage": "jc"}
    return baml_result,
...
def _():
    ...
    # (consumed from ireland_jc_french_en_embedding)
