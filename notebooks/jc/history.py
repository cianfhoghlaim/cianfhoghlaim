...
def _():
    ...
    mo.md(
        r"""
        # History (Junior Cycle (JC))

        > **JC-HIST-LO** — the canonical BIEP per-subject analysis.
...
def _(duckdb, ibis, pd):
    ...
    # (consumed from leaving_certificate/jc/history/)
    pdf_root = f"leaving_certificate/jc/history"
...
async def _():
    ...
    try:
        ...
        baml_result = {"stub": True, "subject": "history", "stage": "jc"}
    return baml_result,
...
def _():
    ...
    # (consumed from ireland_jc_history_en_embedding)
