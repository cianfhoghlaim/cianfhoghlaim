...
def _():
    ...
    mo.md(
        r"""
        # Business (Junior Cycle (JC))

        > **JC-BUS-LO** — the canonical BIEP per-subject analysis.
...
def _(duckdb, ibis, pd):
    ...
    # (consumed from leaving_certificate/jc/business/)
    pdf_root = f"leaving_certificate/jc/business"
...
async def _():
    ...
    try:
        ...
        baml_result = {"stub": True, "subject": "business", "stage": "jc"}
    return baml_result,
...
def _():
    ...
    # (consumed from ireland_jc_business_en_embedding)
