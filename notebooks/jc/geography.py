...
def _():
    ...
    mo.md(
        r"""
        # Geography (Junior Cycle (JC))

        > **JC-GEOG-LO** — the canonical BIEP per-subject analysis.
...
def _(duckdb, ibis, pd):
    ...
    # (consumed from leaving_certificate/jc/geography/)
    pdf_root = f"leaving_certificate/jc/geography"
...
async def _():
    ...
    try:
        ...
        baml_result = {"stub": True, "subject": "geography", "stage": "jc"}
    return baml_result,
...
def _():
    ...
    # (consumed from ireland_jc_geography_en_embedding)
