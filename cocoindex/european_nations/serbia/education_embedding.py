...
LanceDB table ``cianfhoghlaim.lc.european_nations.srb.education_chunks`` using the canonical
...
TABLE_NAME = "cianfhoghlaim.lc.european_nations.srb.education_chunks"
TABLE_DESCRIPTION = (
