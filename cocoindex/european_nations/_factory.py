...
- R1: imports `shared_lifespan` + the canonical ContextKeys
  from `cocoindex/_shared/_lifespan.py`
...
# Note: the pre-v8 callers that did `from cocoindex.european_nations.<nation>.education_embedding import <app>`
# can be migrated via the 1-line shim files at
# cocoindex/european_nations/<nation>/education_embedding.py — each
# is now a 1-line re-export:
#     from cocoindex.european_nations._factory import <app_slug>_education_embedding
