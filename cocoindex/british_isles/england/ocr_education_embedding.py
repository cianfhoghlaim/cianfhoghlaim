...
try:
    from cocoindex._shared._lifespan import EMBEDDER, LANCE_DB, shared_lifespan  # type: ignore  # noqa: F401
...
if COCOINDEX_AVAILABLE:
    ...
    async def ocr_qualification_embedding_flow(  # type: ignore[no-redef]
        ...
        table_name = f"oideachais.england.ocr.{subject}.{qualification_level}"
