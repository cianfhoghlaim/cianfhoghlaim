"""
MCP Server for Crypteolas.

Provides stdio transport for protocol documentation and analysis tools.
"""
...
class MCPServer:
    ...
    async def run(self):
        ...
        self.running = True
        logger.info("Crypteolas MCP server starting (stdio)")
        ...
        logger.info("Crypteolas MCP server stopped")
