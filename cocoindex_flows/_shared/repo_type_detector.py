...
(`cocoindex_flows/_shared/repo_type_detector.py:RepoTypeDetector` (was `stedding/dev/cianfhoghlaim copy/sruth/códeolas/generators/reposwarm/detector.py` pre-v7)).
