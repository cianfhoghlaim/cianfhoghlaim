...
2. Prints the R1-R4 conformance status of the en-cy / Wales Phase 1
   ...
   en-gd / Scotland Phase 4 CocoIndex App
...
Usage:
    ...
    uv run python -m cocoindex_flows.british_isles.uk --check                       # R1-R4 audit on all 4 phases
    ...
    uv run python -m cocoindex_flows.british_isles.uk --metadata                   # all 4 phases metadata
...
def _parse_args(argv: list[str] | None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        ...
        description="ciancheiltis en-cy / Wales Phase 1 + en-ga / ROI Phase 2 + en-ga / NI Phase 3 + en-gd / Scotland Phase 4 CocoIndex App CLI",
    )
    group = parser.add_mutually_exclusive_group(required=True)
    group.add_argument(
        "--check",
        action="store_true",
        help="Run the R1-R4 conformance audit on all 4 phase Apps",
    )
    group.add_argument(
        "--check-phase1",
        action="store_true",
