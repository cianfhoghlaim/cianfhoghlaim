"""breton_embedding — CocoIndex v1 App for Breton (Brezhoneg) vernacular.

Re-exports the canonical ``vernacular_breton_embedding`` app from
...
from .vernacular_factory import (  # noqa: F401
    vernacular_breton_embedding as breton_embedding_app,
)

__all__ = ["breton_embedding_app"]
