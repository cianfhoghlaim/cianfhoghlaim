"""en_education_embedding — Wave 3 stub.

This is a placeholder CocoIndex v1 App for the
`orchestration/defs/3_model_lifecycle/cocoindex_v1/en_education_embedding/defs.yaml`
...
`en_education_embedding` defs.yaml files were a v0-era mistake that we're now stubbing.
"""
...
if COCOINDEX_AVAILABLE:
    ...
    async def en_education_embedding_flow(  # type: ignore[no-untyped-def,unused-ignore]
        source_id: str,
    ) -> AsyncIterator[dict[str, Any]]:
        """Stub: yield one dummy row for the en_education_embedding pipeline."""
        yield {"source_id": source_id, "kind": "en_education_embedding_stub"}

    app = coco.App(
        coco.AppConfig(name="en_education_embedding"),
        en_education_embedding_flow,
