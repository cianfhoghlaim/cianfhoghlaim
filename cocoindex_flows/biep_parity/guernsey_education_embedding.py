"""guernsey_education_embedding — Wave 3 stub.

This is a placeholder CocoIndex v1 App for the
`orchestration/defs/3_model_lifecycle/cocoindex_v1/guernsey_education_embedding/defs.yaml`
...
`guernsey_education_embedding` defs.yaml files were a v0-era mistake that we're now stubbing.
"""
...
if COCOINDEX_AVAILABLE:
    ...
    async def guernsey_education_embedding_flow(  # type: ignore[no-untyped-def,unused-ignore]
        source_id: str,
    ) -> AsyncIterator[dict[str, Any]]:
        """Stub: yield one dummy row for the guernsey_education_embedding pipeline."""
        yield {"source_id": source_id, "kind": "guernsey_education_embedding_stub"}

    app = coco.App(
        coco.AppConfig(name="guernsey_education_embedding"),
        guernsey_education_embedding_flow,
