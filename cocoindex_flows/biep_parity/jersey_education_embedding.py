"""jersey_education_embedding — Wave 3 stub.

This is a placeholder CocoIndex v1 App for the
`orchestration/defs/3_model_lifecycle/cocoindex_v1/jersey_education_embedding/defs.yaml`
...
`jersey_education_embedding` defs.yaml files were a v0-era mistake that we're now stubbing.
"""
...
if COCOINDEX_AVAILABLE:
    ...
    async def jersey_education_embedding_flow(  # type: ignore[no-untyped-def,unused-ignore]
        source_id: str,
    ) -> AsyncIterator[dict[str, Any]]:
        """Stub: yield one dummy row for the jersey_education_embedding pipeline."""
        yield {"source_id": source_id, "kind": "jersey_education_embedding_stub"}

    app = coco.App(
        coco.AppConfig(name="jersey_education_embedding"),
        jersey_education_embedding_flow,
