...
OCR_MODELS: dict[str, OCRModel] = {
    "olmocr-7b": OCRModel(
        ...
        model_id="allenai/olmOCR-2-7B-1025",  # P0: v4 fix per the 2026-06-29 HF audit (real v2 ID, not the fictional "2-7B")
    ...
    "deepseek-ocr": OCRModel(
        name="DeepSeek-OCR-2",
        model_id="deepseek-ai/DeepSeek-OCR-2",  # P0: v4 fix per the 2026-06-29 HF audit (v2 superset)
        backend=ModelBackend.TRANSFORMERS,
        capabilities=[
            ModelCapability.DENSE_OCR,
