...
class TestCharacterInterpolation:
    ...
    def test_tokenize_irish_text_basic(self):
        ...
        from cianfhoghlaim.core.alignment.character_interpolator import tokenize_irish_text
    ...
    def test_interpolate_timestamps(self):
        ...
        from cianfhoghlaim.core.alignment.character_interpolator import (
...
class TestIrishG2P:
    ...
    def test_rule_based_g2p_basic(self):
        ...
        from cianfhoghlaim.core.alignment.irish_g2p import rule_based_g2p
    ...
    def test_dialect_variations(self):
        ...
        from cianfhoghlaim.core.alignment.irish_g2p import IrishDialect, rule_based_g2p

        # Ulster uses /eː/ for "ao" instead of /iː/
        rule_based_g2p("aon", dialect=IrishDialect.ULSTER)
        # Should have dialect-specific variation

    def test_create_phoneme_alignment(self):
        """Test phoneme alignment creation."""
        from cianfhoghlaim.core.alignment.irish_g2p import (
...
class TestCanuintExporter:
    ...
    def test_export_ljspeech(self):
        ...
        from cianfhoghlaim.core.alignment.canuint_exporter import export_ljspeech
    ...
    def test_export_ctm(self):
        ...
        from cianfhoghlaim.core.alignment.canuint_exporter import export_ctm
    ...
    def test_export_textgrid(self):
        ...
        from cianfhoghlaim.core.alignment.canuint_exporter import export_textgrid
    ...
    def test_export_huggingface_dataset(self):
        ...
        from cianfhoghlaim.core.alignment.canuint_exporter import export_huggingface_dataset
...
class TestCanuintValidator:
    ...
    def test_validate_duration_distribution(self):
        ...
        from cianfhoghlaim.core.quality.quality.canuint_validator import validate_duration_distribution
    ...
    def test_validate_alignment_consistency(self):
        ...
        from cianfhoghlaim.core.quality.quality.canuint_validator import validate_alignment_consistency
    ...
    def test_validate_dialect_balance(self):
        ...
        from cianfhoghlaim.core.quality.quality.canuint_validator import validate_dialect_balance
    ...
    def test_validate_speaker_diversity(self):
        ...
        from cianfhoghlaim.core.quality.quality.canuint_validator import validate_speaker_diversity
    ...
    def test_generate_splits(self):
        ...
        from cianfhoghlaim.core.quality.quality.canuint_validator import generate_splits
    ...
    def test_full_validation_report(self):
        ...
        from cianfhoghlaim.core.quality.quality.canuint_validator import validate_canuint_dataset
...
class TestEndToEndPipeline:
    ...
    def test_export_and_validate_pipeline(self):
        ...
        from cianfhoghlaim.core.alignment.canuint_exporter import export_all_formats
        from cianfhoghlaim.core.alignment.character_interpolator import (
            batch_interpolate_alignments,
        )
        from cianfhoghlaim.core.alignment.irish_g2p import batch_convert_to_phonemes
        from cianfhoghlaim.core.quality.quality.canuint_validator import validate_canuint_dataset
