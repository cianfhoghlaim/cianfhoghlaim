...
def test_zotero_source_yields_arxiv_and_dup_columns() -> None:
    from cianfhoghlaim.dlt.leabharlann import DEFAULT_ZOTERO_ROOT, zotero_source
...
def test_leabharlann_books_source_yields_partitioned_rows() -> None:
    from cianfhoghlaim.dlt.leabharlann import DEFAULT_LEABHARLANN_ROOT, leabharlann_books_source
...
def test_takeout_v1_source_yields_rows() -> None:
    from cianfhoghlaim.dlt.leabharlann import DEFAULT_TAKEOUT_ROOT, takeout_v1_source
...
def test_takeout_v1_account_fallback() -> None:
    ...
    from cianfhoghlaim.dlt.leabharlann import _detect_account_label
...
def test_epub_extractor_graceful_degradation(tmp_path: Path) -> None:
    ...
    from cianfhoghlaim.dlt.leabharlann._epub_extractor import extract_epub_chapters
...
def test_find_preview_for(tmp_path: Path) -> None:
    from cianfhoghlaim.dlt.leabharlann.previews import find_preview_for
