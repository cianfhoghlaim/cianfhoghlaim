...
Provides the convex service for the Cianfhoghlaim platform.
...
- **Ops**: `bonneagar/stacks/convex/` (the 6-file GOLD_STANDARD)
...
- - **Pangolin**: `https://convex-api.cianfhoghlaim.ie` (if exposed)
