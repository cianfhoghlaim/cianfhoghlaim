...
Provides the bytebase service for the Cianfhoghlaim platform.
...
- **Ops**: `bonneagar/stacks/bytebase/` (the 6-file GOLD_STANDARD)
...
- - **Pangolin**: `https://bytebase.cianfhoghlaim.ie` (if exposed)
