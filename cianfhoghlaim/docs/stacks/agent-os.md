...
Provides the agent-os service for the Cianfhoghlaim platform.
...
- **Ops**: `bonneagar/stacks/agent-os/` (the 6-file GOLD_STANDARD)
...
- - **Pangolin**: `https://agents.aleyum.cianfhoghlaim.ie` (if exposed)
