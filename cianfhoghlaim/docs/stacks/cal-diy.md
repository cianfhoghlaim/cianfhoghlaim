...
cal.com community build at `https://calcom.cianfhoghlaim.ie`. Login via PocketID SSO.
...
- **Ops**: `bonneagar/stacks/cal-diy/` (the 6-file GOLD_STANDARD)
...
- - **Pangolin**: `https://calcom.cianfhoghlaim.ie` (if exposed)
