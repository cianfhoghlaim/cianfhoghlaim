...
Provides the gluetun service for the Cianfhoghlaim platform.
...
- **Ops**: `bonneagar/stacks/gluetun/` (the 6-file GOLD_STANDARD)
...
- - **Pangolin**: `https://gluetun.cianfhoghlaim.ie` (if exposed)
