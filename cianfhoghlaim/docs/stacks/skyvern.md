...
Skyvern is an open-source AI agent that automates browser-based workflows using computer vision and LLM reasoning. Unlike traditional web scrapers that rely on fixed CSS selectors, Skyvern "sees" the page — it can navigate websites, fill forms, click buttons, and extract data by understanding the visual layout and content.
...
- **Ops**: `bonneagar/stacks/skyvern/` (the 6-file GOLD_STANDARD)
...
- - **Pangolin**: `https://skyvern.cianfhoghlaim.ie` (if exposed)
