...
Provides the meaisinfoghlaim service for the Cianfhoghlaim platform.
...
- **Ops**: `bonneagar/stacks/meaisinfoghlaim/` (the 6-file GOLD_STANDARD)
...
- - **Pangolin**: `https://llamaswap.cianfhoghlaim.ie` (if exposed)
