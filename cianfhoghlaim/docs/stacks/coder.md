...
Provides the coder service for the Cianfhoghlaim platform.
...
- **Ops**: `bonneagar/stacks/coder/` (the 6-file GOLD_STANDARD)
...
- - **Pangolin**: `https://coder.cianfhoghlaim.ie` (if exposed)
