...
Provides the dragonfly service for the Cianfhoghlaim platform.
...
- **Ops**: `bonneagar/stacks/dragonfly/` (the 6-file GOLD_STANDARD)
...
- - **Pangolin**: `https://dragonfly.cianfhoghlaim.ie` (if exposed)
