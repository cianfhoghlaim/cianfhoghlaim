...
Provides the windmill service for the Cianfhoghlaim platform.
...
- **Ops**: `bonneagar/stacks/windmill/` (the 6-file GOLD_STANDARD)
...
- - **Pangolin**: `https://windmill.cianfhoghlaim.ie` (if exposed)
