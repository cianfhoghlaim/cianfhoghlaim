...
The DLT source lives in `oideachais.cianfhoghlaim.dlt.british_isles.ireland.education.leaving_cert`
...
from cianfhoghlaim.dlt.british_isles.ireland.education.leaving_cert import (
    SUBJECTS,
    leaving_cert_source,
)
