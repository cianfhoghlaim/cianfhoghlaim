...
@asset(
    ...
    description=(
        ...
        "Source: cianfhoghlaim.dlt.british_isles.ireland.law.irish_statute_book."
...
@asset(
    ...
    description=(
        ...
        "Source: cianfhoghlaim.dlt.british_isles.ireland.law.doj.doj_source"
    ),
)
...
@asset(
    ...
    description=(
        ...
        "Source: cianfhoghlaim.dlt.british_isles.ireland.law.lawreform.lawreform_source"
    ),
)
