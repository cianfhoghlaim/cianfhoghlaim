...
def create_cycle_asset(cycle: str):
    ...
    def _cycle_asset(context) -> dg.MaterializeResult:
        ...
        from cianfhoghlaim.dlt.common.curriculum_registry import SubjectRegistry
        ...
        from cianfhoghlaim.dlt.common.curriculum_registry import SubjectRegistry
        from cianfhoghlaim.dlt.british_isles.ireland.education.curriculum_source import build_subject_urls
