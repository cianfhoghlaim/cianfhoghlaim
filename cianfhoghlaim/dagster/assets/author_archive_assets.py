...
def author_archive_university_of_galway_raw(context) -> dg.MaterializeResult:
    ...
    from cianfhoghlaim.dlt.leabharlann import university_of_galway_source
...
def author_archive_gemini_deep_research_raw(
    ...
    from cianfhoghlaim.dlt.leabharlann import gemini_deep_research_source
...
def author_archive_takeout_raw(context) -> dg.MaterializeResult:
    ...
    from cianfhoghlaim.dlt.leabharlann import google_takeout_source
