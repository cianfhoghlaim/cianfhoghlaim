...
from .routes import agent, geospatial, search
...
async def health_check() -> HealthResponse:
    ...
    """
    from observability import get_langfuse_client, is_initialized, is_llmobs_enabled
    ...
    try:
        import lancedb
        lancedb.connect("./storage/data/lancedb")
