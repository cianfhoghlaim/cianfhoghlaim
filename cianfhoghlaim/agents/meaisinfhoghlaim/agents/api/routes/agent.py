...
async def run_agent_async(
    ...
    education_team, _EducationResponse = get_education_team()
    ...
    try:
        ...
        return {
            "message": f"I encountered an error processing your request. Please try again. Error: {e!s}",
            "agents_used": [],
            "sources": [],
        }
...
async def stream_agent_response(
    ...
    try:
        ...
        if hasattr(response, '__iter__') and not isinstance(response, str):
            ...
            full_response = response.summary if hasattr(response, 'summary') else str(response)
