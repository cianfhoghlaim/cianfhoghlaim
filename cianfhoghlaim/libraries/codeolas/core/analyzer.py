...
class CodebaseAnalyzer:
    ...
    def lance_catalog(self):
        ...
        if self._lance_catalog is None:
            from codeolas.storage.lance_catalog import LanceCatalog, LanceCatalogConfig
    ...
    def embedding_service(self):
        ...
        if self._embedding_service is None:
            from codeolas.core.embeddings import EmbeddingService
    ...
    async def index(
        ...
        for pattern in exclude_patterns:
            ...
            files -= {Path(f) for f in excluded}

        logger.info(f"Found {len(files)} files to index")

        # Chunk files
        from codeolas.core.chunking import chunk_code_file
        ...
        if all_chunks:
            ...
            # Store in LanceDB
            from codeolas.storage.lance_catalog import CodeChunk as StorageChunk
    ...
    async def deep_research(
        ...
        """
        from codeolas.search.multihop import multihop_search
