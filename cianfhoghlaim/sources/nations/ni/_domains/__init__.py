"""Northern Ireland — 7-domain bundle stub (Plan 3 PRESERVED).

Cross-domain sources for Northern Ireland beyond the education sources at
sources/nations/ni/education/. Each domain maps to a separate
