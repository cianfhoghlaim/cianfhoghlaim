"""England education — English (Plan 2 PRESERVED stub).

en is one of the 6 active nations in cianfhoghlaim (Plan 2 stub).
...
STAGE = "secondary"
LANGUAGE = "english"
PRIMARY_URL = "https://www.gov.uk/government/publications/national-curriculum-in-england-framework-for-key-stages-1-to-4"
