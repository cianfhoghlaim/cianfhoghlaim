...
``stedding/ingest_queue/commonwealth/nga/states/nga_ebi/education/ministry_of_education/<lang>/``.
"""
...
@dlt.resource(
    name="nga_ebi_ministry_of_education",
...
def nga_ebi_ministry_of_education(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_ebi/education/ministry_of_education")
...
@dlt.source(name="nga_ebi_ministry_of_education")
def nga_ebi_ministry_of_education_source(language=None):
    """DLT source for the state ingestion."""
    return nga_ebi_ministry_of_education(language=language)
...
__all__ = [
    ...
    "STATE_CODE",
    "STATE_NAME",
    "nga_ebi_ministry_of_education",
    "nga_ebi_ministry_of_education_source",
]
