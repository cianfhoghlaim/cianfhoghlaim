...
``stedding/ingest_queue/commonwealth/nga/states/nga_ebi/medicine/health_authority/<lang>/``.
"""
...
def nga_ebi_health_authority(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_ebi/medicine/health_authority")
