...
``stedding/ingest_queue/commonwealth/nga/states/nga_ebi/government/gov_portal/<lang>/``.
"""
...
def nga_ebi_gov_portal(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_ebi/government/gov_portal")
