...
``stedding/ingest_queue/commonwealth/nga/states/nga_abi/medicine/health_authority/<lang>/``.
"""
...
def nga_abi_health_authority(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_abi/medicine/health_authority")
