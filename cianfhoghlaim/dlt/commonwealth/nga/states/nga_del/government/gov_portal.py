...
``stedding/ingest_queue/commonwealth/nga/states/nga_del/government/gov_portal/<lang>/``.
"""
...
def nga_del_gov_portal(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_del/government/gov_portal")
