...
``stedding/ingest_queue/commonwealth/nga/states/nga_del/statistics/stats_office/<lang>/``.
"""
...
def nga_del_stats_office(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_del/statistics/stats_office")
