...
``stedding/ingest_queue/commonwealth/nga/states/nga_del/medicine/health_authority/<lang>/``.
"""
...
def nga_del_health_authority(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_del/medicine/health_authority")
