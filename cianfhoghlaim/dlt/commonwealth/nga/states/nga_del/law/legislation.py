...
``stedding/ingest_queue/commonwealth/nga/states/nga_del/law/legislation/<lang>/``.
"""
...
def nga_del_legislation(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_del/law/legislation")
