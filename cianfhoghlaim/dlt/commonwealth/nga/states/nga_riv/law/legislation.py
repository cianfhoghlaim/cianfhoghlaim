...
``stedding/ingest_queue/commonwealth/nga/states/nga_riv/law/legislation/<lang>/``.
"""
...
def nga_riv_legislation(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_riv/law/legislation")
