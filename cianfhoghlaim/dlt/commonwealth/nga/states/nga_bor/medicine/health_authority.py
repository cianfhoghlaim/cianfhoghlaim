...
``stedding/ingest_queue/commonwealth/nga/states/nga_bor/medicine/health_authority/<lang>/``.
"""
...
def nga_bor_health_authority(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_bor/medicine/health_authority")
