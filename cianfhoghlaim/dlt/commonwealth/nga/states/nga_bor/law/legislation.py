...
``stedding/ingest_queue/commonwealth/nga/states/nga_bor/law/legislation/<lang>/``.
"""
...
def nga_bor_legislation(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_bor/law/legislation")
