...
``stedding/ingest_queue/commonwealth/nga/states/nga_kad/medicine/health_authority/<lang>/``.
"""
...
def nga_kad_health_authority(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_kad/medicine/health_authority")
