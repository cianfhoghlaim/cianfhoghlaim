...
``stedding/ingest_queue/commonwealth/nga/states/nga_kad/law/legislation/<lang>/``.
"""
...
def nga_kad_legislation(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_kad/law/legislation")
