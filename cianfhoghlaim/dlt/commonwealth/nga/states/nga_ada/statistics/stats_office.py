...
``stedding/ingest_queue/commonwealth/nga/states/nga_ada/statistics/stats_office/<lang>/``.
"""
...
def nga_ada_stats_office(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_ada/statistics/stats_office")
