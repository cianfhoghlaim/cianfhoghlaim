...
``stedding/ingest_queue/commonwealth/nga/states/nga_ada/medicine/health_authority/<lang>/``.
"""
...
def nga_ada_health_authority(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_ada/medicine/health_authority")
