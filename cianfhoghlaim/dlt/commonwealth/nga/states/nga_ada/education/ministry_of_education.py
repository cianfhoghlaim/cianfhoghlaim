...
``stedding/ingest_queue/commonwealth/nga/states/nga_ada/education/ministry_of_education/<lang>/``.
"""
...
def nga_ada_ministry_of_education(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_ada/education/ministry_of_education")
