...
``stedding/ingest_queue/commonwealth/nga/states/nga_kat/law/legislation/<lang>/``.
"""
...
def nga_kat_legislation(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_kat/law/legislation")
