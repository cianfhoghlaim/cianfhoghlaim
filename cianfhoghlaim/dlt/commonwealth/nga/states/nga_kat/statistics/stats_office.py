...
``stedding/ingest_queue/commonwealth/nga/states/nga_kat/statistics/stats_office/<lang>/``.
"""
...
def nga_kat_stats_office(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_kat/statistics/stats_office")
