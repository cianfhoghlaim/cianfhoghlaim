...
``stedding/ingest_queue/commonwealth/nga/states/nga_kat/government/gov_portal/<lang>/``.
"""
...
def nga_kat_gov_portal(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_kat/government/gov_portal")
