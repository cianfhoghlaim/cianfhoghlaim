...
``stedding/ingest_queue/commonwealth/nga/states/nga_yob/law/legislation/<lang>/``.
"""
...
def nga_yob_legislation(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_yob/law/legislation")
