...
``stedding/ingest_queue/commonwealth/nga/states/nga_yob/medicine/health_authority/<lang>/``.
"""
...
def nga_yob_health_authority(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_yob/medicine/health_authority")
