...
``stedding/ingest_queue/commonwealth/nga/states/nga_osn/law/legislation/<lang>/``.
"""
...
def nga_osn_legislation(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_osn/law/legislation")
