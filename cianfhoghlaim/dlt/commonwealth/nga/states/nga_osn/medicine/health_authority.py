...
``stedding/ingest_queue/commonwealth/nga/states/nga_osn/medicine/health_authority/<lang>/``.
"""
...
def nga_osn_health_authority(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_osn/medicine/health_authority")
