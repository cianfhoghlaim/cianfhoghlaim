...
``stedding/ingest_queue/commonwealth/nga/states/nga_ond/medicine/health_authority/<lang>/``.
"""
...
def nga_ond_health_authority(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_ond/medicine/health_authority")
