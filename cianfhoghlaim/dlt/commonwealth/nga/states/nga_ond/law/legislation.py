...
``stedding/ingest_queue/commonwealth/nga/states/nga_ond/law/legislation/<lang>/``.
"""
...
def nga_ond_legislation(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_ond/law/legislation")
