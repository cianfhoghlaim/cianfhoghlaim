...
``stedding/ingest_queue/commonwealth/nga/states/Ogun State/law/legislation/<lang>/``.
"""
...
def nga_ogn_legislation(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/Ogun State/law/legislation")
