...
``stedding/ingest_queue/commonwealth/nga/states/nga_ogn/government/gov_portal/<lang>/``.
"""
...
def nga_ogn_gov_portal(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_ogn/government/gov_portal")
