...
``stedding/ingest_queue/commonwealth/nga/states/nga_ogn/medicine/health_authority/<lang>/``.
"""
...
def nga_ogn_health_authority(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_ogn/medicine/health_authority")
