...
``stedding/ingest_queue/commonwealth/nga/states/nga_kwa/statistics/stats_office/<lang>/``.
"""
...
def nga_kwa_stats_office(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_kwa/statistics/stats_office")
