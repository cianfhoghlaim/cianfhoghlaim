...
``stedding/ingest_queue/commonwealth/nga/states/nga_kwa/government/gov_portal/<lang>/``.
"""
...
def nga_kwa_gov_portal(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_kwa/government/gov_portal")
