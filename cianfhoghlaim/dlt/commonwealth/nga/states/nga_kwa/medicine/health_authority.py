...
``stedding/ingest_queue/commonwealth/nga/states/nga_kwa/medicine/health_authority/<lang>/``.
"""
...
def nga_kwa_health_authority(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_kwa/medicine/health_authority")
