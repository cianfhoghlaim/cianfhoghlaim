...
``stedding/ingest_queue/commonwealth/nga/states/nga_imo/medicine/health_authority/<lang>/``.
"""
...
def nga_imo_health_authority(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_imo/medicine/health_authority")
