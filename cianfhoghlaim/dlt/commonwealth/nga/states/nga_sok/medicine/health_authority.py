...
``stedding/ingest_queue/commonwealth/nga/states/nga_sok/medicine/health_authority/<lang>/``.
"""
...
def nga_sok_health_authority(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_sok/medicine/health_authority")
