...
``stedding/ingest_queue/commonwealth/nga/states/nga_sok/law/legislation/<lang>/``.
"""
...
def nga_sok_legislation(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_sok/law/legislation")
