...
``stedding/ingest_queue/commonwealth/nga/states/nga_tar/law/legislation/<lang>/``.
"""
...
def nga_tar_legislation(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_tar/law/legislation")
