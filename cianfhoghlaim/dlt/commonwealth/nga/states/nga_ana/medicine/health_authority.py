...
``stedding/ingest_queue/commonwealth/nga/states/nga_ana/medicine/health_authority/<lang>/``.
"""
...
def nga_ana_health_authority(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_ana/medicine/health_authority")
