...
``stedding/ingest_queue/commonwealth/nga/states/nga_bay/law/legislation/<lang>/``.
"""
...
def nga_bay_legislation(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_bay/law/legislation")
