...
``stedding/ingest_queue/commonwealth/nga/states/nga_bay/medicine/health_authority/<lang>/``.
"""
...
def nga_bay_health_authority(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_bay/medicine/health_authority")
