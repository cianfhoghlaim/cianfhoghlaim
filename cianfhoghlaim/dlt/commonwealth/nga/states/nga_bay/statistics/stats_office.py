...
``stedding/ingest_queue/commonwealth/nga/states/nga_bay/statistics/stats_office/<lang>/``.
"""
...
def nga_bay_stats_office(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_bay/statistics/stats_office")
