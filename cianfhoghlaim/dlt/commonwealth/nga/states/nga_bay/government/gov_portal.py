...
``stedding/ingest_queue/commonwealth/nga/states/nga_bay/government/gov_portal/<lang>/``.
"""
...
def nga_bay_gov_portal(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_bay/government/gov_portal")
