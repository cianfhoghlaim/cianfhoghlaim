...
``stedding/ingest_queue/commonwealth/nga/states/nga_enu/education/ministry_of_education/<lang>/``.
"""
...
def nga_enu_ministry_of_education(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_enu/education/ministry_of_education")
