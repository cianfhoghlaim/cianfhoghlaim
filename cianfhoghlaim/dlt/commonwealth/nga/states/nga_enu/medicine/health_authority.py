...
``stedding/ingest_queue/commonwealth/nga/states/nga_enu/medicine/health_authority/<lang>/``.
"""
...
def nga_enu_health_authority(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_enu/medicine/health_authority")
