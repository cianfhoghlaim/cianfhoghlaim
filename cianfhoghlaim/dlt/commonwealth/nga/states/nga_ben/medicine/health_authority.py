...
``stedding/ingest_queue/commonwealth/nga/states/nga_ben/medicine/health_authority/<lang>/``.
"""
...
def nga_ben_health_authority(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_ben/medicine/health_authority")
