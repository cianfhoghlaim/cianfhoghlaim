...
``stedding/ingest_queue/commonwealth/nga/states/nga_ben/law/legislation/<lang>/``.
"""
...
def nga_ben_legislation(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_ben/law/legislation")
