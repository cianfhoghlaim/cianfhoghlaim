...
``stedding/ingest_queue/commonwealth/nga/states/nga_ben/government/gov_portal/<lang>/``.
"""
...
def nga_ben_gov_portal(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_ben/government/gov_portal")
