...
``stedding/ingest_queue/commonwealth/nga/states/nga_keb/medicine/health_authority/<lang>/``.
"""
...
def nga_keb_health_authority(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_keb/medicine/health_authority")
