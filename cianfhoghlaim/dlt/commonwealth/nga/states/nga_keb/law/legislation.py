...
``stedding/ingest_queue/commonwealth/nga/states/nga_keb/law/legislation/<lang>/``.
"""
...
def nga_keb_legislation(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_keb/law/legislation")
