...
``stedding/ingest_queue/commonwealth/nga/states/nga_edo/education/ministry_of_education/<lang>/``.
"""
...
def nga_edo_ministry_of_education(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_edo/education/ministry_of_education")
