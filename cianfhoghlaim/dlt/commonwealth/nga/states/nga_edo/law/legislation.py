...
``stedding/ingest_queue/commonwealth/nga/states/nga_edo/law/legislation/<lang>/``.
"""
...
def nga_edo_legislation(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_edo/law/legislation")
