...
``stedding/ingest_queue/commonwealth/nga/states/nga_nas/government/gov_portal/<lang>/``.
"""
...
def nga_nas_gov_portal(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_nas/government/gov_portal")
