...
``stedding/ingest_queue/commonwealth/nga/states/nga_nas/law/legislation/<lang>/``.
"""
...
def nga_nas_legislation(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_nas/law/legislation")
