...
``stedding/ingest_queue/commonwealth/nga/states/nga_nas/medicine/health_authority/<lang>/``.
"""
...
def nga_nas_health_authority(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_nas/medicine/health_authority")
