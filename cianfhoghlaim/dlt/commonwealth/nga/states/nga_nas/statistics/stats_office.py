...
``stedding/ingest_queue/commonwealth/nga/states/nga_nas/statistics/stats_office/<lang>/``.
"""
...
def nga_nas_stats_office(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_nas/statistics/stats_office")
