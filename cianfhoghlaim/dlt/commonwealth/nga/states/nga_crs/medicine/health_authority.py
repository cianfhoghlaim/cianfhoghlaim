...
``stedding/ingest_queue/commonwealth/nga/states/nga_crs/medicine/health_authority/<lang>/``.
"""
...
def nga_crs_health_authority(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_crs/medicine/health_authority")
