...
``stedding/ingest_queue/commonwealth/nga/states/nga_crs/law/legislation/<lang>/``.
"""
...
def nga_crs_legislation(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_crs/law/legislation")
