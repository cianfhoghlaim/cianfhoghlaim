...
``stedding/ingest_queue/commonwealth/nga/states/nga_eki/medicine/health_authority/<lang>/``.
"""
...
def nga_eki_health_authority(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_eki/medicine/health_authority")
