...
``stedding/ingest_queue/commonwealth/nga/states/nga_eki/law/legislation/<lang>/``.
"""
...
def nga_eki_legislation(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_eki/law/legislation")
