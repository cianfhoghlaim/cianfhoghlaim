...
``stedding/ingest_queue/commonwealth/nga/states/nga_jig/law/legislation/<lang>/``.
"""
...
def nga_jig_legislation(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_jig/law/legislation")
