...
``stedding/ingest_queue/commonwealth/nga/states/nga_jig/medicine/health_authority/<lang>/``.
"""
...
def nga_jig_health_authority(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_jig/medicine/health_authority")
