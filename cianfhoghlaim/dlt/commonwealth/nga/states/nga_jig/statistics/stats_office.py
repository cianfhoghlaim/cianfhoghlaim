...
``stedding/ingest_queue/commonwealth/nga/states/nga_jig/statistics/stats_office/<lang>/``.
"""
...
def nga_jig_stats_office(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_jig/statistics/stats_office")
