...
``stedding/ingest_queue/commonwealth/nga/states/nga_bau/law/legislation/<lang>/``.
"""
...
def nga_bau_legislation(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_bau/law/legislation")
