...
``stedding/ingest_queue/commonwealth/nga/states/nga_bau/medicine/health_authority/<lang>/``.
"""
...
def nga_bau_health_authority(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_bau/medicine/health_authority")
