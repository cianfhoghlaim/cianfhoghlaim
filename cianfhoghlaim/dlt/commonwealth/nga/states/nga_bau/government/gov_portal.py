...
``stedding/ingest_queue/commonwealth/nga/states/nga_bau/government/gov_portal/<lang>/``.
"""
...
def nga_bau_gov_portal(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_bau/government/gov_portal")
