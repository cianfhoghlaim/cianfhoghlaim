...
``stedding/ingest_queue/commonwealth/nga/states/nga_ngr/law/legislation/<lang>/``.
"""
...
def nga_ngr_legislation(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_ngr/law/legislation")
