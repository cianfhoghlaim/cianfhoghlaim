...
``stedding/ingest_queue/commonwealth/nga/states/nga_ngr/medicine/health_authority/<lang>/``.
"""
...
def nga_ngr_health_authority(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_ngr/medicine/health_authority")
