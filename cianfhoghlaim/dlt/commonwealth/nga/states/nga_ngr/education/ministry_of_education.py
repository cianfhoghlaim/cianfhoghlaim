...
``stedding/ingest_queue/commonwealth/nga/states/nga_ngr/education/ministry_of_education/<lang>/``.
"""
...
def nga_ngr_ministry_of_education(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_ngr/education/ministry_of_education")
