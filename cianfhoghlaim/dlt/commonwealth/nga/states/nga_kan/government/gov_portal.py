...
``stedding/ingest_queue/commonwealth/nga/states/nga_kan/government/gov_portal/<lang>/``.
"""
...
def nga_kan_gov_portal(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_kan/government/gov_portal")
