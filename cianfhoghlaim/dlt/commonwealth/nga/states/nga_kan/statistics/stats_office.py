...
``stedding/ingest_queue/commonwealth/nga/states/nga_kan/statistics/stats_office/<lang>/``.
"""
...
def nga_kan_stats_office(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_kan/statistics/stats_office")
