...
``stedding/ingest_queue/commonwealth/nga/states/nga_kan/law/legislation/<lang>/``.
"""
...
def nga_kan_legislation(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_kan/law/legislation")
