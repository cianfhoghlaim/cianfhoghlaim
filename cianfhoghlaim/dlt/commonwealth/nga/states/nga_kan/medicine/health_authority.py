...
``stedding/ingest_queue/commonwealth/nga/states/nga_kan/medicine/health_authority/<lang>/``.
"""
...
def nga_kan_health_authority(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_kan/medicine/health_authority")
