...
``stedding/ingest_queue/commonwealth/nga/states/nga_gom/medicine/health_authority/<lang>/``.
"""
...
def nga_gom_health_authority(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_gom/medicine/health_authority")
