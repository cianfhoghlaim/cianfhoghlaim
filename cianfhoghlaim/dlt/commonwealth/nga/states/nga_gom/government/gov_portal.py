...
``stedding/ingest_queue/commonwealth/nga/states/nga_gom/government/gov_portal/<lang>/``.
"""
...
def nga_gom_gov_portal(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_gom/government/gov_portal")
