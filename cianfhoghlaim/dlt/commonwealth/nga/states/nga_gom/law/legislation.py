...
``stedding/ingest_queue/commonwealth/nga/states/nga_gom/law/legislation/<lang>/``.
"""
...
def nga_gom_legislation(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_gom/law/legislation")
