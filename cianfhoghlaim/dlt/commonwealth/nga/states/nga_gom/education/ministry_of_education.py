...
``stedding/ingest_queue/commonwealth/nga/states/nga_gom/education/ministry_of_education/<lang>/``.
"""
...
def nga_gom_ministry_of_education(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_gom/education/ministry_of_education")
