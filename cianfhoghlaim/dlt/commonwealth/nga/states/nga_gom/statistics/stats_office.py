...
``stedding/ingest_queue/commonwealth/nga/states/nga_gom/statistics/stats_office/<lang>/``.
"""
...
def nga_gom_stats_office(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_gom/statistics/stats_office")
