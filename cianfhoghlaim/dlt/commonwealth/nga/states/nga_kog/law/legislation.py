...
``stedding/ingest_queue/commonwealth/nga/states/nga_kog/law/legislation/<lang>/``.
"""
...
def nga_kog_legislation(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_kog/law/legislation")
