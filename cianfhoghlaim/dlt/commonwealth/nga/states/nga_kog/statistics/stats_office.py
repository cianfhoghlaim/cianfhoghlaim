...
``stedding/ingest_queue/commonwealth/nga/states/nga_kog/statistics/stats_office/<lang>/``.
"""
...
def nga_kog_stats_office(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_kog/statistics/stats_office")
