...
``stedding/ingest_queue/commonwealth/nga/states/nga_kog/government/gov_portal/<lang>/``.
"""
...
def nga_kog_gov_portal(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_kog/government/gov_portal")
