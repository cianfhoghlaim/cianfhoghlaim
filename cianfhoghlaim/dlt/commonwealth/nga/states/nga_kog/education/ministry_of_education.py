...
``stedding/ingest_queue/commonwealth/nga/states/nga_kog/education/ministry_of_education/<lang>/``.
"""
...
def nga_kog_ministry_of_education(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_kog/education/ministry_of_education")
