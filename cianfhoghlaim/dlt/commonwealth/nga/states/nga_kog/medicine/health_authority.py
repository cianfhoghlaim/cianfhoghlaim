...
``stedding/ingest_queue/commonwealth/nga/states/nga_kog/medicine/health_authority/<lang>/``.
"""
...
def nga_kog_health_authority(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_kog/medicine/health_authority")
