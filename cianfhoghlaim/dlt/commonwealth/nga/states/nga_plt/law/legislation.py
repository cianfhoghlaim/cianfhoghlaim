...
``stedding/ingest_queue/commonwealth/nga/states/nga_plt/law/legislation/<lang>/``.
"""
...
def nga_plt_legislation(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_plt/law/legislation")
