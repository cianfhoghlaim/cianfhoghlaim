...
``stedding/ingest_queue/commonwealth/nga/states/nga_plt/medicine/health_authority/<lang>/``.
"""
...
def nga_plt_health_authority(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_plt/medicine/health_authority")
