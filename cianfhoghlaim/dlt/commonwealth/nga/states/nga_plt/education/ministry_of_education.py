...
``stedding/ingest_queue/commonwealth/nga/states/nga_plt/education/ministry_of_education/<lang>/``.
"""
...
def nga_plt_ministry_of_education(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_plt/education/ministry_of_education")
