...
``stedding/ingest_queue/commonwealth/nga/states/nga_zam/statistics/stats_office/<lang>/``.
"""
...
def nga_zam_stats_office(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_zam/statistics/stats_office")
