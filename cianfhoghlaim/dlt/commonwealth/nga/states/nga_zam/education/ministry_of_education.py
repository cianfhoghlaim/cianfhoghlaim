...
``stedding/ingest_queue/commonwealth/nga/states/nga_zam/education/ministry_of_education/<lang>/``.
"""
...
def nga_zam_ministry_of_education(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_zam/education/ministry_of_education")
