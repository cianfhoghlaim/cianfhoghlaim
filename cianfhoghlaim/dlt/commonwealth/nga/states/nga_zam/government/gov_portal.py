...
``stedding/ingest_queue/commonwealth/nga/states/nga_zam/government/gov_portal/<lang>/``.
"""
...
def nga_zam_gov_portal(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_zam/government/gov_portal")
