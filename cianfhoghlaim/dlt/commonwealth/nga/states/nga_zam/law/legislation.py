...
``stedding/ingest_queue/commonwealth/nga/states/nga_zam/law/legislation/<lang>/``.
"""
...
def nga_zam_legislation(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_zam/law/legislation")
