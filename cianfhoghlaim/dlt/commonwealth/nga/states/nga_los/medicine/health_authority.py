...
``stedding/ingest_queue/commonwealth/nga/states/nga_los/medicine/health_authority/<lang>/``.
"""
...
def nga_los_health_authority(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_los/medicine/health_authority")
