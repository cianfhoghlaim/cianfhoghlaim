...
``stedding/ingest_queue/commonwealth/nga/states/nga_los/law/legislation/<lang>/``.
"""
...
def nga_los_legislation(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_los/law/legislation")
