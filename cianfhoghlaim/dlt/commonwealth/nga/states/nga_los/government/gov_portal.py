...
``stedding/ingest_queue/commonwealth/nga/states/nga_los/government/gov_portal/<lang>/``.
"""
...
def nga_los_gov_portal(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_los/government/gov_portal")
