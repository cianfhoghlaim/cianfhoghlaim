...
``stedding/ingest_queue/commonwealth/nga/states/nga_fct/law/legislation/<lang>/``.
"""
...
def nga_fct_legislation(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_fct/law/legislation")
