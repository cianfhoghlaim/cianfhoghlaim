...
``stedding/ingest_queue/commonwealth/nga/states/nga_fct/medicine/health_authority/<lang>/``.
"""
...
def nga_fct_health_authority(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_fct/medicine/health_authority")
