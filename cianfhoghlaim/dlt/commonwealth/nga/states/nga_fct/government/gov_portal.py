...
``stedding/ingest_queue/commonwealth/nga/states/nga_fct/government/gov_portal/<lang>/``.
"""
...
def nga_fct_gov_portal(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_fct/government/gov_portal")
