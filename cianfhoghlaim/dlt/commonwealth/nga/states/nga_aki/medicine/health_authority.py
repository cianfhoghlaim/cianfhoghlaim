...
``stedding/ingest_queue/commonwealth/nga/states/nga_aki/medicine/health_authority/<lang>/``.
"""
...
def nga_aki_health_authority(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_aki/medicine/health_authority")
