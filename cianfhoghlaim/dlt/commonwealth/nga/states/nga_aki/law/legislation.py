...
``stedding/ingest_queue/commonwealth/nga/states/nga_aki/law/legislation/<lang>/``.
"""
...
def nga_aki_legislation(language=None):
    ...
    cache_dir = Path("stedding/ingest_queue/commonwealth/nga/states/nga_aki/law/legislation")
