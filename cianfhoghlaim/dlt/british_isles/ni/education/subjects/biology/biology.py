...
def ni_biology(language: str | None = None) -> Iterator[dict[str, Any]]:
    """Yield Northern Ireland biology syllabus rows from the canonical cache.
    ...
    cache_dir = Path("stedding/site_scrape_samples/biep/ni/biology")
...
@dlt.source(name="ni_biology")
def ni_biology_source(language: str | None = None):
    """DLT source for the Northern Ireland biology ingestion."""
    return ni_biology(language=language)
