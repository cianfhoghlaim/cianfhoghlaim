...
def ni_physics(language: str | None = None) -> Iterator[dict[str, Any]]:
    """Yield Northern Ireland physics syllabus rows from the canonical cache.
    ...
    cache_dir = Path("stedding/site_scrape_samples/biep/ni/physics")
...
@dlt.source(name="ni_physics")
def ni_physics_source(language: str | None = None):
    """DLT source for the Northern Ireland physics ingestion."""
    return ni_physics(language=language)
