"""Per-subject DLT source for North Macedonia (Computing Science).
...
``stedding/ingest_queue/european_nations/mkd/education/subjects/computing_science/<lang>/``.
    ...
    def __init__(self) -> None:
        super().__init__(
            ...
            extra_metadata={
                ...
                "title": "North Macedonia Computing Science (MKD)",
                "subject": SUBJECT,
...
_NATION_SOURCE = MKDComputingScienceSource()
...
def mkd_computing_science(language: str | None = None) -> Iterator[dict[str, Any]]:
    """Yield North Macedonia Computing Science rows from the canonical cache."""
    if not use_local_scrapes():
        logger.warning(
            "mkd_computing_science_live_mode_not_implemented",
...
@dlt.source(name="mkd_computing_science")
def mkd_computing_science_source(language: str | None = None):
    """DLT source for the North Macedonia Computing Science ingestion."""
    return mkd_computing_science(language=language)
