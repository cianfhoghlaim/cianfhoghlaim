...
``dlt/european_nations/est/law/statute_book.py`` with
``source_id="european_nations.est.law.statute_book"`` and lands in
the DuckLake table ``oideachais.law.european_nations.est``.

Honours ``USE_LOCAL_SCRAPES=true`` by reading from
``stedding/ingest_queue/european_nations/est/law/<lang>/``.
...
class ESTLawSource(NationSource):
    ...
    def __init__(self) -> None:
        super().__init__(
            ...
            extra_metadata={
                "canonical_root": "https://www.riigiteataja.ee",
                "title": "Riigi Teataja (State Gazette of Estonia)",
            },
        )
...
def statute_book(language: str | None = None) -> Iterator[dict[str, Any]]:
    """Yield Estonia law rows from the canonical cache."""
...
def statute_book_source(language: str | None = None):
    """DLT source for the Riigi Teataja (State Gazette of Estonia) ingestion."""
