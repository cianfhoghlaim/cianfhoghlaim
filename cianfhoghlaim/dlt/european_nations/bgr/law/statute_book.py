...
``dlt/european_nations/bgr/law/statute_book.py`` with
``source_id="european_nations.bgr.law.statute_book"`` and lands in
the DuckLake table ``oideachais.law.european_nations.bgr``.

Honours ``USE_LOCAL_SCRAPES=true`` by reading from
``stedding/ingest_queue/european_nations/bgr/law/<lang>/``.
...
class BGRLawSource(NationSource):
    ...
    def __init__(self) -> None:
        super().__init__(
            ...
            extra_metadata={
                "canonical_root": "https://lex.bg",
                "title": "Bulgarian State Gazette / Lex.bg",
            },
        )
...
def statute_book(language: str | None = None) -> Iterator[dict[str, Any]]:
    """Yield Bulgaria law rows from the canonical cache."""
...
def statute_book_source(language: str | None = None):
    """DLT source for the Bulgarian State Gazette / Lex.bg ingestion."""
