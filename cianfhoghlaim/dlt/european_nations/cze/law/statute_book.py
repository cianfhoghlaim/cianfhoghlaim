...
``dlt/european_nations/cze/law/statute_book.py`` with
``source_id="european_nations.cze.law.statute_book"`` and lands in
the DuckLake table ``oideachais.law.european_nations.cze``.

Honours ``USE_LOCAL_SCRAPES=true`` by reading from
``stedding/ingest_queue/european_nations/cze/law/<lang>/``.
...
class CzechiaLawSource(NationSource):
    ...
    def __init__(self) -> None:
        super().__init__(
            ...
            extra_metadata={
                "canonical_root": "https://www.zakonyprolidi.cz",
                "title": "Czech Statute Book (zakonyprolidi.cz)",
            },
        )
...
def statute_book(language: str | None = None) -> Iterator[dict[str, Any]]:
    """Yield Czechia law rows from the canonical cache."""
...
def statute_book_source(language: str | None = None):
    """DLT source for the Czech Statute Book (zakonyprolidi.cz) ingestion."""
