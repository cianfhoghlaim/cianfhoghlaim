...
- 2026-07-08 (this change — `2026-06-29-fix-ocr-vlm-registry-with-unsloth-priority`):
  the canonical home moves to `cianfhoghlaim/ocr/models/registry.py`
  (the v4 spec line 685 location). The old
  `cianfhoghlaim/meaisinfhoghlaim/models/registry.py` is kept as a
  back-compat re-export shim that emits a DeprecationWarning.
