...
async def run_evaluation(
    ...
    """
    from cianfhoghlaim.core.evaluation.evaluation.ragas_pipeline import (
...
Expected Results:
    ...
    if "comparison" in results and "improvement_percentage" in results["comparison"]:
        ...
        print("(Target: 22.7% based on taighde/mlflow_ragas.md research)")
