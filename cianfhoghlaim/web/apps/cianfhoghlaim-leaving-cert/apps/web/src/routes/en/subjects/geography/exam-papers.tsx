// /en/subjects/geography/exam-papers — Geography per-subject past exam paper viewer + discussExamPaper BAML action.
//
...
export const Route = createFileRoute("/en/subjects/geography/exam-papers")({
  component: GeographyExampapersPage,
});

function GeographyExampapersPage() {
  return (
    <div className="max-w-4xl mx-auto flex flex-col gap-6 p-6">
      <h1 className="text-2xl font-bold text-slate-900">Geography — Past exam papers</h1>
      <p className="text-slate-600">
        All Geography past exam papers tagged by topic + paper + year.
