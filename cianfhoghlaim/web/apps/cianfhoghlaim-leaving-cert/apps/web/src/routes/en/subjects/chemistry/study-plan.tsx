// /en/subjects/chemistry/study-plan — Chemistry per-subject study plan generator (WebStudyPlan BAML action).
//
...
export const Route = createFileRoute("/en/subjects/chemistry/study-plan")({
  component: ChemistryStudyplanPage,
});

function ChemistryStudyplanPage() {
  return (
    <div className="max-w-4xl mx-auto flex flex-col gap-6 p-6">
      <h1 className="text-2xl font-bold text-slate-900">Chemistry — Study plan</h1>
      <p className="text-slate-600">
        Chemistry study plan generator. Calls the per-subject
        <code> generateStudyPlan </code>
        Convex action (backed by the per-subject
        <code> WebStudyPlan </code>
        BAML function over
        <code> qpack_chemistry.baml</code>).
      </p>
