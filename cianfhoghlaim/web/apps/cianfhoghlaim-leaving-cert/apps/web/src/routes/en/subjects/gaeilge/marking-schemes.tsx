// /en/subjects/gaeilge/marking-schemes — Gaeilge per-subject marking scheme (PCLM) viewer + WebMarkingSchemeExplanation.
//
...
export const Route = createFileRoute("/en/subjects/gaeilge/marking-schemes")({
  component: GaeilgeMarkingschemesPage,
});

function GaeilgeMarkingschemesPage() {
  return (
    <div className="max-w-4xl mx-auto flex flex-col gap-6 p-6">
      <h1 className="text-2xl font-bold text-slate-900">Gaeilge — Marking schemes</h1>
      <p className="text-slate-600">
        Gaeilge marking scheme (PCLM — Partial Credit, Logical
