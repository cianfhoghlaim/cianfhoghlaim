// /en/subjects/mathematics/exam-papers — Mathematics per-subject past exam paper viewer + discussExamPaper BAML action.
//
...
export const Route = createFileRoute("/en/subjects/mathematics/exam-papers")({
  component: MathematicsExampapersPage,
});

function MathematicsExampapersPage() {
  return (
    <div className="max-w-4xl mx-auto flex flex-col gap-6 p-6">
      <h1 className="text-2xl font-bold text-slate-900">Mathematics — Past exam papers</h1>
      <p className="text-slate-600">
        All Mathematics past exam papers tagged by topic + paper + year.
