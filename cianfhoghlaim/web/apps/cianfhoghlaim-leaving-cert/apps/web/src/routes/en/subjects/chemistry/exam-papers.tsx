// /en/subjects/chemistry/exam-papers — Chemistry per-subject past exam paper viewer + discussExamPaper BAML action.
//
...
export const Route = createFileRoute("/en/subjects/chemistry/exam-papers")({
  component: ChemistryExampapersPage,
});

function ChemistryExampapersPage() {
  return (
    <div className="max-w-4xl mx-auto flex flex-col gap-6 p-6">
      <h1 className="text-2xl font-bold text-slate-900">Chemistry — Past exam papers</h1>
      <p className="text-slate-600">
        All Chemistry past exam papers tagged by topic + paper + year.
