...
def _compute_embedding(text: str) -> list[float]:
    ...
    try:
        from cianfhoghlaim.cocoindex.leabharlann_embedding import embed_text
...
class AchievementLedger:
    ...
    async def cross_quest_relevance(
        ...
        """
        embedding = _compute_embedding(query_text) if query_text else [0.0] * 1024
